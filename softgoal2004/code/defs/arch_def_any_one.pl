...
rule1 says modifiability of system if
	helped by c1
	any_one_of modifiability of process
	any_one_of modifiability of dataRep
	any_one_of modifiability of function
	ref "L Chung's book" keywords [chung].      

rule2 says comprehensibility of system if
	coherence of system
	any_one_of simplicity of system
	ref "L Chung's book" keywords [chung].      

rule3 says performance of system if
	helped by c1
	any_one_of spacePerformance of system
	any_one_of  timePerformance of system
	ref "L Chung's book" keywords [chung].      

rule4 says modifiability of function if
	extensibility of function
	any_one_of deletability of function
	any_one_of updatability of function
	ref "L Chung's book" keywords [chung].      
