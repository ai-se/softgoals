...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f1 ,    90.61  ,   4.42 (         ------|    *  ---    ),85.08, 88.40, 91.16, 92.82, 94.48
   1 ,     gen20_f1 ,    90.61  ,   4.42 (         ------|    *  ---    ),85.08, 88.40, 91.16, 92.82, 94.48
   1 ,     gen40_f1 ,    90.61  ,   4.42 (         ------|    *  ---    ),85.08, 88.40, 91.16, 92.82, 94.48
   1 ,     gen60_f1 ,    90.61  ,   4.42 (         ------|    *  ---    ),85.08, 88.40, 91.16, 92.82, 94.48
   1 ,     gen80_f1 ,    90.61  ,   4.42 (         ------|    *  ---    ),85.08, 88.40, 91.16, 92.82, 94.48
   1 ,    gen100_f1 ,    90.61  ,   4.42 (         ------|    *  ---    ),85.08, 88.40, 91.16, 92.82, 94.48

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55
   1 ,     gen20_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55
   1 ,     gen40_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55
   1 ,     gen60_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55
   1 ,     gen80_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55
   1 ,    gen100_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,    206.0  ,   20.0 (     ---      *| --------     ),191.00, 196.00, 207.00, 212.00, 225.00
   1 ,     gen20_f3 ,    206.0  ,   20.0 (     ---      *| --------     ),191.00, 196.00, 207.00, 212.00, 225.00
   1 ,     gen40_f3 ,    206.0  ,   20.0 (     ---      *| --------     ),191.00, 196.00, 207.00, 212.00, 225.00
   1 ,     gen60_f3 ,    206.0  ,   20.0 (     ---      *| --------     ),191.00, 196.00, 207.00, 212.00, 225.00
   1 ,     gen80_f3 ,    206.0  ,   20.0 (     ---      *| --------     ),191.00, 196.00, 207.00, 212.00, 225.00
   1 ,    gen100_f3 ,    206.0  ,   20.0 (     ---      *| --------     ),191.00, 196.00, 207.00, 212.00, 225.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f4 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
   1 ,     gen20_f4 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
   1 ,     gen40_f4 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
   1 ,     gen60_f4 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
   1 ,     gen80_f4 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
   1 ,    gen100_f4 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
```

### Time Taken : 190.96875596
![1](../../../src/img/original_best_rest/CSCounselling.png)
...
+------+----------------------------------------------------+----------+-------+------+---------+
|  1   |     Provide Information to Other Counselloers      |   task   |   1   |  1   | 0.28571 |
|  2   |        Sign Contract with Counselling Union        |   task   |   1   |  1   | 0.28571 |
|  3   |   ! Counselor Speak on Kids Issues in General 1    |   task   |   -1  |  1   | 0.28571 |
|  4   |             Encourage Kids to Call CS              |   task   |   1   |  1   | 0.27586 |
|  5   |          Provide Resources in One Source           |   task   |   1   |  1   | 0.27563 |
|  6   |             *Implement Bulletin Board1             |   task   |   -1  |  1   | 0.26667 |
|  7   |                  Double Headsets                   | resource |   1   |  1   |  0.2513 |
|  8   |              !Undergo Media Training               |   task   |   1   |  1   | 0.24923 |
|  9   |       Comment on Technology Usability Issues       |   task   |   -1  |  1   | 0.24897 |
|  10  |                    Training CDs                    | resource |   -1  |  1   | 0.24381 |
|  11  |      Perform Conference Call with Third Party      |   task   |   1   |  1   | 0.24381 |
|  12  |                   Report Abuses                    |   task   |   1   |  1   | 0.24083 |
|  13  |           Provide Information in Binders           |   task   |   1   |  1   | 0.24067 |
|  14  |          *Receive Training from Managment          |   task   |   1   |  1   |  0.2312 |
|  15  |            Perform Crisis Intervention             |   task   |   1   |  1   | 0.22857 |
|  16  |               Participate in events1               |   task   |   1   |  1   | 0.22345 |
|  17  |                   Request Shifts                   |   task   |   -1  |  1   | 0.22345 |
|  18  |                Counselling Policies                | resource |   1   |  1   | 0.22261 |
|  19  |        Receive Call Classification Training        |   task   |   1   |  1   | 0.22261 |
|  20  |          !Participate in Sponsor Meetings          |   task   |   -1  |  1   | 0.21879 |
|  21  |           !Participate in Board Meetings           |   task   |   1   |  1   |  0.216  |
|  22  |     Listen to Calls of Experienced Counsellors     |   task   |   1   |  1   | 0.21333 |
|  23  |                      Feedback                      | resource |   -1  |  1   | 0.20903 |
|  24  |              Speak Publicly about Job              |   task   |   -1  |  1   |  0.2048 |
|  25  |               Counselling Workshops                | resource |   -1  |  1   | 0.20455 |
|  26  |   Block Kids who Display Inappropriate Behavoir    |   task   |   -1  |  1   | 0.19931 |
|  27  | Include Legal Information in Counselling Resources |   task   |   -1  |  1   | 0.19692 |
|  28  |                 *Explore Options1                  |   task   |   -1  |  1   | 0.19636 |
|  29  |            Diffuse Conflict with Parent            |   task   |   1   |  1   | 0.19267 |
|  30  |              Debrief with Counsellors              |   task   |   1   |  1   | 0.19059 |
|  31  |         *Implement Email for Counsellors1          |   task   |   -1  |  1   | 0.18963 |
|  32  |                Refer Parents to PHL                |   task   |   1   |  1   |  0.1875 |
|  33  |  *Encourage Kids to Talk to Different Counsellors  |   task   |   1   |  1   | 0.18667 |
|  34  |             Tape Recording Technology              | resource |   -1  |  1   | 0.18645 |
|  35  |                  *Explore Options                  |   task   |   -1  |  1   | 0.18286 |
|  36  |          Encourage Kids to Talk to Others          |   task   |   1   |  1   | 0.18286 |
|  37  |              *Edit Counselling Posts               |   task   |   1   |  1   |   0.18  |
|  38  |              Attend Part Time Meeting              |   task   |   -1  |  1   | 0.17655 |
|  39  |          ! Write Articles for Magazines 1          |   task   |   -1  |  1   | 0.17655 |
|  40  |               Report Outdated Links1               |   task   |   1   |  1   | 0.17308 |
|  41  |            Remove Identifying Material             |   task   |   1   |  1   | 0.17308 |
|  42  |              Speak at SA Conferences               |   task   |   1   |  1   | 0.17043 |
|  43  |                  Listen for Cues                   |   task   |   1   |  1   |  0.169  |
|  44  |               Learn Web Technologies               |   task   |   -1  |  1   | 0.16667 |
|  45  |                  Assess Situation                  |   task   |   -1  |  1   | 0.16667 |
|  46  |                   Record Stories                   |   task   |   -1  |  1   | 0.16516 |
|  47  |            Provide Resources in Library            |   task   |   -1  |  1   | 0.16516 |
|  48  |               Web Moderator Meetings               | resource |   -1  |  1   | 0.16333 |
|  49  |           *Implement Categorization Tool           |   task   |   -1  |  1   | 0.16333 |
|  50  |           Provide Resources in E-Library           |   task   |   -1  |  1   | 0.16095 |
|  51  | Include Drug Information in Counselling Resources  |   task   |   -1  |  1   | 0.16095 |
|  52  |                       Tapes                        | resource |   1   |  1   | 0.16095 |
|  53  |           ! Write Articles for Website 1           |   task   |   1   |  1   | 0.16071 |
|  54  |                 Assess Situation1                  |   task   |   -1  |  1   | 0.16071 |
+------+----------------------------------------------------+----------+-------+------+---------+
```
...
|                     Find Information in Library                      |   task   |   1   |
...
|                 Collect Caller/Situation Statistics                  |   task   |   -1  |
...
|                     Web Counselling be Performed                     |   task   |  -0.5 |
|                     Improve Counselling Skills2                      | softgoal |  0.5  |
|                       Undergo Clinical Review2                       |   task   |   1   |
|                 *Provide Training to New Counsellors                 |   task   |   1   |
