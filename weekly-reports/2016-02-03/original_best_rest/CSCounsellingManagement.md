...
### Time Taken : 51.1450231075
![1](../../../src/img/original_best_rest/CSCounsellingManagement.png)
...
+------+-----------------------------------------------------+----------+-------+------+---------+
|  1   |                   Double Head Set                   | resource |   1   |  1   | 0.31391 |
|  2   |               Set Counselling Policies              |   task   |   -1  |  1   |  0.2592 |
|  3   |             Put On Counselling Workshops            |   task   |   1   |  1   | 0.23273 |
|  4   |           Historical Data of Call Volumes           | resource |   -1  |  1   | 0.22563 |
|  5   |                   Call Statistics                   | resource |   1   |  1   | 0.22345 |
|  6   |                    Debrief Calls                    |   task   |   1   |  1   | 0.22231 |
|  7   |                     Review Tape                     |   task   |   -1  |  1   | 0.21407 |
|  8   |         Acquire Web Training from Operations        |   task   |   1   |  1   | 0.21333 |
|  9   |            Put on Web Moderator Meetings            |   task   |   1   |  1   | 0.21333 |
|  10  |                  Debrief Web Posts                  |   task   |   1   |  1   |  0.196  |
|  11  |                Counselling Resources                | resource |   -1  |  1   | 0.18963 |
|  12  |      Put on Orientation Process for Cousellors      |   task   |   1   |  1   |  0.1875 |
|  13  |              !Hire Counselling Managers             |   task   |   1   |  1   | 0.18286 |
|  14  |           Negotiate with Counsellors Union          |   task   |   -1  |  1   |   0.18  |
|  15  |              Attend Part Time Meetings              |   task   |   1   |  1   |   0.18  |
|  16  |                    Request Shifts                   |   task   |   1   |  1   |   0.18  |
|  17  |      Provide One-on-One Support to Counsellors      |   task   |   1   |  1   | 0.17308 |
|  18  |                 Counsellors Be Paid                 |   task   |   -1  |  1   | 0.16667 |
|  19  |      Communicate CS Information to Counsellors      |   task   |   1   |  1   | 0.16095 |
|  20  |                  !Hire Counsellors                  |   task   |   -1  |  1   | 0.16071 |
|  21  | Write Yearly Peformance Evaluations for Counsellors |   task   |   -1  |  1   |  0.1568 |
|  22  |                   Use Blue Pumpkin                  |   task   |   -1  |  1   | 0.15517 |
|  23  |        Create Call Classification Catagories        |   task   |   1   |  1   | 0.15077 |
+------+-----------------------------------------------------+----------+-------+------+---------+
```
