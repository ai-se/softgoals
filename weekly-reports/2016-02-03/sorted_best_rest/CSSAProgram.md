...
### Time Taken : 20.7730329037
![1](../../../src/img/sorted_best_rest/CSSAProgram.png)
...
+------+-------------------------------+----------+-------+------+---------+
|  1   |       Plan Social Events      |   task   |   -1  |  1   | 0.05229 |
|  2   |        Send out Emails        |   task   |   -1  |  1   | 0.04327 |
|  3   |   Run Fundraiser in Schools1  |   task   |   1   |  1   | 0.04177 |
|  4   |      Promotion Resources1     | resource |   -1  |  1   | 0.04003 |
|  5   |           Train SA s          |   task   |   -1  |  1   | 0.03843 |
|  6   |  Write Articles for Newspaper |   task   |   -1  |  1   | 0.03529 |
|  7   |       Attend SA Meetings      |   task   |   -1  |  1   | 0.03431 |
|  8   | School Initiates Presenation1 |   task   |   -1  |  1   | 0.02911 |
|  9   |       Attend CS Meetings      |   task   |   -1  |  1   | 0.02824 |
|  10  |        Provide Speaches       |   task   |   -1  |  1   | 0.02521 |
|  11  |    Help with Presentations    |   task   |   -1  |  1   | 0.02434 |
|  12  |          Retrain SA s         |   task   |   -1  |  1   | 0.02042 |
+------+-------------------------------+----------+-------+------+---------+
```
