...
----------------------------------------------------
   ...
   1 ,     gen20_f3 ,     29.0  ,    1.0 (           ----|-*     ------ ),28.00, 29.00, 29.00, 30.00, 31.00
   1 ,     gen40_f3 ,     29.0  ,    0.0 (           ----|-*----------- ),28.00, 29.00, 29.00, 29.00, 31.00
   1 ,     gen60_f3 ,     29.0  ,    2.0 (           ----|-*            ),28.00, 29.00, 29.00, 30.00, 30.00
   1 ,     gen80_f3 ,     29.0  ,    1.0 (               | *-----       ),28.00, 28.00, 29.00, 29.00, 30.00
   1 ,    gen100_f3 ,     29.0  ,    1.0 (               | *-----       ),28.00, 28.00, 29.00, 29.00, 30.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f4 ,      3.0  ,    1.0 (---*           |              ), 2.00,  3.00,  3.00,  4.00,  4.00
   1 ,     gen80_f4 ,      3.0  ,    1.0 (---   *--      |              ), 2.00,  3.00,  4.00,  4.00,  5.00
   2 ,     gen60_f4 ,      4.0  ,    2.0 (      *        |              ), 3.00,  3.00,  4.00,  5.00,  5.00
   3 ,     gen40_f4 ,      5.0  ,    1.0 (   ---   *---  |              ), 3.00,  4.00,  5.00,  5.00,  6.00
   4 ,     gen20_f4 ,      6.0  ,    2.0 (      ---    * |---           ), 4.00,  5.00,  6.00,  7.00,  8.00
   5 ,      gen0_f4 ,      7.0  ,    3.0 (         ----  |*      ---    ), 5.00,  6.00,  7.00,  9.00, 10.00
```

### Time Taken : 9.1875679493
![1](../../../src/img/weight_modified/Kids and Youth.png)
...
|  2   |        Implement Video Counselling        | task |   -1  |  1   |
|  3   |              Provide Feedback             | task |   -1  |  1   |
...
|  10  |         !Implement Text Messaging         | task |   -1  |  1   |
|  11  |   !Implement Bulletin Board with Replies  | task |   -1  |  1   |
|  12  |        !Implement Polls about Kids        | task |   1   |  1   |
|  13  |   !Implement Cyber Café/Portal/Chat Room  | task |   -1  |  1   |
|  14  |  !Implement General Questions and Answers | task |   1   |  1   |
