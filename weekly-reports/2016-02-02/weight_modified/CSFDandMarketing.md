...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    94.16  ,   4.54 (       ------  |*     ----    ),90.26, 92.86, 94.16, 96.75, 98.70
   2 ,     gen40_f1 ,    95.45  ,   4.54 (         ------|   *   ---    ),90.91, 93.51, 95.45, 97.40, 98.70
   3 ,     gen60_f1 ,     96.1  ,   3.89 (            ---|    *  ---    ),92.21, 94.16, 96.10, 97.40, 98.70
   3 ,     gen80_f1 ,     96.1  ,   3.89 (             --|---   *---    ),92.86, 95.45, 96.75, 97.40, 98.70
   3 ,    gen100_f1 ,     97.4  ,    2.6 (               |---    * -    ),93.51, 95.45, 97.40, 98.05, 98.70

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    84.38  ,   6.25 (         --    * ------       ),78.13, 81.25, 84.38, 87.50, 93.75
   2 ,     gen20_f2 ,     87.5  ,   6.25 (           ----| *   --       ),81.25, 84.38, 87.50, 90.63, 93.75
   2 ,     gen40_f2 ,     87.5  ,   9.37 (           ----| *     ----   ),81.25, 84.38, 87.50, 93.75, 96.88
   3 ,     gen60_f2 ,    90.63  ,   6.25 (               |-    * ----   ),84.38, 87.50, 90.63, 93.75, 96.88
   3 ,     gen80_f2 ,    90.63  ,   6.25 (               |-    * ----   ),84.38, 87.50, 90.63, 93.75, 96.88
   3 ,    gen100_f2 ,    93.75  ,   9.38 (               |-----  *      ),84.38, 90.63, 93.75, 96.88, 96.88

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,    234.0  ,   23.0 (     ----   *  |-----         ),212.00, 224.00, 234.00, 244.00, 261.00
   2 ,     gen20_f3 ,    244.0  ,   21.0 (       ----    |*----         ),219.00, 232.00, 245.00, 250.00, 262.00
   2 ,     gen40_f3 ,    244.0  ,   20.0 (         ---   |* ------      ),224.00, 234.00, 245.00, 251.00, 271.00
   2 ,     gen60_f3 ,    245.0  ,   25.0 (         ---   |*  ------     ),224.00, 234.00, 245.00, 255.00, 274.00
   3 ,     gen80_f3 ,    246.0  ,   21.0 (          ---  | * ------     ),228.00, 238.00, 248.00, 256.00, 274.00
   3 ,    gen100_f3 ,    249.0  ,   25.0 (          -----| *   ----     ),228.00, 244.00, 249.00, 261.00, 274.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f4 ,     34.0  ,    4.0 (          ---- |*  ----       ),30.00, 33.00, 34.00, 36.00, 39.00
   1 ,     gen20_f4 ,     35.0  ,    5.0 (          ---- | *  ----      ),30.00, 33.00, 35.00, 37.00, 40.00
   1 ,     gen40_f4 ,     35.0  ,    5.0 (          ---- | *   ----     ),30.00, 33.00, 35.00, 38.00, 41.00
   2 ,     gen60_f4 ,     36.0  ,    4.0 (          -----|   * ----     ),30.00, 34.00, 36.00, 38.00, 41.00
   2 ,     gen80_f4 ,     36.0  ,    4.0 (            ---|   * ----     ),31.00, 34.00, 36.00, 38.00, 41.00
   2 ,    gen100_f4 ,     36.0  ,    4.0 (            ---|   * ----     ),31.00, 34.00, 36.00, 38.00, 41.00
```

### Time Taken : 210.096085072
![1](../../../src/img/weight_modified/CSFDandMarketing.png)
...
+------+--------------------------------------------------------------------------+----------+-------+------+
|  1   |                  Single charitable registration number1                  | resource |   1   |  1   |
|  2   |                   !Train counselors on public speaking                   |   task   |   1   |  1   |
|  3   |                          Participate in events                           |   task   |   1   |  1   |
|  4   |                     Provide Real Time Tax Receipts                       |   task   |   1   |  1   |
|  5   |                          Conflicts Be Managed                            |   task   |   -1  |  1   |
|  6   |                            Free advertisement                            | resource |   1   |  1   |
|  7   |                    Market [Only For Serious Issues]                      |   task   |   1   |  1   |
|  8   |              ! Counselor Speak on Kids Issues in General 1               |   task   |   1   |  1   |
|  9   |      Sponsors Include CS Logos and Descriptions on their Products        |   task   |   1   |  1   |
|  10  |                      Share PAP in Document Library1                      |   task   |   1   |  1   |
|  11  |                  Communicate through Internet and phone                  |   task   |   1   |  1   |
|  12  |                          Provide free services1                          |   task   |   1   |  1   |
|  13  |                     Develop national event calendar                      |   task   |   1   |  1   |
|  14  |                              Provide funds                               |   task   |   1   |  1   |
|  15  |                             Reach agreement                              |   task   |   1   |  1   |
|  16  |                          Provide free services                           |   task   |   1   |  1   |
|  17  |                          Reallocate resources1                           |   task   |   -1  |  1   |
|  18  |                           Pledge\nDuring event                           |   task   |   1   |  1   |
|  19  |                      Provide philanthropic donation                      |   task   |   1   |  1   |
|  20  |                      Share PAP in Document Library                       |   task   |   1   |  1   |
|  21  |              Put Together Proposals for Corporate Sponsors               |   task   |   1   |  1   |
|  22  |                    Put on orientation for volunteers                     |   task   |   1   |  1   |
|  23  |                  Store donor information into database                   |   task   |   1   |  1   |
|  24  |                              Pledge\nonline                              |   task   |   1   |  1   |
|  25  |                        Get web event technology1                         |   task   |   1   |  1   |
|  26  |                          Use volunteer services                          |   task   |   1   |  1   |
|  27  |                        Collect donor information                         |   task   |   1   |  1   |
|  28  |                         Create General Ledgers                           |   task   |   -1  |  1   |
|  29  |                      Place Sponsor Logos in Events                       |   task   |   1   |  1   |
|  30  |                           Speak at Fundraisers                           |   task   |   -1  |  1   |
|  31  |                       National Marketing Strategy                        | resource |   1   |  1   |
|  32  |          Bring Regional Fundraising Staff Together Once a Year           |   task   |   -1  |  1   |
|  33  |                Pay Fund Development and Marketing Staff                  |   task   |   -1  |  1   |
|  34  |            Create posters, flyers and informational material             |   task   |   1   |  1   |
|  35  |   Put on Orientation Process for Fund Development and Marketing Staff    |   task   |   1   |  1   |
|  36  |                     ! Write Articles for Magazines 1                     |   task   |   1   |  1   |
|  37  |                          Give CS Presentations                           |   task   |   -1  |  1   |
|  38  |                     Implement Stay in Touch program                      |   task   |   -1  |  1   |
|  39  |                       Inform Sponsors of Progress                        |   task   |   1   |  1   |
|  40  |      Email Corporate Partners Interesting and Relevant News Pieces       |   task   |   1   |  1   |
|  41  |                      ! Write Articles for Website 1                      |   task   |   -1  |  1   |
|  42  |                Work with the Regions to Implement Events                 |   task   |   -1  |  1   |
|  43  | Pitch to National Corporate Sponsors the Sponsorship of Regional Events  |   task   |   -1  |  1   |
|  44  |                     Provide Document Library System                      |   task   |   1   |  1   |
|  45  |                          Create Thank you ads                            |   task   |   -1  |  1   |
|  46  |                         Create branded products                          |   task   |   -1  |  1   |
|  47  |                            Get donor database                            |   task   |   -1  |  1   |
|  48  |                       Give philanthropic donation                        |   task   |   1   |  1   |
|  49  |                     Provide Online Donor Technology                      |   task   |   -1  |  1   |
|  50  |                           Reallocate resources                           |   task   |   -1  |  1   |
|  51  |                              Track budgets                               |   task   |   -1  |  1   |
|  52  |                       Market through own channels                        |   task   |   1   |  1   |
|  53  |                       Get philanthropic donations                        |   task   |   1   |  1   |
|  54  |                       Bi-Weekly Conference Calls                         |   task   |   -1  |  1   |
|  55  |                             Manage Accounts                              |   task   |   -1  |  1   |
|  56  |                        Donor/Accounting Database                         | resource |   -1  |  1   |
|  57  |                Write Down Corporate Sponsors Objectives                  |   task   |   -1  |  1   |
|  58  |                      ! Provide compiled call data                        |   task   |   -1  |  1   |
|  59  |                Get Corporate Partner Information from DL1                |   task   |   -1  |  1   |
|  60  |                        Run Fundraiser in Schools                         |   task   |   -1  |  1   |
|  61  |                       ! Provide money for services                       |   task   |   -1  |  1   |
|  62  |                      Elaborate Fundraising targets1                      |   task   |   -1  |  1   |
|  63  |           Provide Promotional Material to Student Ambassadors            |   task   |   -1  |  1   |
|  64  |                  Store donor transactions into database                  |   task   |   -1  |  1   |
|  65  |                            Provide Logo to CS                            |   task   |   -1  |  1   |
|  66  |                       Exclusive Brand and Logo use                       | resource |   -1  |  1   |
|  67  |                         Send recognition letters                         |   task   |   -1  |  1   |
|  68  |                    Organize discussions with Sponsors                    |   task   |   -1  |  1   |
...
|                         Attend fundraising event                         |   task   |   1   |
...
|                          Become a Major patron                           |   task   |  0.5  |
...
|                   Put on Fundraising Events on the Web                   |   task   |   1   |
