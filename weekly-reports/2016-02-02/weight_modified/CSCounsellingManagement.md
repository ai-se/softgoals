...
### Time Taken : 50.6342208385
![1](../../../src/img/weight_modified/CSCounsellingManagement.png)
...
|  3   |           Negotiate with Counsellors Union          |   task   |   -1  |  1   |
|  4   |             Put On Counselling Workshops            |   task   |   -1  |  1   |
|  5   |              Attend Part Time Meetings              |   task   |   -1  |  1   |
|  6   |        Create Call Classification Catagories        |   task   |   -1  |  1   |
|  7   |                    Debrief Calls                    |   task   |   -1  |  1   |
...
|  12  |      Put on Orientation Process for Cousellors      |   task   |   1   |  1   |
|  13  |      Communicate CS Information to Counsellors      |   task   |   1   |  1   |
|  14  |                 Counsellors Be Paid                 |   task   |   -1  |  1   |
|  15  |                Counselling Resources                | resource |   -1  |  1   |
|  16  |           Historical Data of Call Volumes           | resource |   -1  |  1   |
|  17  |                   Call Statistics                   | resource |   -1  |  1   |
|  18  |                    Request Shifts                   |   task   |   -1  |  1   |
|  19  |              !Hire Counselling Managers             |   task   |   -1  |  1   |
|  20  |         Acquire Web Training from Operations        |   task   |   -1  |  1   |
|  21  |                   Double Head Set                   | resource |   -1  |  1   |
|  22  |                     Review Tape                     |   task   |   -1  |  1   |
|  23  |            Put on Web Moderator Meetings            |   task   |   -1  |  1   |
+------+-----------------------------------------------------+----------+-------+------+
```
