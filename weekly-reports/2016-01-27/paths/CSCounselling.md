...
----------------------------------------------------
   ...
   1 ,     gen40_f1 ,    84.29  ,   6.19 (        -------|   *   ---    ),75.71, 81.43, 84.29, 87.14, 89.52
   1 ,     gen60_f1 ,    84.29  ,   6.19 (        -------|-   *  ---    ),75.71, 82.38, 84.76, 87.14, 90.00
   1 ,     gen80_f1 ,    84.29  ,   6.19 (        -------|-   *  ---    ),75.71, 82.38, 84.76, 87.14, 90.00
   1 ,    gen100_f1 ,    85.24  ,   5.72 (        -------|-   *  ----   ),75.71, 82.86, 85.24, 87.14, 90.48

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f2 ,    159.0  ,   20.0 (    -----   *  |----          ),142.00, 153.00, 160.00, 168.00, 179.00
   1 ,     gen80_f2 ,    160.0  ,   19.0 (      ---   *  |-----         ),146.00, 153.00, 160.00, 169.00, 181.00
   1 ,     gen60_f2 ,    161.0  ,   18.0 (      ----   * |-----         ),146.00, 156.00, 162.00, 170.00, 181.00
   1 ,     gen40_f2 ,    162.0  ,   19.0 (      ----   * |-----         ),146.00, 156.00, 163.00, 170.00, 182.00
   2 ,     gen20_f2 ,    163.0  ,   23.0 (       ---   * | -----        ),148.00, 157.00, 164.00, 172.00, 184.00
   2 ,      gen0_f2 ,    164.0  ,   25.0 (       ---    *|    ----      ),148.00, 157.00, 166.00, 179.00, 189.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen20_f3 ,     26.0  ,    4.0 (     ----    * | --------     ),22.00, 24.00, 26.00, 28.00, 32.00
   1 ,     gen40_f3 ,     26.0  ,    4.0 (     ----    * | --------     ),22.00, 24.00, 26.00, 28.00, 32.00
   1 ,     gen60_f3 ,     26.0  ,    5.0 (     ----    * | --------     ),22.00, 24.00, 26.00, 28.00, 32.00
   1 ,     gen80_f3 ,     26.0  ,    5.0 (     ----    * | ------       ),22.00, 24.00, 26.00, 28.00, 31.00
   1 ,    gen100_f3 ,     26.0  ,    5.0 (     ----    * |-------       ),22.00, 24.00, 26.00, 27.00, 31.00
   1 ,      gen0_f3 ,     26.0  ,    4.0 (     ------    * --------     ),22.00, 25.00, 27.00, 28.00, 32.00
```

### Time Taken : 290.559107065
![1](../../../src/img/paths/CSCounselling.png)
...
+------+----------------------------------------------------+----------+-------+------+
|  1   |              Attend Part Time Meeting              |   task   |   1   |  1   |
|  2   |            Remove Identifying Material             |   task   |   1   |  1   |
|  3   |                  Listen for Cues                   |   task   |   1   |  1   |
|  4   |               Report Outdated Links1               |   task   |   1   |  1   |
|  5   |          ! Write Articles for Magazines 1          |   task   |   -1  |  1   |
|  6   |     Provide Information to Other Counselloers      |   task   |   -1  |  1   |
|  7   |           !Participate in Board Meetings           |   task   |   1   |  1   |
|  8   |             *Implement Bulletin Board1             |   task   |   -1  |  1   |
|  9   |              Debrief with Counsellors              |   task   |   1   |  1   |
|  10  |             Tape Recording Technology              | resource |   -1  |  1   |
|  11  |               Counselling Workshops                | resource |   1   |  1   |
|  12  |                 Assess Situation1                  |   task   |   -1  |  1   |
|  13  |                   Record Stories                   |   task   |   1   |  1   |
|  14  |              !Undergo Media Training               |   task   |   1   |  1   |
|  15  |        Receive Call Classification Training        |   task   |   1   |  1   |
|  16  |                 *Explore Options1                  |   task   |   -1  |  1   |
|  17  |              Speak at SA Conferences               |   task   |   1   |  1   |
|  18  |            Diffuse Conflict with Parent            |   task   |   1   |  1   |
|  19  |   ! Counselor Speak on Kids Issues in General 1    |   task   |   -1  |  1   |
|  20  |  *Encourage Kids to Talk to Different Counsellors  |   task   |   1   |  1   |
|  21  |               Web Moderator Meetings               | resource |   1   |  1   |
|  22  |          *Receive Training from Managment          |   task   |   1   |  1   |
|  23  |        Sign Contract with Counselling Union        |   task   |   -1  |  1   |
|  24  |            Provide Resources in Library            |   task   |   -1  |  1   |
|  25  |                       Tapes                        | resource |   -1  |  1   |
|  26  |   Block Kids who Display Inappropriate Behavoir    |   task   |   1   |  1   |
|  27  |           *Implement Categorization Tool           |   task   |   -1  |  1   |
|  28  |              *Edit Counselling Posts               |   task   |   1   |  1   |
|  29  |           Provide Resources in E-Library           |   task   |   1   |  1   |
|  30  |             Encourage Kids to Call CS              |   task   |   1   |  1   |
|  31  |                      Feedback                      | resource |   -1  |  1   |
|  32  |              Speak Publicly about Job              |   task   |   1   |  1   |
|  33  |                  Double Headsets                   | resource |   1   |  1   |
|  34  |       Comment on Technology Usability Issues       |   task   |   -1  |  1   |
|  35  |     Listen to Calls of Experienced Counsellors     |   task   |   -1  |  1   |
|  36  |          Encourage Kids to Talk to Others          |   task   |   -1  |  1   |
|  37  |               Learn Web Technologies               |   task   |   -1  |  1   |
|  38  |                    Training CDs                    | resource |   -1  |  1   |
|  39  | Include Legal Information in Counselling Resources |   task   |   1   |  1   |
|  40  |      Perform Conference Call with Third Party      |   task   |   -1  |  1   |
|  41  |                Counselling Policies                | resource |   -1  |  1   |
|  42  |          !Participate in Sponsor Meetings          |   task   |   -1  |  1   |
|  43  |               Participate in events1               |   task   |   1   |  1   |
|  44  |           Provide Information in Binders           |   task   |   1   |  1   |
|  45  |           ! Write Articles for Website 1           |   task   |   -1  |  1   |
|  46  |         *Implement Email for Counsellors1          |   task   |   -1  |  1   |
|  47  |          Provide Resources in One Source           |   task   |   1   |  1   |
|  48  |                  Assess Situation                  |   task   |   -1  |  1   |
|  49  |                   Report Abuses                    |   task   |   -1  |  1   |
|  50  |                Refer Parents to PHL                |   task   |   -1  |  1   |
|  51  | Include Drug Information in Counselling Resources  |   task   |   1   |  1   |
|  52  |                  *Explore Options                  |   task   |   -1  |  1   |
|  53  |            Perform Crisis Intervention             |   task   |   1   |  1   |
|  54  |                   Request Shifts                   |   task   |   -1  |  1   |
+------+----------------------------------------------------+----------+-------+------+
```
