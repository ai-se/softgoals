...
----------------------------------------------------
   ...
   1 ,     gen20_f1 ,    84.95  ,   5.91 (       ------  |*  ---        ),77.42, 82.26, 84.95, 87.63, 89.78
   1 ,     gen40_f1 ,    84.95  ,   5.91 (       ------- |*  ---        ),77.42, 82.80, 84.95, 87.63, 89.78
   1 ,     gen60_f1 ,    85.48  ,   5.37 (       ------- | * ---        ),77.42, 82.80, 85.48, 87.63, 89.78
   1 ,     gen80_f1 ,    86.02  ,   5.37 (       ------- | * ---        ),77.42, 83.33, 86.02, 87.63, 89.78
   1 ,    gen100_f1 ,    86.02  ,   5.37 (       --------| *  ----      ),77.42, 83.87, 86.02, 88.17, 91.40

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f2 ,    199.0  ,   26.0 (       ---    *| ---          ),177.00, 188.00, 199.00, 209.00, 220.00
   1 ,     gen60_f2 ,    199.0  ,   24.0 (       ----   *| ------       ),178.00, 190.00, 200.00, 211.00, 229.00
   1 ,     gen80_f2 ,    199.0  ,   24.0 (       ----   *| ----         ),178.00, 190.00, 200.00, 209.00, 221.00
   1 ,     gen20_f2 ,    200.0  ,   24.0 (       ----   *|  -----       ),178.00, 192.00, 201.00, 212.00, 229.00
   1 ,     gen40_f2 ,    200.0  ,   24.0 (       ----   *|  -----       ),178.00, 192.00, 201.00, 212.00, 229.00
   1 ,      gen0_f2 ,    207.0  ,   30.0 (       ------  | *  ----      ),179.00, 196.00, 209.00, 218.00, 232.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen60_f3 ,     33.0  ,    5.0 (           ----| *    ---     ),29.00, 32.00, 33.00, 36.00, 38.00
   1 ,     gen80_f3 ,     33.0  ,    5.0 (           ----| *    -       ),29.00, 32.00, 33.00, 36.00, 37.00
   1 ,    gen100_f3 ,     33.0  ,    4.0 (           ----| *  ---       ),29.00, 32.00, 33.00, 35.00, 37.00
   1 ,      gen0_f3 ,     34.0  ,    4.0 (            ---|- *   ----    ),30.00, 33.00, 34.00, 36.00, 39.00
   1 ,     gen20_f3 ,     34.0  ,    5.0 (           ----|  *   ---     ),29.00, 32.00, 34.00, 36.00, 38.00
   1 ,     gen40_f3 ,     34.0  ,    5.0 (           ----|  *   ---     ),29.00, 32.00, 34.00, 36.00, 38.00
```

### Time Taken : 367.684527874
![1](../../../src/img/paths/CSFDandMarketing.png)
...
+------+--------------------------------------------------------------------------+----------+-------+------+
|  1   |                  Store donor transactions into database                  |   task   |   1   |  1   |
|  2   |                             Manage Accounts                              |   task   |   1   |  1   |
|  3   |                   !Train counselors on public speaking                   |   task   |   -1  |  1   |
|  4   |                          Participate in events                           |   task   |   1   |  1   |
|  5   |                            Provide Logo to CS                            |   task   |   1   |  1   |
|  6   |                     Implement Stay in Touch program                      |   task   |   -1  |  1   |
|  7   |                       Market through own channels                        |   task   |   -1  |  1   |
|  8   |                    Put on orientation for volunteers                     |   task   |   1   |  1   |
|  9   |                Pay Fund Development and Marketing Staff                  |   task   |   -1  |  1   |
|  10  |                      Elaborate Fundraising targets1                      |   task   |   -1  |  1   |
|  11  |                        Donor/Accounting Database                         | resource |   -1  |  1   |
|  12  |                  Store donor information into database                   |   task   |   1   |  1   |
|  13  |                       Get philanthropic donations                        |   task   |   1   |  1   |
|  14  |                         Create General Ledgers                           |   task   |   -1  |  1   |
|  15  |                    Organize discussions with Sponsors                    |   task   |   1   |  1   |
|  16  |                Get Corporate Partner Information from DL1                |   task   |   -1  |  1   |
|  17  |                              Track budgets                               |   task   |   1   |  1   |
|  18  |                             Reach agreement                              |   task   |   1   |  1   |
|  19  |                           Pledge\nDuring event                           |   task   |   -1  |  1   |
|  20  |                     Provide Online Donor Technology                      |   task   |   1   |  1   |
|  21  |              ! Counselor Speak on Kids Issues in General 1               |   task   |   1   |  1   |
|  22  |              Put Together Proposals for Corporate Sponsors               |   task   |   1   |  1   |
|  23  |                     Provide Real Time Tax Receipts                       |   task   |   -1  |  1   |
|  24  |                     ! Write Articles for Magazines 1                     |   task   |   1   |  1   |
|  25  |                       Bi-Weekly Conference Calls                         |   task   |   -1  |  1   |
|  26  |                          Conflicts Be Managed                            |   task   |   1   |  1   |
|  27  |                       ! Provide money for services                       |   task   |   1   |  1   |
|  28  |            Create posters, flyers and informational material             |   task   |   -1  |  1   |
|  29  |                      ! Write Articles for Website 1                      |   task   |   -1  |  1   |
|  30  |                      Share PAP in Document Library                       |   task   |   1   |  1   |
|  31  |                              Pledge\nonline                              |   task   |   1   |  1   |
|  32  |                  Single charitable registration number1                  | resource |   -1  |  1   |
|  33  |                  Communicate through Internet and phone                  |   task   |   -1  |  1   |
|  34  |                           Reallocate resources                           |   task   |   -1  |  1   |
|  35  |                          Create Thank you ads                            |   task   |   -1  |  1   |
|  36  |                        Run Fundraiser in Schools                         |   task   |   -1  |  1   |
|  37  |                      Place Sponsor Logos in Events                       |   task   |   1   |  1   |
|  38  |                         Send recognition letters                         |   task   |   -1  |  1   |
|  39  |                         Create branded products                          |   task   |   -1  |  1   |
|  40  |                       Inform Sponsors of Progress                        |   task   |   -1  |  1   |
|  41  |                            Get donor database                            |   task   |   1   |  1   |
|  42  |                              Provide funds                               |   task   |   1   |  1   |
|  43  |          Bring Regional Fundraising Staff Together Once a Year           |   task   |   -1  |  1   |
|  44  |      Sponsors Include CS Logos and Descriptions on their Products        |   task   |   -1  |  1   |
|  45  |                          Provide free services1                          |   task   |   1   |  1   |
|  46  |                     Provide Document Library System                      |   task   |   -1  |  1   |
|  47  |   Put on Orientation Process for Fund Development and Marketing Staff    |   task   |   -1  |  1   |
|  48  |                Write Down Corporate Sponsors Objectives                  |   task   |   -1  |  1   |
|  49  |                           Manage Receivables                             |   task   |   -1  |  1   |
|  50  |                        Get web event technology1                         |   task   |   1   |  1   |
|  51  |                    Market [Only For Serious Issues]                      |   task   |   1   |  1   |
|  52  |                          Use volunteer services                          |   task   |   1   |  1   |
|  53  |                      Provide philanthropic donation                      |   task   |   -1  |  1   |
|  54  |                          Provide free services                           |   task   |   1   |  1   |
|  55  | Pitch to National Corporate Sponsors the Sponsorship of Regional Events  |   task   |   1   |  1   |
|  56  |                        Collect donor information                         |   task   |   -1  |  1   |
|  57  |                       Give philanthropic donation                        |   task   |   1   |  1   |
|  58  |                            Free advertisement                            | resource |   -1  |  1   |
|  59  |                Work with the Regions to Implement Events                 |   task   |   1   |  1   |
|  60  |                      ! Provide compiled call data                        |   task   |   -1  |  1   |
|  61  |                          Give CS Presentations                           |   task   |   -1  |  1   |
|  62  |                       Exclusive Brand and Logo use                       | resource |   -1  |  1   |
|  63  |                      Share PAP in Document Library1                      |   task   |   1   |  1   |
|  64  |      Email Corporate Partners Interesting and Relevant News Pieces       |   task   |   -1  |  1   |
|  65  |                       National Marketing Strategy                        | resource |   -1  |  1   |
|  66  |                     Develop national event calendar                      |   task   |   -1  |  1   |
|  67  |                          Reallocate resources1                           |   task   |   -1  |  1   |
|  68  |           Provide Promotional Material to Student Ambassadors            |   task   |   -1  |  1   |
|  69  |                           Speak at Fundraisers                           |   task   |   -1  |  1   |
+------+--------------------------------------------------------------------------+----------+-------+------+
```
