...
----------------------------------------------------
   ...
   2 ,     gen40_f1 ,    100.0  ,   3.23 (               |             *),96.77, 96.77, 100.00, 100.00, 100.00
   2 ,     gen60_f1 ,    100.0  ,   3.23 (               |             *),96.77, 96.77, 100.00, 100.00, 100.00
   2 ,     gen80_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.77, 100.00, 100.00, 100.00, 100.00
   2 ,    gen100_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.77, 100.00, 100.00, 100.00, 100.00
...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f3 ,      3.0  ,    1.0 ( ---*          |              ), 1.00,  3.00,  3.00,  4.00,  4.00
   2 ,     gen80_f3 ,      4.0  ,    2.0 (    -* -       |              ), 3.00,  4.00,  4.00,  5.00,  6.00
   3 ,     gen60_f3 ,      7.0  ,    2.0 (     --- * -   |              ), 4.00,  6.00,  7.00,  8.00,  9.00
   4 ,     gen40_f3 ,      9.0  ,    2.0 (         -- * -|              ), 7.00,  8.00,  9.00, 10.00, 11.00
   5 ,     gen20_f3 ,     11.0  ,    3.0 (            ---| *-           ), 9.00, 11.00, 12.00, 13.00, 14.00
   6 ,      gen0_f3 ,     15.0  ,    2.0 (               |---  *-----   ),11.00, 14.00, 15.00, 16.00, 19.00
```

### Time Taken : 9.60671591759
![1](../../../src/img/paths/CSFDandMarketingSD.png)
...
+------+----------------------------------------------+----------+-------+------+
|  1   |               Provide receipts               |   task   |   -1  |  1   |
|  2   |               Manage Accounts                |   task   |   -1  |  1   |
|  3   |             Manage Receivables               |   task   |   -1  |  1   |
|  4   |         Provide fundraising services         |   task   |   -1  |  1   |
|  5   |         Provide fundraising services         |   task   |   -1  |  1   |
|  6   |             Sponsorship proposal             |   task   |   -1  |  1   |
|  7   |             Pledge\nDuring event             |   task   |   -1  |  1   |
|  8   |                Provide funds                 |   task   |   -1  |  1   |
|  9   |         Manage\nPartner Relationship         |   task   |   -1  |  1   |
|  10  | ! Counselor Speak on Kids Issues in General  |   task   |   -1  |  1   |
|  11  |           National Event Calendar            | resource |   -1  |  1   |
|  12  |             ! Market CS Service              |   task   |   -1  |  1   |
|  13  |              Free advertisement              | resource |   -1  |  1   |
|  14  |            Provide free services             |   task   |   -1  |  1   |
|  15  |                Pledge online                 |   task   |   -1  |  1   |
|  16  |       Provide Document Library System        |   task   |   -1  |  1   |
|  17  |                  Agreement                   | resource |   -1  |  1   |
|  18  |            Participate in events             |   task   |   -1  |  1   |
|  19  |        Use sponsor marketing channels        |   task   |   -1  |  1   |
|  20  |  Get Corporate Partner Information from DL   |   task   |   1   |  1   |
|  21  |       Provide Online Donor Technology        |   task   |   -1  |  1   |
|  22  |           Create General Ledgers             |   task   |   -1  |  1   |
|  23  |        ! Write Articles for Website          |   task   |   -1  |  1   |
|  24  |    Single charitable registration number     | resource |   1   |  1   |
|  25  |        ! Provide compiled call data          |   task   |   -1  |  1   |
|  26  |           Philanthropic donations            |   task   |   -1  |  1   |
|  27  |            Collect Pledge online             |   task   |   -1  |  1   |
|  28  |                 Sponsor Logo                 | resource |   -1  |  1   |
|  29  |           Get sponsors for events            |   task   |   -1  |  1   |
|  30  |                    Funds                     | resource |   -1  |  1   |
|  31  |         ! Provide money for services         |   task   |   -1  |  1   |
