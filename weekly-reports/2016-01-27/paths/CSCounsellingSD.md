...
----------------------------------------------------
   ...
   1 ,     gen20_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f3 ,      3.0  ,    1.0 ( -*            |              ), 2.00,  3.00,  3.00,  3.00,  4.00
   2 ,     gen80_f3 ,      5.0  ,    2.0 (   --*---      |              ), 4.00,  5.00,  5.00,  6.00,  8.00
   3 ,     gen60_f3 ,      8.0  ,    2.0 (      ---*-    |              ), 6.00,  8.00,  8.00,  9.00, 10.00
   4 ,     gen40_f3 ,     11.0  ,    2.0 (          ---*-|              ), 9.00, 11.00, 11.00, 12.00, 14.00
   5 ,     gen20_f3 ,     14.0  ,    2.0 (             --|*--           ),11.00, 13.00, 14.00, 14.00, 16.00
   6 ,      gen0_f3 ,     17.0  ,    3.0 (               |--- * ----    ),13.00, 16.00, 17.00, 18.00, 21.00
```

### Time Taken : 12.8913691044
![1](../../../src/img/paths/CSCounsellingSD.png)
...
|  4   |             Provide Information              |   task   |   -1  |  1   |
|  5   |                Sign Contract                 |   task   |   -1  |  1   |
|  6   |           Information in E-Library           | resource |   -1  |  1   |
|  7   |            Report Outdated Links             |   task   |   -1  |  1   |
|  8   |          *Implement Bulletin Board           |   task   |   -1  |  1   |
|  9   |                   Feedback                   | resource |   -1  |  1   |
|  10  |                    Tapes                     | resource |   -1  |  1   |
|  11  |          Tape Recording Technoloyg           | resource |   -1  |  1   |
|  12  |          !Perform Email Counselling          |   task   |   -1  |  1   |
|  13  |            Participate in events             |   task   |   -1  |  1   |
|  14  |             Provide Counselling              |   task   |   -1  |  1   |
|  15  | ! Counselor Speak on Kids Issues in General  |   task   |   -1  |  1   |
|  16  |       ! Write Articles for Magazines         |   task   |   -1  |  1   |
|  17  |         !Moderate Discussion Boards          |   task   |   -1  |  1   |
...
|  21  |            Information/Resources             | resource |   -1  |  1   |
|  22  |           Create Counselling Posts           |   task   |   -1  |  1   |
|  23  |      Provide Web Counselling with Video      |   task   |   -1  |  1   |
|  24  |           Undergo Clinical Review            |   task   |   -1  |  1   |
|  25  |           Resources in the Library           | resource |   -1  |  1   |
|  26  |            Web Moderator Meetings            | resource |   -1  |  1   |
|  27  |        *Implement Categorization Tool        |   task   |   1   |  1   |
|  28  |             Counselling Policies             | resource |   -1  |  1   |
|  29  |                  Promote CS                  |   task   |   -1  |  1   |
|  30  |               !Moderate a Chat               |   task   |   -1  |  1   |
|  31  |        ! Write Articles for Website          |   task   |   -1  |  1   |
|  32  |                 Training CDs                 | resource |   -1  |  1   |
|  33  |               Double Headsets                | resource |   -1  |  1   |
|  34  |       *Implement Email for Counsellors       |   task   |   -1  |  1   |
|  35  |       Information Binders at Stations        | resource |   -1  |  1   |
+------+----------------------------------------------+----------+-------+------+
```
