...
----------------------------------------------------
   ...
   1 ,     gen40_f1 ,    86.62  ,    5.1 (    -------    | *    -       ),81.53, 84.08, 86.62, 88.54, 89.17
   1 ,     gen60_f1 ,    86.62  ,   4.46 (      ------   | *    -       ),82.17, 84.71, 86.62, 88.54, 89.17
   1 ,     gen80_f1 ,    86.62  ,   4.46 (       -----   | *    ---     ),82.80, 84.71, 86.62, 88.54, 89.81
   1 ,    gen100_f1 ,    86.62  ,   4.46 (       -----   |  *   ---     ),82.80, 84.71, 87.26, 88.54, 89.81

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f2 ,    126.0  ,   13.0 (      --   *   |----          ),117.00, 121.00, 126.00, 133.00, 141.00
   1 ,     gen60_f2 ,    126.0  ,   14.0 (      ----  *  | ----         ),117.00, 124.00, 127.00, 135.00, 143.00
   1 ,     gen80_f2 ,    126.0  ,   14.0 (      ---   *  |----          ),117.00, 122.00, 127.00, 133.00, 141.00
   1 ,     gen40_f2 ,    128.0  ,   15.0 (      ----  *  | ----         ),117.00, 124.00, 128.00, 135.00, 143.00
   2 ,     gen20_f2 ,    130.0  ,   15.0 (      -----   *|  ----        ),117.00, 125.00, 131.00, 138.00, 144.00
   2 ,      gen0_f2 ,    133.0  ,   15.0 (       -----   | * ---        ),118.00, 127.00, 135.00, 139.00, 145.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen40_f3 ,     10.0  ,    3.0 (           --  |*   ---       ), 8.00,  9.00, 10.00, 12.00, 13.00
   1 ,     gen60_f3 ,     10.0  ,    3.0 (           --  |*   ---       ), 8.00,  9.00, 10.00, 12.00, 13.00
   1 ,     gen80_f3 ,     10.0  ,    3.0 (         ----  |*   ---       ), 7.00,  9.00, 10.00, 12.00, 13.00
   1 ,    gen100_f3 ,     10.0  ,    2.0 (         ----  |* -----       ), 7.00,  9.00, 10.00, 11.00, 13.00
   1 ,      gen0_f3 ,     11.0  ,    2.0 (           ----|  * -----     ), 8.00, 10.00, 11.00, 12.00, 14.00
   1 ,     gen20_f3 ,     11.0  ,    3.0 (           ----|  * -----     ), 8.00, 10.00, 11.00, 12.00, 14.00
```

### Time Taken : 72.1255180836
![1](../../../src/img/paths/CSCounsellingManagement.png)
...
+------+-----------------------------------------------------+----------+-------+------+
|  1   |              Attend Part Time Meetings              |   task   |   1   |  1   |
|  2   |               Set Counselling Policies              |   task   |   -1  |  1   |
|  3   |                   Double Head Set                   | resource |   1   |  1   |
|  4   |                 Counsellors Be Paid                 |   task   |   -1  |  1   |
|  5   |           Negotiate with Counsellors Union          |   task   |   -1  |  1   |
|  6   |            Put on Web Moderator Meetings            |   task   |   1   |  1   |
|  7   |             Put On Counselling Workshops            |   task   |   -1  |  1   |
|  8   |      Provide One-on-One Support to Counsellors      |   task   |   1   |  1   |
|  9   | Write Yearly Peformance Evaluations for Counsellors |   task   |   1   |  1   |
|  10  |                    Request Shifts                   |   task   |   -1  |  1   |
|  11  |         Acquire Web Training from Operations        |   task   |   -1  |  1   |
|  12  |                    Debrief Calls                    |   task   |   1   |  1   |
|  13  |           Historical Data of Call Volumes           | resource |   -1  |  1   |
|  14  |                Counselling Resources                | resource |   -1  |  1   |
|  15  |      Put on Orientation Process for Cousellors      |   task   |   1   |  1   |
|  16  |                   Call Statistics                   | resource |   -1  |  1   |
|  17  |              !Hire Counselling Managers             |   task   |   1   |  1   |
|  18  |      Communicate CS Information to Counsellors      |   task   |   -1  |  1   |
|  19  |        Create Call Classification Catagories        |   task   |   -1  |  1   |
|  20  |                     Review Tape                     |   task   |   -1  |  1   |
|  21  |                   Use Blue Pumpkin                  |   task   |   -1  |  1   |
