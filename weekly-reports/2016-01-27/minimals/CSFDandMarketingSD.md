...
----------------------------------------------------
   ...
   1 ,     gen12_f1 ,    96.77  ,   3.23 (*              |              ),96.77, 96.77, 96.77, 100.00, 100.00
   1 ,     gen16_f1 ,    96.77  ,   3.23 (*              |              ),96.77, 96.77, 96.77, 100.00, 100.00
   1 ,     gen20_f1 ,    96.77  ,   3.23 (*              |              ),96.77, 96.77, 96.77, 100.00, 100.00
...
----------------------------------------------------
   ...
   1 ,     gen12_f2 ,     29.0  ,    0.0 (*              |              ),29.00, 29.00, 29.00, 29.00, 29.00
   1 ,     gen16_f2 ,     29.0  ,    0.0 (*              |              ),29.00, 29.00, 29.00, 29.00, 29.00
   1 ,     gen20_f2 ,     29.0  ,    0.0 (*              |              ),29.00, 29.00, 29.00, 29.00, 29.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen20_f3 ,     11.0  ,    3.0 (     ----  * --|              ), 9.00, 11.00, 12.00, 13.00, 14.00
   1 ,     gen16_f3 ,     12.0  ,    2.0 (     ----  * --|-             ), 9.00, 11.00, 12.00, 13.00, 15.00
   2 ,     gen12_f3 ,     13.0  ,    3.0 (       ----  * |-             ),10.00, 12.00, 13.00, 14.00, 15.00
   3 ,      gen4_f3 ,     14.0  ,    3.0 (         ----  * ----         ),11.00, 13.00, 14.00, 15.00, 17.00
   3 ,      gen8_f3 ,     14.0  ,    2.0 (       ----    *---           ),10.00, 12.00, 14.00, 14.00, 16.00
   4 ,      gen0_f3 ,     15.0  ,    2.0 (         ------| * ------     ),11.00, 14.00, 15.00, 16.00, 19.00
```

### Time Taken : 4.77158999443
![1](../../../src/img/minimals/CSFDandMarketingSD.png)
...
|  2   |                  Agreement                   | resource |   -1  |  1   |
|  3   |              Free advertisement              | resource |   -1  |  1   |
|  4   |               Provide receipts               |   task   |   1   |  1   |
|  5   | ! Counselor Speak on Kids Issues in General  |   task   |   -1  |  1   |
|  6   |                 Sponsor Logo                 | resource |   -1  |  1   |
|  7   |  Get Corporate Partner Information from DL   |   task   |   1   |  1   |
|  8   |           National Event Calendar            | resource |   -1  |  1   |
|  9   |                Pledge online                 |   task   |   -1  |  1   |
|  10  |            Participate in events             |   task   |   1   |  1   |
|  11  |             ! Market CS Service              |   task   |   -1  |  1   |
|  12  |             Sponsorship proposal             |   task   |   -1  |  1   |
|  13  |       ! Write Articles for Magazines         |   task   |   -1  |  1   |
|  14  |        ! Write Articles for Website          |   task   |   -1  |  1   |
...
|  21  |                Provide funds                 |   task   |   1   |  1   |
|  22  |             Manage Receivables               |   task   |   -1  |  1   |
|  23  |           Philanthropic donations            |   task   |   -1  |  1   |
|  24  |            Provide free services             |   task   |   -1  |  1   |
|  25  |         Manage\nPartner Relationship         |   task   |   -1  |  1   |
|  26  |           Get sponsors for events            |   task   |   1   |  1   |
|  27  |               Manage Accounts                |   task   |   -1  |  1   |
|  28  |        Use sponsor marketing channels        |   task   |   1   |  1   |
|  29  |           Create General Ledgers             |   task   |   -1  |  1   |
|  30  |            Collect Pledge online             |   task   |   -1  |  1   |
|  31  |                    Funds                     | resource |   -1  |  1   |
|  32  |       Provide Document Library System        |   task   |   -1  |  1   |
+------+----------------------------------------------+----------+-------+------+
```
