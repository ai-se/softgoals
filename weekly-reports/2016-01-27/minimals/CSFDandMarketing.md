...
----------------------------------------------------
   ...
   1 ,     gen12_f1 ,    84.95  ,   6.98 (       ------  | *  ----      ),77.42, 81.72, 84.95, 87.10, 89.78
   1 ,     gen16_f1 ,    84.95  ,   5.91 (       ------- | *  ----      ),77.42, 82.26, 84.95, 87.10, 89.78
   1 ,     gen20_f1 ,    84.95  ,   5.91 (       ------- | *   ---      ),77.42, 82.26, 84.95, 87.63, 89.78

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen16_f2 ,    200.0  ,   24.0 (       ----   *|  -----       ),178.00, 192.00, 201.00, 212.00, 229.00
   1 ,     gen20_f2 ,    200.0  ,   24.0 (       ----   *|  -----       ),178.00, 192.00, 201.00, 212.00, 229.00
   1 ,     gen12_f2 ,    203.0  ,   29.0 (       ------  |* -----       ),179.00, 196.00, 206.00, 213.00, 229.00
...
----------------------------------------------------
   ...
   1 ,     gen12_f3 ,     34.0  ,    5.0 (            ---|  *   ----    ),30.00, 32.00, 34.00, 36.00, 39.00
   1 ,     gen16_f3 ,     34.0  ,    5.0 (           ----|  *   ---     ),29.00, 32.00, 34.00, 36.00, 38.00
   1 ,     gen20_f3 ,     34.0  ,    5.0 (           ----|  *   ---     ),29.00, 32.00, 34.00, 36.00, 38.00
```

### Time Taken : 201.442534924
![1](../../../src/img/minimals/CSFDandMarketing.png)
...
+------+--------------------------------------------------------------------------+----------+-------+------+
|  1   |                      Provide philanthropic donation                      |   task   |   -1  |  1   |
|  2   |                    Put on orientation for volunteers                     |   task   |   1   |  1   |
|  3   |                    Market [Only For Serious Issues]                      |   task   |   1   |  1   |
|  4   |      Sponsors Include CS Logos and Descriptions on their Products        |   task   |   1   |  1   |
|  5   |                      Share PAP in Document Library1                      |   task   |   1   |  1   |
|  6   |                     Implement Stay in Touch program                      |   task   |   -1  |  1   |
|  7   |                        Donor/Accounting Database                         | resource |   -1  |  1   |
|  8   |                       National Marketing Strategy                        | resource |   1   |  1   |
|  9   |           Provide Promotional Material to Student Ambassadors            |   task   |   1   |  1   |
|  10  |                          Create Thank you ads                            |   task   |   1   |  1   |
|  11  |                          Provide free services1                          |   task   |   -1  |  1   |
|  12  |                  Store donor information into database                   |   task   |   1   |  1   |
|  13  |                          Participate in events                           |   task   |   1   |  1   |
|  14  |                     Provide Real Time Tax Receipts                       |   task   |   -1  |  1   |
|  15  |                    Organize discussions with Sponsors                    |   task   |   1   |  1   |
|  16  |                      Elaborate Fundraising targets1                      |   task   |   -1  |  1   |
|  17  |                      Place Sponsor Logos in Events                       |   task   |   -1  |  1   |
|  18  |                   !Train counselors on public speaking                   |   task   |   -1  |  1   |
|  19  |                Get Corporate Partner Information from DL1                |   task   |   1   |  1   |
|  20  |              ! Counselor Speak on Kids Issues in General 1               |   task   |   1   |  1   |
|  21  |                       Exclusive Brand and Logo use                       | resource |   1   |  1   |
|  22  |                     Develop national event calendar                      |   task   |   1   |  1   |
|  23  |                          Reallocate resources1                           |   task   |   -1  |  1   |
|  24  |                     ! Write Articles for Magazines 1                     |   task   |   1   |  1   |
|  25  |                          Use volunteer services                          |   task   |   1   |  1   |
|  26  |                       Inform Sponsors of Progress                        |   task   |   1   |  1   |
|  27  |                      ! Write Articles for Website 1                      |   task   |   -1  |  1   |
|  28  |                             Reach agreement                              |   task   |   1   |  1   |
|  29  |                            Free advertisement                            | resource |   -1  |  1   |
|  30  |                              Track budgets                               |   task   |   1   |  1   |
|  31  |                             Manage Accounts                              |   task   |   -1  |  1   |
|  32  |                  Single charitable registration number1                  | resource |   -1  |  1   |
|  33  |                       Get philanthropic donations                        |   task   |   1   |  1   |
|  34  |                        Collect donor information                         |   task   |   -1  |  1   |
|  35  |                       Market through own channels                        |   task   |   1   |  1   |
|  36  |                       Give philanthropic donation                        |   task   |   -1  |  1   |
...
|  39  |                Write Down Corporate Sponsors Objectives                  |   task   |   -1  |  1   |
|  40  |                           Reallocate resources                           |   task   |   1   |  1   |
|  41  |                         Create General Ledgers                           |   task   |   1   |  1   |
|  42  |                            Provide Logo to CS                            |   task   |   1   |  1   |
|  43  |                        Run Fundraiser in Schools                         |   task   |   -1  |  1   |
|  44  |            Create posters, flyers and informational material             |   task   |   1   |  1   |
|  45  |                     Provide Document Library System                      |   task   |   1   |  1   |
|  46  |                       ! Provide money for services                       |   task   |   1   |  1   |
|  47  |                          Give CS Presentations                           |   task   |   1   |  1   |
|  48  |                           Pledge\nDuring event                           |   task   |   -1  |  1   |
|  49  |          Bring Regional Fundraising Staff Together Once a Year           |   task   |   -1  |  1   |
|  50  |                           Manage Receivables                             |   task   |   -1  |  1   |
|  51  |      Email Corporate Partners Interesting and Relevant News Pieces       |   task   |   -1  |  1   |
|  52  |                      ! Provide compiled call data                        |   task   |   1   |  1   |
|  53  |                            Get donor database                            |   task   |   -1  |  1   |
|  54  |                          Provide free services                           |   task   |   1   |  1   |
|  55  |                Work with the Regions to Implement Events                 |   task   |   1   |  1   |
|  56  |                              Pledge\nonline                              |   task   |   1   |  1   |
|  57  |                        Get web event technology1                         |   task   |   1   |  1   |
|  58  |                Pay Fund Development and Marketing Staff                  |   task   |   1   |  1   |
|  59  |              Put Together Proposals for Corporate Sponsors               |   task   |   1   |  1   |
|  60  |                          Conflicts Be Managed                            |   task   |   1   |  1   |
|  61  |                      Share PAP in Document Library                       |   task   |   1   |  1   |
|  62  | Pitch to National Corporate Sponsors the Sponsorship of Regional Events  |   task   |   1   |  1   |
|  63  |                         Create branded products                          |   task   |   -1  |  1   |
|  64  |                       Bi-Weekly Conference Calls                         |   task   |   1   |  1   |
|  65  |                           Speak at Fundraisers                           |   task   |   -1  |  1   |
|  66  |                              Provide funds                               |   task   |   -1  |  1   |
|  67  |                  Store donor transactions into database                  |   task   |   -1  |  1   |
|  68  |                         Send recognition letters                         |   task   |   -1  |  1   |
|  69  |                  Communicate through Internet and phone                  |   task   |   -1  |  1   |
+------+--------------------------------------------------------------------------+----------+-------+------+
```
