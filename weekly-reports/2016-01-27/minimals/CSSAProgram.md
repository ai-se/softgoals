...
----------------------------------------------------
   ...
   1 ,      gen4_f1 ,    64.18  ,   19.4 (      ---     *|------        ),47.76, 53.73, 64.18, 68.66, 79.10
   1 ,      gen8_f1 ,    64.18  ,   19.4 (      ---     *|-------       ),47.76, 53.73, 64.18, 68.66, 80.60
   1 ,     gen12_f1 ,    64.18  ,  17.91 (      ---     *|  -----       ),47.76, 55.22, 64.18, 71.64, 80.60
   1 ,     gen16_f1 ,    64.18  ,  17.91 (      ---     *|  -----       ),47.76, 55.22, 64.18, 71.64, 80.60
   1 ,     gen20_f1 ,    64.18  ,  17.91 (      ----    *|  -----       ),47.76, 56.72, 64.18, 71.64, 80.60

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,     36.0  ,   11.0 (    ------  *  |  ---         ),26.00, 34.00, 36.00, 44.00, 48.00
   1 ,      gen4_f2 ,     36.0  ,   11.0 (  -------   *  | ----         ),24.00, 33.00, 36.00, 43.00, 47.00
   1 ,      gen8_f2 ,     36.0  ,   11.0 (  -------   *  | ----         ),24.00, 33.00, 36.00, 43.00, 47.00
   1 ,     gen12_f2 ,     36.0  ,   11.0 (  -------   *  | ---          ),24.00, 33.00, 36.00, 42.00, 46.00
   1 ,     gen16_f2 ,     36.0  ,   11.0 (  -------   *  | ---          ),24.00, 33.00, 36.00, 42.00, 46.00
   1 ,     gen20_f2 ,     36.0  ,    9.0 (  -------   *  |----          ),24.00, 33.00, 36.00, 41.00, 46.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen12_f3 ,      5.0  ,    2.0 (        *  ----|----          ), 4.00,  4.00,  5.00,  6.00,  9.00
   1 ,     gen16_f3 ,      5.0  ,    2.0 (        *  ----|----          ), 4.00,  4.00,  5.00,  6.00,  9.00
   1 ,     gen20_f3 ,      5.0  ,    2.0 (        *  ----|----          ), 4.00,  4.00,  5.00,  6.00,  9.00
   1 ,      gen4_f3 ,      5.0  ,    3.0 (           *---|----          ), 4.00,  4.00,  6.00,  6.00,  9.00
   1 ,      gen8_f3 ,      5.0  ,    2.0 (           *---|----          ), 4.00,  4.00,  6.00,  6.00,  9.00
   1 ,      gen0_f3 ,      6.0  ,    3.0 (     ---   *---|----          ), 4.00,  5.00,  6.00,  6.00,  9.00
```

### Time Taken : 9.93308186531
![1](../../../src/img/minimals/CSSAProgram.png)
...
|  2   |    Help with Presentations    |   task   |   1   |  1   |
|  3   |          Retrain SA s         |   task   |   1   |  1   |
|  4   |       Attend SA Meetings      |   task   |   1   |  1   |
|  5   |           Train SA s          |   task   |   1   |  1   |
|  6   |   Run Fundraiser in Schools1  |   task   |   1   |  1   |
|  7   |        Send out Emails        |   task   |   -1  |  1   |
|  8   |       Plan Social Events      |   task   |   -1  |  1   |
|  9   |       Attend CS Meetings      |   task   |   1   |  1   |
|  10  |      Promotion Resources1     | resource |   1   |  1   |
|  11  | School Initiates Presenation1 |   task   |   -1  |  1   |
|  12  |        Provide Speaches       |   task   |   -1  |  1   |
+------+-------------------------------+----------+-------+------+
```
