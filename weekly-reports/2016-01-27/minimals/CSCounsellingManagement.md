...
----------------------------------------------------
   ...
   1 ,     gen12_f1 ,    85.99  ,   4.46 (    -------    *    ---       ),81.53, 84.08, 85.99, 87.90, 89.17
   1 ,     gen16_f1 ,    85.99  ,   4.46 (    -------    *    ---       ),81.53, 84.08, 85.99, 87.90, 89.17
   1 ,     gen20_f1 ,    85.99  ,   4.46 (    -------    *    ---       ),81.53, 84.08, 85.99, 87.90, 89.17

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen16_f2 ,    130.0  ,   15.0 (      -----   *|  ----        ),117.00, 125.00, 131.00, 138.00, 144.00
   1 ,     gen20_f2 ,    130.0  ,   15.0 (      -----   *|  ----        ),117.00, 125.00, 131.00, 138.00, 144.00
   1 ,     gen12_f2 ,    131.0  ,   15.0 (      -----    *   ---        ),117.00, 125.00, 132.00, 139.00, 144.00
...
----------------------------------------------------
   ...
   1 ,     gen12_f3 ,     11.0  ,    3.0 (     ------   *| ------       ), 8.00, 10.00, 11.00, 12.00, 14.00
   1 ,     gen16_f3 ,     11.0  ,    3.0 (     ------   *| ------       ), 8.00, 10.00, 11.00, 12.00, 14.00
   1 ,     gen20_f3 ,     11.0  ,    3.0 (     ------   *| ------       ), 8.00, 10.00, 11.00, 12.00, 14.00
```

### Time Taken : 29.0450620651
![1](../../../src/img/minimals/CSCounsellingManagement.png)
...
+------+-----------------------------------------------------+----------+-------+------+
|  1   |                    Debrief Calls                    |   task   |   1   |  1   |
|  2   |      Put on Orientation Process for Cousellors      |   task   |   1   |  1   |
|  3   |        Create Call Classification Catagories        |   task   |   1   |  1   |
|  4   |           Negotiate with Counsellors Union          |   task   |   -1  |  1   |
|  5   |                 Counsellors Be Paid                 |   task   |   -1  |  1   |
|  6   |                    Request Shifts                   |   task   |   1   |  1   |
|  7   |            Put on Web Moderator Meetings            |   task   |   1   |  1   |
|  8   |                Counselling Resources                | resource |   -1  |  1   |
|  9   |         Acquire Web Training from Operations        |   task   |   1   |  1   |
|  10  |              Attend Part Time Meetings              |   task   |   1   |  1   |
|  11  |              !Hire Counselling Managers             |   task   |   1   |  1   |
|  12  |               Set Counselling Policies              |   task   |   -1  |  1   |
|  13  |                   Call Statistics                   | resource |   1   |  1   |
|  14  |             Put On Counselling Workshops            |   task   |   -1  |  1   |
|  15  |           Historical Data of Call Volumes           | resource |   -1  |  1   |
|  16  |                  !Hire Counsellors                  |   task   |   -1  |  1   |
|  17  |                  Debrief Web Posts                  |   task   |   -1  |  1   |
|  18  | Write Yearly Peformance Evaluations for Counsellors |   task   |   -1  |  1   |
|  19  |                   Double Head Set                   | resource |   -1  |  1   |
|  20  |      Provide One-on-One Support to Counsellors      |   task   |   1   |  1   |
|  21  |      Communicate CS Information to Counsellors      |   task   |   -1  |  1   |
|  22  |                     Review Tape                     |   task   |   -1  |  1   |
|  23  |                   Use Blue Pumpkin                  |   task   |   -1  |  1   |
+------+-----------------------------------------------------+----------+-------+------+
```
...
|                     *Happiness of Counsellors                      | softgoal |   1   |
