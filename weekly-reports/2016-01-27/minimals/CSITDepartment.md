...
----------------------------------------------------
   ...
   1 ,     gen12_f1 ,    85.25  ,   8.19 (      ---------|  *  ---      ),73.77, 81.97, 85.25, 88.52, 91.80
   1 ,     gen16_f1 ,    85.25  ,   8.19 (      ---------|  *  ---      ),73.77, 81.97, 85.25, 88.52, 91.80
   1 ,     gen20_f1 ,    85.25  ,   8.19 (      ---------|  *  ---      ),73.77, 81.97, 85.25, 88.52, 91.80

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen12_f2 ,     68.0  ,   10.0 (      -------- |*  ---        ),52.00, 64.00, 68.00, 72.00, 77.00
   1 ,     gen16_f2 ,     68.0  ,   10.0 (      -------- |*  ---        ),52.00, 64.00, 68.00, 72.00, 77.00
...
----------------------------------------------------
   ...
   1 ,     gen12_f3 ,      9.0  ,    3.0 (------       * |-------       ), 6.00,  8.00, 10.00, 11.00, 13.00
   1 ,     gen16_f3 ,      9.0  ,    3.0 (------       * |-------       ), 6.00,  8.00, 10.00, 11.00, 13.00
   1 ,     gen20_f3 ,      9.0  ,    3.0 (------       * |-------       ), 6.00,  8.00, 10.00, 11.00, 13.00
```

### Time Taken : 12.0071599483
![1](../../../src/img/minimals/CSITDepartment.png)
...
|  3   |                     Hardware                    | resource |   -1  |  1   |
|  4   |            !Implement Phone Feedback1           |   task   |   1   |  1   |
|  5   |                     Software                    | resource |   1   |  1   |
|  6   |                     Use VPN                     |   task   |   1   |  1   |
|  7   |                 Free Web Server                 | resource |   1   |  1   |
|  8   | Provide Technology to Create and Send Documents |   task   |   -1  |  1   |
|  9   |                   Network PCs                   |   task   |   -1  |  1   |
|  10  |                     Upgrades                    | resource |   -1  |  1   |
|  11  |            Put Content Onto Website1            |   task   |   -1  |  1   |
|  12  |         Provide Online Donor Technology1        |   task   |   -1  |  1   |
|  13  |      Use Informal Buddy System for Training     |   task   |   1   |  1   |
|  14  |  Perform Donor/Accounting Data Base Maintenance |   task   |   -1  |  1   |
|  15  |                Use Current Method               |   task   |   1   |  1   |
|  16  |         *Implement Email for Counsellors        |   task   |   -1  |  1   |
|  17  |                  Free Hardware                  | resource |   1   |  1   |
|  18  |                   Web Server1                   | resource |   -1  |  1   |
|  19  |                   IT Resources                  | resource |   -1  |  1   |
|  20  |                  Free Upgrades                  | resource |   -1  |  1   |
