...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,     87.9  ,   3.18 (           ----|   *  ---     ),84.71, 86.62, 87.90, 89.17, 90.45
   2 ,     gen40_f1 ,     87.9  ,   3.18 (             - |   *  ---     ),85.35, 85.99, 87.90, 89.17, 90.45
   2 ,     gen80_f1 ,     87.9  ,   4.46 (          ---- |   *  ---     ),84.08, 85.99, 87.90, 89.17, 90.45
   2 ,    gen100_f1 ,     87.9  ,   3.83 (          -    |   * --       ),84.08, 84.71, 87.90, 88.54, 89.81
   2 ,     gen60_f1 ,     87.9  ,   2.55 (             --|-    *---     ),85.35, 87.26, 88.54, 89.17, 90.45

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    133.0  ,   15.0 (       -----   | * ---        ),118.00, 127.00, 135.00, 139.00, 145.00
   1 ,    gen100_f2 ,    137.0  ,   11.0 (         ----- |  * ---       ),123.00, 131.00, 137.00, 141.00, 146.00
   1 ,     gen80_f2 ,    137.0  ,   12.0 (         ------|  *  --       ),122.00, 133.00, 138.00, 142.00, 146.00
   1 ,     gen40_f2 ,    138.0  ,   15.0 (           --- |   *  -       ),126.00, 131.00, 139.00, 144.00, 146.00
   1 ,     gen20_f2 ,    139.0  ,   14.0 (           ----|   *  -       ),125.00, 133.00, 139.00, 144.00, 146.00
   1 ,     gen60_f2 ,    139.0  ,   13.0 (            ---|   *----      ),127.00, 133.00, 139.00, 141.00, 148.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f3 ,      3.0  ,    2.0 ( ----* ----    |              ), 1.00,  3.00,  3.00,  4.00,  6.00
   2 ,     gen80_f3 ,      4.0  ,    3.0 (       * ----  |              ), 3.00,  3.00,  4.00,  5.00,  7.00
   3 ,     gen60_f3 ,      6.0  ,    3.0 (     --    *-  |              ), 3.00,  4.00,  6.00,  6.00,  7.00
   4 ,     gen40_f3 ,      6.0  ,    2.0 (         --  *-|              ), 5.00,  6.00,  7.00,  7.00,  9.00
   5 ,     gen20_f3 ,      9.0  ,    3.0 (           --- |* ----        ), 6.00,  8.00,  9.00, 10.00, 12.00
   6 ,      gen0_f3 ,     11.0  ,    2.0 (              -|--  * ----    ), 8.00, 10.00, 11.00, 12.00, 14.00
```

### Time Taken : 61.4923210144
![1](../../../src/img/cdom/CSCounsellingManagement.png)
...
|  2   |              Attend Part Time Meetings              |   task   |   -1  |  1   |
|  3   |               Set Counselling Policies              |   task   |   -1  |  1   |
|  4   |         Acquire Web Training from Operations        |   task   |   -1  |  1   |
|  5   |                   Double Head Set                   | resource |   -1  |  1   |
|  6   |                   Use Blue Pumpkin                  |   task   |   -1  |  1   |
|  7   |                  !Hire Counsellors                  |   task   |   -1  |  1   |
|  8   |              !Hire Counselling Managers             |   task   |   -1  |  1   |
|  9   |           Historical Data of Call Volumes           | resource |   -1  |  1   |
|  10  |             Put On Counselling Workshops            |   task   |   -1  |  1   |
|  11  |                    Request Shifts                   |   task   |   -1  |  1   |
|  12  |           Negotiate with Counsellors Union          |   task   |   -1  |  1   |
|  13  |      Provide One-on-One Support to Counsellors      |   task   |   -1  |  1   |
|  14  |      Communicate CS Information to Counsellors      |   task   |   -1  |  1   |
|  15  | Write Yearly Peformance Evaluations for Counsellors |   task   |   -1  |  1   |
|  16  |                 Counsellors Be Paid                 |   task   |   -1  |  1   |
|  17  |                    Debrief Calls                    |   task   |   -1  |  1   |
|  18  |                     Review Tape                     |   task   |   -1  |  1   |
|  19  |      Put on Orientation Process for Cousellors      |   task   |   1   |  1   |
|  20  |                   Call Statistics                   | resource |   1   |  1   |
|  21  |                Counselling Resources                | resource |   -1  |  1   |
|  22  |            Put on Web Moderator Meetings            |   task   |   -1  |  1   |
