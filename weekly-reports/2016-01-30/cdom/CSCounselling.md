...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    87.14  ,   4.28 (              -|--- * ---     ),81.90, 85.71, 87.14, 89.05, 90.95
   2 ,     gen40_f1 ,     88.1  ,   3.33 (               |---- * --     ),83.33, 86.67, 88.10, 89.52, 91.43
   3 ,     gen60_f1 ,     88.1  ,   3.33 (               |----  *---    ),83.81, 87.14, 88.57, 89.52, 91.90
   3 ,     gen80_f1 ,     88.1  ,   3.33 (               | ---  *----   ),84.29, 87.14, 88.57, 89.52, 93.33
   3 ,    gen100_f1 ,    89.05  ,   2.86 (               | ---  *----   ),84.29, 87.14, 89.05, 90.00, 93.33

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    164.0  ,   25.0 (    ----    *  | ----         ),148.00, 157.00, 166.00, 179.00, 189.00
   2 ,     gen20_f2 ,    176.0  ,   18.0 (         ---   |*  --         ),160.00, 167.00, 176.00, 182.00, 189.00
   2 ,     gen40_f2 ,    176.0  ,   17.0 (         ----  |*  ---        ),160.00, 169.00, 177.00, 184.00, 190.00
   2 ,     gen60_f2 ,    178.0  ,   18.0 (         ----  | *  -----     ),160.00, 170.00, 179.00, 185.00, 197.00
   2 ,     gen80_f2 ,    179.0  ,   16.0 (          ---  | * ------     ),162.00, 170.00, 179.00, 184.00, 197.00
   2 ,    gen100_f2 ,    179.0  ,   16.0 (          ---  |  * -----     ),162.00, 170.00, 180.00, 185.00, 197.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen80_f3 ,     24.0  ,    4.0 (   -----    *  |---           ),19.00, 22.00, 24.00, 26.00, 28.00
   1 ,    gen100_f3 ,     24.0  ,    4.0 (   -----    * -|---           ),19.00, 22.00, 24.00, 25.00, 28.00
   1 ,     gen40_f3 ,     25.0  ,    5.0 (       ---    *| -----        ),21.00, 23.00, 25.00, 27.00, 30.00
   1 ,     gen60_f3 ,     25.0  ,    4.0 (     ---      *|---           ),20.00, 22.00, 25.00, 26.00, 28.00
   2 ,     gen20_f3 ,     25.0  ,    4.0 (        ----   * -----        ),22.00, 24.00, 26.00, 27.00, 30.00
   2 ,      gen0_f3 ,     26.0  ,    4.0 (        ------ | * -------    ),22.00, 25.00, 27.00, 28.00, 32.00
```

### Time Taken : 240.309094906
![1](../../../src/img/cdom/CSCounselling.png)
...
+------+----------------------------------------------------+----------+-------+------+
|  1   |          Provide Resources in One Source           |   task   |   1   |  1   |
|  2   | Include Legal Information in Counselling Resources |   task   |   -1  |  1   |
|  3   |                 *Explore Options1                  |   task   |   1   |  1   |
|  4   |             Tape Recording Technology              | resource |   -1  |  1   |
|  5   |           *Implement Categorization Tool           |   task   |   -1  |  1   |
|  6   |               Report Outdated Links1               |   task   |   1   |  1   |
|  7   |              !Undergo Media Training               |   task   |   1   |  1   |
|  8   |              *Edit Counselling Posts               |   task   |   1   |  1   |
|  9   |               Learn Web Technologies               |   task   |   -1  |  1   |
|  10  |             *Implement Bulletin Board1             |   task   |   -1  |  1   |
|  11  |          ! Write Articles for Magazines 1          |   task   |   -1  |  1   |
|  12  |  *Encourage Kids to Talk to Different Counsellors  |   task   |   1   |  1   |
|  13  |              Speak Publicly about Job              |   task   |   -1  |  1   |
|  14  |      Perform Conference Call with Third Party      |   task   |   -1  |  1   |
|  15  |                   Request Shifts                   |   task   |   -1  |  1   |
|  16  |          *Receive Training from Managment          |   task   |   -1  |  1   |
|  17  |     Provide Information to Other Counselloers      |   task   |   1   |  1   |
|  18  |           Provide Resources in E-Library           |   task   |   -1  |  1   |
|  19  |            Perform Crisis Intervention             |   task   |   1   |  1   |
|  20  |                  Assess Situation                  |   task   |   -1  |  1   |
|  21  |        Sign Contract with Counselling Union        |   task   |   1   |  1   |
|  22  |          !Participate in Sponsor Meetings          |   task   |   -1  |  1   |
|  23  |                  *Explore Options                  |   task   |   1   |  1   |
|  24  |                Refer Parents to PHL                |   task   |   1   |  1   |
|  25  |           Provide Information in Binders           |   task   |   1   |  1   |
|  26  |              Speak at SA Conferences               |   task   |   -1  |  1   |
|  27  |   ! Counselor Speak on Kids Issues in General 1    |   task   |   -1  |  1   |
|  28  |          Encourage Kids to Talk to Others          |   task   |   -1  |  1   |
|  29  |           !Participate in Board Meetings           |   task   |   -1  |  1   |
|  30  |                   Report Abuses                    |   task   |   1   |  1   |
|  31  |               Participate in events1               |   task   |   1   |  1   |
|  32  |                       Tapes                        | resource |   -1  |  1   |
|  33  |                      Feedback                      | resource |   -1  |  1   |
|  34  |           ! Write Articles for Website 1           |   task   |   -1  |  1   |
|  35  |               Web Moderator Meetings               | resource |   -1  |  1   |
|  36  |            Diffuse Conflict with Parent            |   task   |   1   |  1   |
|  37  |       Comment on Technology Usability Issues       |   task   |   -1  |  1   |
|  38  |                 Assess Situation1                  |   task   |   -1  |  1   |
|  39  |               Counselling Workshops                | resource |   1   |  1   |
|  40  |                Counselling Policies                | resource |   -1  |  1   |
|  41  |            Provide Resources in Library            |   task   |   -1  |  1   |
|  42  |              Attend Part Time Meeting              |   task   |   -1  |  1   |
|  43  |     Listen to Calls of Experienced Counsellors     |   task   |   -1  |  1   |
|  44  |            Remove Identifying Material             |   task   |   1   |  1   |
|  45  |                   Record Stories                   |   task   |   -1  |  1   |
|  46  |             Encourage Kids to Call CS              |   task   |   -1  |  1   |
|  47  |   Block Kids who Display Inappropriate Behavoir    |   task   |   -1  |  1   |
|  48  | Include Drug Information in Counselling Resources  |   task   |   1   |  1   |
|  49  |                  Listen for Cues                   |   task   |   -1  |  1   |
|  50  |                    Training CDs                    | resource |   -1  |  1   |
|  51  |        Receive Call Classification Training        |   task   |   -1  |  1   |
|  52  |                  Double Headsets                   | resource |   -1  |  1   |
|  53  |              Debrief with Counsellors              |   task   |   1   |  1   |
|  54  |         *Implement Email for Counsellors1          |   task   |   -1  |  1   |
+------+----------------------------------------------------+----------+-------+------+
```
