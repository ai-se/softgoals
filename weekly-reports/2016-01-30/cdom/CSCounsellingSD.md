...
----------------------------------------------------
   ...
   1 ,     gen40_f1 ,    100.0  ,   3.03 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
   1 ,     gen60_f1 ,    100.0  ,   3.03 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
   1 ,     gen80_f1 ,    100.0  ,   3.03 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
   1 ,    gen100_f1 ,    100.0  ,   3.03 (               |             *),96.97, 96.97, 100.00, 100.00, 100.00
...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f3 ,      8.0  ,    2.0 (      -  *     |              ), 6.00,  7.00,  8.00,  8.00,  9.00
   2 ,     gen80_f3 ,      8.0  ,    2.0 (       -- *--  |              ), 7.00,  8.00,  9.00, 10.00, 11.00
   3 ,     gen60_f3 ,     10.0  ,    3.0 (         --  *-|              ), 8.00, 10.00, 11.00, 12.00, 13.00
   4 ,     gen40_f3 ,     12.0  ,    3.0 (           -- *|---           ),10.00, 11.00, 12.00, 14.00, 16.00
   5 ,     gen20_f3 ,     14.0  ,    3.0 (              -|*  ---        ),12.00, 13.00, 14.00, 16.00, 18.00
   6 ,      gen0_f3 ,     17.0  ,    3.0 (               |--- * ----    ),13.00, 16.00, 17.00, 18.00, 21.00
```

### Time Taken : 11.3596489429
![1](../../../src/img/cdom/CSCounsellingSD.png)
...
+------+----------------------------------------------+----------+-------+------+
|  1   |       *Implement Email for Counsellors       |   task   |   -1  |  1   |
|  2   |            Report Outdated Links             |   task   |   -1  |  1   |
|  3   |            Information/Resources             | resource |   -1  |  1   |
|  4   |                   Feedback                   | resource |   -1  |  1   |
|  5   |           Create Counselling Posts           |   task   |   -1  |  1   |
|  6   |            Counselling Workshops             | resource |   -1  |  1   |
|  7   |         Web Counselling be Performed         |   task   |   -1  |  1   |
|  8   |          *Implement Bulletin Board           |   task   |   -1  |  1   |
|  9   |             Counselling Policies             | resource |   -1  |  1   |
|  10  |      Provide Web Counselling with Audio      |   task   |   -1  |  1   |
|  11  |               Double Headsets                | resource |   -1  |  1   |
|  12  |         !Moderate Discussion Boards          |   task   |   -1  |  1   |
|  13  |             Provide Information              |   task   |   -1  |  1   |
|  14  |            Web Moderator Meetings            | resource |   -1  |  1   |
|  15  |            Participate in events             |   task   |   -1  |  1   |
|  16  |           Resources in the Library           | resource |   -1  |  1   |
|  17  |      Provide Web Counselling with Video      |   task   |   -1  |  1   |
|  18  |                 Training CDs                 | resource |   -1  |  1   |
|  19  |          Tape Recording Technoloyg           | resource |   -1  |  1   |
|  20  |               Web Site Content               | resource |   -1  |  1   |
|  21  |       ! Write Articles for Magazines         |   task   |   -1  |  1   |
|  22  |          !Perform Email Counselling          |   task   |   -1  |  1   |
|  23  |        ! Write Articles for Website          |   task   |   -1  |  1   |
|  24  |            Counsellor Experience             | resource |   -1  |  1   |
|  25  |                Sign Contract                 |   task   |   -1  |  1   |
|  26  | ! Counselor Speak on Kids Issues in General  |   task   |   -1  |  1   |
|  27  |           Undergo Clinical Review            |   task   |   -1  |  1   |
|  28  |                    Tapes                     | resource |   -1  |  1   |
|  29  |       Information Binders at Stations        | resource |   -1  |  1   |
|  30  |         Provide Written Counselling          |   task   |   -1  |  1   |
|  31  |                  Promote CS                  |   task   |   -1  |  1   |
|  32  |             Provide Counselling              |   task   |   -1  |  1   |
|  33  |        *Implement Categorization Tool        |   task   |   1   |  1   |
|  34  |               !Moderate a Chat               |   task   |   1   |  1   |
|  35  |           Information in E-Library           | resource |   -1  |  1   |
+------+----------------------------------------------+----------+-------+------+
```
