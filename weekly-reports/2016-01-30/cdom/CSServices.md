...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    65.07  ,   7.66 (              -|   * -----    ),59.33, 61.72, 66.03, 68.90, 76.08
   2 ,     gen40_f1 ,    67.94  ,    6.7 (               |--  * ------  ),61.72, 65.07, 67.94, 70.81, 77.99
   3 ,     gen60_f1 ,    68.42  ,   8.61 (               | --  * -----  ),63.64, 66.03, 68.42, 72.25, 77.99
   3 ,     gen80_f1 ,     68.9  ,   9.09 (               | --- *   ---  ),64.11, 66.99, 68.90, 74.64, 77.99
   3 ,    gen100_f1 ,     68.9  ,   8.13 (               |  -- *   ---  ),65.07, 67.46, 68.90, 74.64, 77.99

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    146.0  ,   83.0 ( -----        *|---           ),73.00, 106.00, 149.00, 162.00, 177.00
   2 ,     gen20_f2 ,    171.0  ,   31.0 (             --|  * ----      ),143.00, 162.00, 173.00, 185.00, 208.00
   3 ,     gen60_f2 ,    176.0  ,   33.0 (               |-  *  ---     ),154.00, 167.00, 178.00, 195.00, 215.00
   3 ,     gen40_f2 ,    178.0  ,   32.0 (              -|   *  ---     ),153.00, 164.00, 178.00, 195.00, 213.00
   3 ,     gen80_f2 ,    180.0  ,   37.0 (               |-   * ----    ),154.00, 167.00, 187.00, 199.00, 217.00
   3 ,    gen100_f2 ,    187.0  ,   35.0 (               |--  *  ---    ),155.00, 171.00, 187.00, 201.00, 217.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,     24.0  ,    5.0 (     ------  * |------        ),20.00, 23.00, 24.00, 26.00, 29.00
   1 ,    gen100_f3 ,     24.0  ,    5.0 (     ----    * |--------      ),20.00, 22.00, 24.00, 26.00, 30.00
   1 ,     gen80_f3 ,     24.0  ,    5.0 (   --------   *|  ------      ),19.00, 23.00, 25.00, 27.00, 30.00
   1 ,     gen20_f3 ,     25.0  ,    4.0 (     ------   *|  ------      ),20.00, 23.00, 25.00, 27.00, 30.00
   1 ,     gen40_f3 ,     25.0  ,    4.0 (       ----   *|  ------      ),21.00, 23.00, 25.00, 27.00, 30.00
   1 ,     gen60_f3 ,     25.0  ,    5.0 (     ----     *|  ------      ),20.00, 22.00, 25.00, 27.00, 30.00
```

### Time Taken : 320.207272053
![1](../../../src/img/cdom/CSServices.png)
...
+------+------------------------------------------------------------+----------+-------+------+
|  1   |                Kids Use Phone Counselling1                 |   task   |   1   |  1   |
|  2   |             Maintain Ask a Counsellor Section1             |   task   |   1   |  1   |
|  3   |               Voice Counselling be Performed               |   task   |   1   |  1   |
|  4   |             Provide Web Counselling with Audio             |   task   |   1   |  1   |
|  5   |                Kids Use Video Counselling1                 |   task   |   1   |  1   |
|  6   |                Kids Use Voice Counselling1                 |   task   |   1   |  1   |
|  7   |                !Moderate Discussion Boards                 |   task   |   1   |  1   |
|  8   |                 Put Content Onto Website1                  |   task   |   1   |  1   |
|  9   |                      !Moderate a Chat                      |   task   |   1   |  1   |
|  10  |                  Create Counselling Posts                  |   task   |   1   |  1   |
|  11  |                        Trace Calls                         |   task   |   -1  |  1   |
|  12  |           Implement Bulletin Board with Replies1           |   task   |   1   |  1   |
|  13  |                     Service Resources                      | resource |   1   |  1   |
|  14  |              Schedule Chat at Specific Times               |   task   |   1   |  1   |
|  15  |                        Web Software                        | resource |   -1  |  1   |
|  16  | Parents Use\nTool to Allow Parents to Talk to Each Other 1 |   task   |   -1  |  1   |
|  17  |                     Implement Filters                      |   task   |   1   |  1   |
|  18  |                Implement Board with Replies                |   task   |   1   |  1   |
|  19  |      Kids Use Bulletin Board with Delayed Moderation1      |   task   |   -1  |  1   |
|  20  |              Implement Anti-Pranking Message               |   task   |   -1  |  1   |
|  21  |               Implement Information Section                |   task   |   1   |  1   |
|  22  |                !Kids Read Polls about Kids1                |   task   |   -1  |  1   |
|  23  |             Provide Web Counselling with Video             |   task   |   1   |  1   |
|  24  |    Inform Kids about Anonymity [Kids] of Web Services1     |   task   |   1   |  1   |
|  25  |                   Feedback Form Software                   | resource |   1   |  1   |
|  26  |     Implement Bulletin Board with Delayed Moderation1      |   task   |   -1  |  1   |
|  27  |                          Feedback                          | resource |   1   |  1   |
|  28  |           Kids Use Bulletin Board with Replies1            |   task   |   1   |  1   |
|  29  |          Parents Use Bulletin Board with Replies1          |   task   |   -1  |  1   |
|  30  |                Provide Written Counselling                 |   task   |   1   |  1   |
|  31  |                Kids Use Email Counselling1                 |   task   |   1   |  1   |
|  32  |                 !Perform Email Counselling                 |   task   |   -1  |  1   |
|  33  |                      Implement Delay                       |   task   |   1   |  1   |
|  34  |                 *Provide Recorded Messages                 |   task   |   1   |  1   |
|  35  |         Kids use get Informed Section of Web Site          |   task   |   -1  |  1   |
|  36  |               *Maintain PHL Phone Services4                |   task   |   1   |  1   |
|  37  |           Kids Use Ask a Counsellor Section\ns1            |   task   |   1   |  1   |
|  38  |                 !Implement Text Messaging1                 |   task   |   -1  |  1   |
|  39  |                Implement Voice Counselling1                |   task   |   1   |  1   |
|  40  |          Kids Read General Questions and Answers1          |   task   |   1   |  1   |
|  41  |                         Feedback1                          | resource |   -1  |  1   |
|  42  |                      Web Site Content                      | resource |   -1  |  1   |
|  43  |                         Web Server                         | resource |   -1  |  1   |
|  44  |           Kids Use Cyber Café/Portal/Chat Room1            |   task   |   -1  |  1   |
|  45  |       Block Kids who Display Inappropriate Behavoir        |   task   |   -1  |  1   |
|  46  |                    Strategic Blue Print                    | resource |   -1  |  1   |
|  47  |                 !Implement Phone Feedback3                 |   task   |   -1  |  1   |
|  48  |             !Implement One-On-One Chat Rooms1              |   task   |   1   |  1   |
|  49  |  !Implement\nTool to Allow Parents to Talk to Each Other   |   task   |   -1  |  1   |
|  50  |              Parents Use Information Section1              |   task   |   -1  |  1   |
+------+------------------------------------------------------------+----------+-------+------+
```
...
|              *Maintain/Implement CS Web Services1             |   task   |   1   |
