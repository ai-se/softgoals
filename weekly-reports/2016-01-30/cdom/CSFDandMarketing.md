...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    87.63  ,   5.37 (            ---|   *  ----    ),82.26, 85.48, 88.17, 90.32, 93.55
   2 ,     gen40_f1 ,    89.25  ,   3.76 (               |--   *----    ),84.95, 87.10, 89.25, 90.86, 93.55
   3 ,     gen60_f1 ,    89.78  ,   4.84 (               | --  *  --    ),86.02, 88.17, 89.78, 91.94, 94.09
   3 ,     gen80_f1 ,    90.86  ,   4.84 (               | ---- * --    ),86.02, 89.25, 90.86, 92.47, 94.09
   3 ,    gen100_f1 ,    90.86  ,    4.3 (               | ---- * --    ),86.56, 89.25, 90.86, 92.47, 94.09

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    207.0  ,   30.0 (      -----   *| ----         ),179.00, 196.00, 209.00, 218.00, 232.00
   2 ,     gen20_f2 ,    218.0  ,   25.0 (          -----| *   ----     ),192.00, 211.00, 218.00, 232.00, 246.00
   2 ,     gen40_f2 ,    220.0  ,   23.0 (           ----|  *  ---      ),198.00, 213.00, 222.00, 232.00, 245.00
   2 ,     gen60_f2 ,    222.0  ,   23.0 (              -|- *   ---     ),206.00, 218.00, 224.00, 235.00, 247.00
   2 ,     gen80_f2 ,    222.0  ,   24.0 (              -|- *   ---     ),209.00, 217.00, 224.00, 237.00, 247.00
   2 ,    gen100_f2 ,    224.0  ,   24.0 (              -|-  *  ---     ),209.00, 218.00, 225.00, 237.00, 247.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen80_f3 ,     33.0  ,    4.0 (            ---| *  ---       ),30.00, 32.00, 33.00, 35.00, 37.00
   1 ,    gen100_f3 ,     33.0  ,    4.0 (            ---| *  --        ),30.00, 32.00, 33.00, 35.00, 36.00
   1 ,      gen0_f3 ,     34.0  ,    4.0 (            ---|- *   ----    ),30.00, 33.00, 34.00, 36.00, 39.00
   1 ,     gen20_f3 ,     34.0  ,    5.0 (           ----|  *   ----    ),29.00, 32.00, 34.00, 36.00, 39.00
   1 ,     gen40_f3 ,     34.0  ,    5.0 (            ---|  *   ---     ),30.00, 32.00, 34.00, 36.00, 38.00
   1 ,     gen60_f3 ,     34.0  ,    4.0 (            ---|  * ---       ),30.00, 32.00, 34.00, 35.00, 37.00
```

### Time Taken : 250.470297098
![1](../../../src/img/cdom/CSFDandMarketing.png)
...
+------+--------------------------------------------------------------------------+----------+-------+------+
|  1   |              ! Counselor Speak on Kids Issues in General 1               |   task   |   1   |  1   |
|  2   |                         Send recognition letters                         |   task   |   1   |  1   |
|  3   |                          Provide free services1                          |   task   |   1   |  1   |
|  4   |                          Use volunteer services                          |   task   |   -1  |  1   |
|  5   |                        Donor/Accounting Database                         | resource |   -1  |  1   |
|  6   |                Pay Fund Development and Marketing Staff                  |   task   |   1   |  1   |
|  7   |                          Participate in events                           |   task   |   1   |  1   |
|  8   |                      Provide philanthropic donation                      |   task   |   1   |  1   |
|  9   |                          Conflicts Be Managed                            |   task   |   1   |  1   |
|  10  |                            Get donor database                            |   task   |   1   |  1   |
|  11  |                             Reach agreement                              |   task   |   1   |  1   |
|  12  |                      ! Write Articles for Website 1                      |   task   |   1   |  1   |
|  13  |                      Place Sponsor Logos in Events                       |   task   |   -1  |  1   |
|  14  |                       Exclusive Brand and Logo use                       | resource |   -1  |  1   |
|  15  |                    Organize discussions with Sponsors                    |   task   |   -1  |  1   |
|  16  |                       Give philanthropic donation                        |   task   |   -1  |  1   |
|  17  |                      ! Provide compiled call data                        |   task   |   -1  |  1   |
|  18  |                     Provide Document Library System                      |   task   |   -1  |  1   |
|  19  |                        Collect donor information                         |   task   |   1   |  1   |
|  20  |              Put Together Proposals for Corporate Sponsors               |   task   |   -1  |  1   |
|  21  |                       Get philanthropic donations                        |   task   |   1   |  1   |
|  22  |                             Manage Accounts                              |   task   |   1   |  1   |
|  23  |                              Pledge\nonline                              |   task   |   1   |  1   |
|  24  | Pitch to National Corporate Sponsors the Sponsorship of Regional Events  |   task   |   -1  |  1   |
|  25  |                     Provide Real Time Tax Receipts                       |   task   |   1   |  1   |
|  26  |                           Manage Receivables                             |   task   |   1   |  1   |
|  27  |                          Create Thank you ads                            |   task   |   -1  |  1   |
|  28  |                       Market through own channels                        |   task   |   -1  |  1   |
|  29  |                           Speak at Fundraisers                           |   task   |   -1  |  1   |
|  30  |                       ! Provide money for services                       |   task   |   1   |  1   |
|  31  |                      Elaborate Fundraising targets1                      |   task   |   -1  |  1   |
|  32  |                    Put on orientation for volunteers                     |   task   |   -1  |  1   |
|  33  |                          Reallocate resources1                           |   task   |   -1  |  1   |
|  34  |                    Market [Only For Serious Issues]                      |   task   |   1   |  1   |
|  35  |                         Create branded products                          |   task   |   -1  |  1   |
|  36  |                        Run Fundraiser in Schools                         |   task   |   -1  |  1   |
|  37  |                Work with the Regions to Implement Events                 |   task   |   1   |  1   |
|  38  |                          Provide free services                           |   task   |   1   |  1   |
|  39  |                Get Corporate Partner Information from DL1                |   task   |   -1  |  1   |
|  40  |                         Create General Ledgers                           |   task   |   -1  |  1   |
|  41  |                     Implement Stay in Touch program                      |   task   |   -1  |  1   |
|  42  |                              Track budgets                               |   task   |   -1  |  1   |
|  43  |          Bring Regional Fundraising Staff Together Once a Year           |   task   |   1   |  1   |
|  44  |                            Free advertisement                            | resource |   -1  |  1   |
|  45  |                     Develop national event calendar                      |   task   |   -1  |  1   |
|  46  |                          Give CS Presentations                           |   task   |   -1  |  1   |
|  47  |                  Communicate through Internet and phone                  |   task   |   -1  |  1   |
|  48  |           Provide Promotional Material to Student Ambassadors            |   task   |   -1  |  1   |
|  49  |                      Share PAP in Document Library                       |   task   |   1   |  1   |
|  50  |      Sponsors Include CS Logos and Descriptions on their Products        |   task   |   1   |  1   |
|  51  |                  Single charitable registration number1                  | resource |   1   |  1   |
|  52  |                     ! Write Articles for Magazines 1                     |   task   |   1   |  1   |
|  53  |                       Bi-Weekly Conference Calls                         |   task   |   1   |  1   |
|  54  |                Write Down Corporate Sponsors Objectives                  |   task   |   -1  |  1   |
|  55  |                      Share PAP in Document Library1                      |   task   |   1   |  1   |
|  56  |                  Store donor transactions into database                  |   task   |   -1  |  1   |
|  57  |   Put on Orientation Process for Fund Development and Marketing Staff    |   task   |   -1  |  1   |
|  58  |                       National Marketing Strategy                        | resource |   -1  |  1   |
|  59  |                   !Train counselors on public speaking                   |   task   |   -1  |  1   |
|  60  |                       Inform Sponsors of Progress                        |   task   |   1   |  1   |
|  61  |                              Provide funds                               |   task   |   -1  |  1   |
|  62  |                  Store donor information into database                   |   task   |   -1  |  1   |
|  63  |                           Reallocate resources                           |   task   |   -1  |  1   |
|  64  |                           Pledge\nDuring event                           |   task   |   -1  |  1   |
|  65  |                        Get web event technology1                         |   task   |   1   |  1   |
|  66  |            Create posters, flyers and informational material             |   task   |   -1  |  1   |
|  67  |      Email Corporate Partners Interesting and Relevant News Pieces       |   task   |   -1  |  1   |
|  68  |                     Provide Online Donor Technology                      |   task   |   -1  |  1   |
|  69  |                            Provide Logo to CS                            |   task   |   -1  |  1   |
+------+--------------------------------------------------------------------------+----------+-------+------+
```
...
|                      Get donor /accounting database                      |   task   |   -1  |
...
|             Up to Date [ Information on Corporate Sponsors]              | softgoal |   1   |
