...
----------------------------------------------------
   ...
   1 ,     gen20_f1 ,    98.84  ,    0.0 (*--------------|------------- ),98.84, 98.84, 98.84, 98.84, 100.00
   1 ,     gen40_f1 ,    98.84  ,    0.0 (*--------------|------------- ),98.84, 98.84, 98.84, 98.84, 100.00
   1 ,     gen60_f1 ,    98.84  ,    0.0 (*--------------|------------- ),98.84, 98.84, 98.84, 98.84, 100.00
   1 ,     gen80_f1 ,    98.84  ,    0.0 (*--------------|------------- ),98.84, 98.84, 98.84, 98.84, 100.00
   1 ,    gen100_f1 ,    98.84  ,    0.0 (*--------------|------------- ),98.84, 98.84, 98.84, 98.84, 100.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    171.0  ,    0.0 (*              |              ),171.00, 171.00, 171.00, 171.00, 171.00
   1 ,     gen20_f2 ,    171.0  ,    0.0 (*              |              ),171.00, 171.00, 171.00, 171.00, 171.00
   1 ,     gen40_f2 ,    171.0  ,    0.0 (*              |              ),171.00, 171.00, 171.00, 171.00, 171.00
   1 ,     gen60_f2 ,    171.0  ,    0.0 (*              |              ),171.00, 171.00, 171.00, 171.00, 171.00
   1 ,     gen80_f2 ,    171.0  ,    0.0 (*              |              ),171.00, 171.00, 171.00, 171.00, 171.00
   1 ,    gen100_f2 ,    171.0  ,    0.0 (*              |              ),171.00, 171.00, 171.00, 171.00, 171.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen40_f3 ,    220.0  ,   28.0 (      ----   * |-----         ),197.00, 211.00, 220.00, 230.00, 253.00
   1 ,     gen60_f3 ,    220.0  ,   24.0 (      ----   * |-----         ),197.00, 211.00, 220.00, 229.00, 253.00
   1 ,     gen80_f3 ,    220.0  ,   24.0 (      ----   * |--            ),197.00, 211.00, 220.00, 229.00, 241.00
   1 ,    gen100_f3 ,    220.0  ,   24.0 (      ----   * |--            ),197.00, 211.00, 220.00, 229.00, 241.00
   1 ,     gen20_f3 ,    220.0  ,   28.0 (      ----   * |-----         ),197.00, 211.00, 222.00, 230.00, 253.00
   1 ,      gen0_f3 ,    222.0  ,   28.0 (      -----  * |------        ),197.00, 215.00, 222.00, 234.00, 257.00
```

### Time Taken : 107.550354958
![1](../../../src/img/vary_cost/CSSimplified.png)
...
+------+----------------------------------------------------------+----------+-------+------+
|  1   |                !Implement Phone Feedback                 |   task   |   -1  |  5   |
|  2   |                     Call Statistics                      | resource |   1   |  2   |
|  3   |                  Web Moderator Meetings                  | resource |   -1  |  5   |
|  4   |                       Web Software                       | resource |   -1  |  2   |
|  5   |                Tape Recording Technology                 | resource |   -1  |  5   |
|  6   |                   Strategic Blue Print                   | resource |   1   |  1   |
|  7   |             Negotiate with Counsellors Union             |   task   |   1   |  5   |
|  8   |        Get Corporate Partner Information from DL         |   task   |   1   |  2   |
|  9   |                     Double Head Set                      | resource |   -1  |  1   |
|  10  |                      Pledge online                       |   task   |   1   |  4   |
|  11  |                !Perform Email Counselling                |   task   |   1   |  4   |
|  12  |                Kids Use Video Counselling                |   task   |   1   |  2   |
|  13  |              Parents Use Phone Counselling               |   task   |   1   |  4   |
|  14  |                *Implement Bulletin Board                 |   task   |   1   |  5   |
|  15  |                   Provide Information                    |   task   |   1   |  2   |
|  16  |                          Oracle                          | resource |   1   |  2   |
|  17  |                      Free Hardware                       | resource |   -1  |  5   |
|  18  |               Implement Board with Replies               |   task   |   1   |  4   |
|  19  |                       Web Server1                        | resource |   1   |  3   |
|  20  |               ! Provide money for services               |   task   |   1   |  4   |
|  21  |                       IT Resources                       | resource |   -1  |  4   |
|  22  |       !Parents Use Service to Talk to Each Other         |   task   |   1   |  1   |
|  23  |               Implement Voice Counselling                |   task   |   1   |  4   |
|  24  |                !Implement Text Messaging                 |   task   |   -1  |  4   |
|  25  |          Inform kids about anonymity of service          |   task   |   -1  |  4   |
|  26  |               Diffuse Conflict with Parent               |   task   |   1   |  1   |
|  27  |                 Help with Presentations                  |   task   |   -1  |  4   |
|  28  |               *Maintain PHL Phone Services               |   task   |   -1  |  3   |
|  29  |                      Free Software                       | resource |   1   |  3   |
|  30  |          Single charitable registration number           | resource |   1   |  2   |
|  31  |                Kids read Polls about Kids                |   task   |   1   |  5   |
|  32  |                        Web Server                        | resource |   1   |  1   |
|  33  |                   Manage Receivables                     |   task   |   -1  |  3   |
|  34  |           Help Put on SA Training Conferences            |   task   |   1   |  2   |
|  35  |          !Implement Bulletin Board with Replies          |   task   |   1   |  5   |
|  36  |                 Create General Ledgers                   |   task   |   1   |  3   |
|  37  |                  Speak at Fundraisers1                   |   task   |   1   |  4   |
|  38  |              Use sponsor marketing channels              |   task   |   -1  |  5   |
|  39  |            Provide Web Counselling with Audio            |   task   |   1   |  4   |
|  40  |               Write Articles for Newspaper               |   task   |   1   |  3   |
|  41  |                  Participate in events                   |   task   |   1   |  2   |
|  42  |                          Tapes                           | resource |   1   |  1   |
|  43  |               School Initiates Presenation               |   task   |   -1  |  3   |
|  44  |                Donor/Accounting Data Base                | resource |   1   |  5   |
|  45  |               Provide Written Counselling                |   task   |   -1  |  1   |
|  46  |             Parents Use Information Section              |   task   |   -1  |  4   |
|  47  |                       Training CDs                       | resource |   -1  |  5   |
|  48  |               Second Reading of Web Posts                |   task   |   -1  |  2   |
|  49  |                  Counselling Workshops                   | resource |   1   |  3   |
|  50  |                        Feedback1                         | resource |   1   |  5   |
|  51  |                      Provide funds                       |   task   |   1   |  3   |
|  52  |               !Implement Polls about Kids                |   task   |   1   |  3   |
|  53  |              Put on SA Training Conferences              |   task   |   -1  |  5   |
|  54  |              Maintain/Implement CS Services              |   task   |   -1  |  2   |
|  55  |                   Promotion Resources                    | resource |   1   |  5   |
|  56  |                Kids Use Phone Counselling                |   task   |   -1  |  5   |
|  57  |                   Provide Counselling                    |   task   |   -1  |  1   |
|  58  |                    Free advertisement                    | resource |   -1  |  3   |
|  59  |                   Promotion Resources1                   | resource |   -1  |  3   |
|  60  |                         *Salary                          | resource |   1   |  3   |
|  61  |              Implement Information Section               |   task   |   1   |  3   |
|  62  |                Maintain Phone Counselling                |   task   |   -1  |  5   |
|  63  |                 Undergo Clinical Review                  |   task   |   -1  |  3   |
|  64  |                   Pledge\nDuring event                   |   task   |   -1  |  2   |
|  65  |                Kids Use Email Counselling                |   task   |   -1  |  4   |
|  66  |                  Counsellor Experience                   | resource |   1   |  4   |
|  67  |                         Feedback                         | resource |   -1  |  5   |
|  68  |          !Implement Cyber Café/Portal/Chat Room          |   task   |   -1  |  2   |
|  69  |                         Hardware                         | resource |   -1  |  5   |
|  70  |               Implement Video Counselling                |   task   |   1   |  5   |
|  71  |                        Promote CS                        |   task   |   -1  |  5   |
|  72  |              ! Write Articles for Website                |   task   |   -1  |  1   |
|  73  |                    Service Resources                     | resource |   1   |  5   |
|  74  |                    Caller Statistics                     | resource |   1   |  1   |
|  75  |                     !Moderate a Chat                     |   task   |   -1  |  2   |
|  76  |                     Web Site Content                     | resource |   1   |  4   |
|  77  |             Provide Online Donor Technology              |   task   |   1   |  3   |
|  78  |                   ! Market CS Service                    |   task   |   -1  |  4   |
|  79  |        Maintain Get Informed Section of Web Site         |   task   |   -1  |  4   |
|  80  |                         Upgrades                         | resource |   -1  |  4   |
|  81  |             ! Write Articles for Magazines               |   task   |   1   |  1   |
|  82  |            Provide Web Counselling with Video            |   task   |   1   |  4   |
|  83  |            Maintain Ask a Counsellor Section             |   task   |   1   |  4   |
|  84  |                  Give CS Presentations1                  |   task   |   -1  |  3   |
|  85  |                 Put Content Onto Website                 |   task   |   -1  |  2   |
|  86  |              ! Provide compiled call data                |   task   |   -1  |  3   |
|  87  |                       Sponsor Logo                       | resource |   -1  |  1   |
|  88  |         Plan and Put on Reconnection Conferences         |   task   |   1   |  4   |
|  89  |             *Implement Email for Counsellors             |   task   |   1   |  2   |
|  90  |                  Maintain Web Services                   |   task   |   -1  |  3   |
|  91  |              *Implement Categorization Tool              |   task   |   -1  |  3   |
|  92  |                     Manage Accounts                      |   task   |   1   |  1   |
|  93  |                         Speaches                         | resource |   -1  |  3   |
|  94  |                   Speak at Fundraisers                   |   task   |   -1  |  1   |
|  95  |                 Get web event technology                 |   task   |   -1  |  5   |
|  96  |                 *Maintain Phone Services                 |   task   |   -1  |  1   |
|  97  |      Help Plan and Put on Reconnection Conferences       |   task   |   -1  |  4   |
|  98  |                        Agreement                         | resource |   1   |  4   |
|  99  |                     Send out Emails                      |   task   |   -1  |  5   |
| 100  |                  Feedback Form Software                  | resource |   -1  |  3   |
| 101  |              Kids Use One-On-One Chat Rooms              |   task   |   -1  |  2   |
| 102  |                     Provide receipts                     |   task   |   -1  |  5   |
| 103  |                   Sponsorship proposal                   |   task   |   -1  |  4   |
| 104  |              Voice Counselling be Performed              |   task   |   -1  |  3   |
| 105  |        Kids use get Informed Section of Web Site         |   task   |   -1  |  5   |
| 106  |         Parents Use Bulletin Board with Replies          |   task   |   -1  |  3   |
| 107  |               Manage\nPartner Relationship               |   task   |   -1  |  3   |
| 108  |                       Information                        | resource |   -1  |  3   |
| 109  |           Kids Use Bulletin Board with Replies           |   task   |   1   |  4   |
| 110  |       ! Counselor Speak on Kids Issues in General        |   task   |   1   |  2   |
| 111  |                      Sign Contract                       |   task   |   1   |  3   |
| 112  |             !Implement One-On-One Chat Rooms             |   task   |   1   |  3   |
| 113  |             Historical Data of Call Volumes              | resource |   -1  |  3   |
| 114  |                Kids Use Voice Counselling                |   task   |   -1  |  4   |
| 115  |           Kids Use Ask a Counsellor Section\ns           |   task   |   -1  |  1   |
| 116  |               !Moderate Discussion Boards                |   task   |   -1  |  4   |
| 117  |                          Funds                           | resource |   -1  |  4   |
| 118  |             Provide Document Library System              |   task   |   -1  |  1   |
| 119  |         !Implement General Questions and Answers         |   task   |   1   |  5   |
| 120  |               Provide fundraising services               |   task   |   1   |  1   |
| 121  | !Implement\nTool to Allow Parents to Talk to Each Other  |   task   |   -1  |  4   |
| 122  |                     Free Web Server                      | resource |   -1  |  5   |
| 123  |                 Philanthropic donations                  |   task   |   -1  |  1   |
| 124  |            Phone Library of Recorded Messages            | resource |   -1  |  1   |
| 125  |               Implement Email Counselling                |   task   |   1   |  4   |
| 126  |              Share PAP in Document Library               |   task   |   1   |  1   |
| 127  |                  Collect Pledge online                   |   task   |   -1  |  3   |
| 128  |                 Get sponsors for events                  |   task   |   -1  |  4   |
| 129  |                      Free Upgrades                       | resource |   -1  |  1   |
| 130  |               Find Help with Presentations               |   task   |   1   |  5   |
| 131  |         Kids read General Questions and Answers          |   task   |   -1  |  5   |
| 132  |                 Create Counselling Posts                 |   task   |   -1  |  4   |
| 133  |                  Provide free services                   |   task   |   -1  |  1   |
| 134  |                   Counselling Policies                   | resource |   -1  |  4   |
| 135  |                 Kids Use Text Messaging                  |   task   |   -1  |  2   |
| 136  |                         Software                         | resource |   -1  |  4   |
| 137  |                Run Fundraiser in Schools                 |   task   |   -1  |  4   |
| 138  |             Maintain/ Implement PHL Services             |   task   |   -1  |  4   |
| 139  |              Elaborate Fundraising targets               |   task   |   -1  |  1   |
| 140  |           Kids Use Cyber Café/Portal/Chat Room           |   task   |   -1  |  3   |
| 141  |                  Give CS Presentations                   |   task   |   -1  |  5   |
+------+----------------------------------------------------------+----------+-------+------+
```
