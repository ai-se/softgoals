...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    87.63  ,    4.3 (             --|   * ---      ),82.80, 86.02, 88.17, 89.78, 93.01
   2 ,     gen40_f1 ,    89.25  ,   4.84 (              -|--  *-----    ),83.87, 87.10, 89.25, 90.32, 94.09
   3 ,     gen60_f1 ,    89.78  ,   4.31 (              -|--   * ---    ),83.87, 87.63, 89.78, 91.40, 94.09
   3 ,     gen80_f1 ,    90.32  ,    4.3 (               | --- * ---    ),86.56, 89.25, 90.32, 91.94, 94.62
   3 ,    gen100_f1 ,    90.32  ,    4.3 (               | --- *  ---   ),86.56, 89.25, 90.32, 92.47, 95.16

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    207.0  ,   30.0 (       -----   |*  ----       ),179.00, 196.00, 209.00, 218.00, 232.00
   2 ,     gen20_f2 ,    214.0  ,   15.0 (             --|- *------     ),198.00, 211.00, 214.00, 220.00, 237.00
   2 ,     gen40_f2 ,    214.0  ,   23.0 (             --|  *   ----    ),198.00, 210.00, 215.00, 228.00, 240.00
   2 ,     gen60_f2 ,    219.0  ,   20.0 (           ----|-  *   ---    ),193.00, 213.00, 219.00, 231.00, 242.00
   3 ,     gen80_f2 ,    222.0  ,   20.0 (               |--   * ---    ),208.00, 216.00, 226.00, 232.00, 243.00
   3 ,    gen100_f2 ,    228.0  ,   20.0 (               |--    * --    ),209.00, 216.00, 229.00, 234.00, 243.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f3 ,     93.0  ,   17.0 (      ----   * |-             ),78.00, 87.00, 94.00, 99.00, 104.00
   1 ,     gen60_f3 ,     94.0  ,   16.0 (      -----  * |--            ),78.00, 90.00, 95.00, 100.00, 105.00
   1 ,     gen80_f3 ,     94.0  ,   15.0 (      -----  * |-             ),78.00, 90.00, 95.00, 99.00, 104.00
   1 ,     gen20_f3 ,     95.0  ,   11.0 (       ----  * |----          ),81.00, 90.00, 95.00, 101.00, 109.00
   1 ,     gen40_f3 ,     95.0  ,   14.0 (     ------  * |--            ),77.00, 90.00, 95.00, 101.00, 106.00
   1 ,      gen0_f3 ,    101.0  ,   16.0 (      ------   |* ----        ),79.00, 92.00, 101.00, 105.00, 114.00
```

### Time Taken : 230.153176069
![1](../../../src/img/vary_cost/CSFDandMarketing.png)
...
+------+--------------------------------------------------------------------------+----------+-------+------+
|  1   |              ! Counselor Speak on Kids Issues in General 1               |   task   |   1   |  5   |
|  2   |                           Manage Receivables                             |   task   |   1   |  2   |
|  3   |                          Reallocate resources1                           |   task   |   -1  |  4   |
|  4   |                    Put on orientation for volunteers                     |   task   |   1   |  2   |
|  5   |                             Reach agreement                              |   task   |   1   |  1   |
|  6   |                       ! Provide money for services                       |   task   |   1   |  4   |
|  7   |                     Implement Stay in Touch program                      |   task   |   -1  |  2   |
|  8   |                              Track budgets                               |   task   |   -1  |  5   |
|  9   |                    Market [Only For Serious Issues]                      |   task   |   1   |  2   |
|  10  |                          Participate in events                           |   task   |   1   |  2   |
|  11  |                           Reallocate resources                           |   task   |   1   |  1   |
|  12  |                             Manage Accounts                              |   task   |   -1  |  5   |
|  13  |                       Get philanthropic donations                        |   task   |   1   |  2   |
|  14  |                Write Down Corporate Sponsors Objectives                  |   task   |   -1  |  2   |
|  15  | Pitch to National Corporate Sponsors the Sponsorship of Regional Events  |   task   |   -1  |  2   |
|  16  |                Work with the Regions to Implement Events                 |   task   |   1   |  2   |
|  17  |                Pay Fund Development and Marketing Staff                  |   task   |   1   |  3   |
|  18  |                      Place Sponsor Logos in Events                       |   task   |   -1  |  4   |
|  19  |                       Market through own channels                        |   task   |   -1  |  4   |
|  20  |                            Free advertisement                            | resource |   1   |  3   |
|  21  |                        Donor/Accounting Database                         | resource |   -1  |  2   |
|  22  |          Bring Regional Fundraising Staff Together Once a Year           |   task   |   -1  |  4   |
|  23  |                      Share PAP in Document Library1                      |   task   |   1   |  1   |
|  24  |                              Pledge\nonline                              |   task   |   1   |  1   |
|  25  |                  Store donor information into database                   |   task   |   -1  |  2   |
|  26  |              Put Together Proposals for Corporate Sponsors               |   task   |   1   |  5   |
|  27  |   Put on Orientation Process for Fund Development and Marketing Staff    |   task   |   -1  |  3   |
|  28  |                     Develop national event calendar                      |   task   |   1   |  3   |
|  29  |                          Provide free services1                          |   task   |   1   |  4   |
|  30  |                       National Marketing Strategy                        | resource |   1   |  1   |
|  31  |                      Provide philanthropic donation                      |   task   |   1   |  1   |
|  32  |                      Elaborate Fundraising targets1                      |   task   |   -1  |  5   |
|  33  |                          Give CS Presentations                           |   task   |   1   |  5   |
|  34  |                        Run Fundraiser in Schools                         |   task   |   -1  |  5   |
|  35  |                          Create Thank you ads                            |   task   |   -1  |  1   |
|  36  |                        Get web event technology1                         |   task   |   -1  |  5   |
|  37  |      Sponsors Include CS Logos and Descriptions on their Products        |   task   |   1   |  3   |
|  38  |                          Use volunteer services                          |   task   |   -1  |  4   |
|  39  |                     Provide Real Time Tax Receipts                       |   task   |   1   |  2   |
|  40  |                          Provide free services                           |   task   |   1   |  1   |
|  41  |                     Provide Online Donor Technology                      |   task   |   1   |  1   |
|  42  |                       Inform Sponsors of Progress                        |   task   |   1   |  1   |
|  43  |                            Get donor database                            |   task   |   1   |  4   |
|  44  |           Provide Promotional Material to Student Ambassadors            |   task   |   1   |  5   |
|  45  |                  Store donor transactions into database                  |   task   |   -1  |  5   |
|  46  |                         Create branded products                          |   task   |   1   |  3   |
|  47  |                        Collect donor information                         |   task   |   1   |  4   |
|  48  |                       Bi-Weekly Conference Calls                         |   task   |   1   |  2   |
|  49  |                            Provide Logo to CS                            |   task   |   -1  |  2   |
|  50  |            Create posters, flyers and informational material             |   task   |   -1  |  3   |
|  51  |                          Conflicts Be Managed                            |   task   |   1   |  4   |
|  52  |                      ! Provide compiled call data                        |   task   |   1   |  2   |
|  53  |                      Share PAP in Document Library                       |   task   |   1   |  3   |
|  54  |                       Exclusive Brand and Logo use                       | resource |   -1  |  3   |
|  55  |                              Provide funds                               |   task   |   1   |  3   |
|  56  |                      ! Write Articles for Website 1                      |   task   |   1   |  4   |
|  57  |                       Give philanthropic donation                        |   task   |   1   |  3   |
|  58  |                         Send recognition letters                         |   task   |   -1  |  3   |
|  59  |                  Single charitable registration number1                  | resource |   -1  |  4   |
|  60  |                     ! Write Articles for Magazines 1                     |   task   |   1   |  2   |
|  61  |                   !Train counselors on public speaking                   |   task   |   -1  |  5   |
|  62  |                Get Corporate Partner Information from DL1                |   task   |   -1  |  1   |
|  63  |                    Organize discussions with Sponsors                    |   task   |   -1  |  3   |
|  64  |                  Communicate through Internet and phone                  |   task   |   -1  |  1   |
|  65  |      Email Corporate Partners Interesting and Relevant News Pieces       |   task   |   -1  |  2   |
|  66  |                           Speak at Fundraisers                           |   task   |   -1  |  5   |
|  67  |                         Create General Ledgers                           |   task   |   -1  |  4   |
|  68  |                     Provide Document Library System                      |   task   |   -1  |  4   |
...
|                         Attend fundraising event                         |   task   |  0.5  |
...
|             Company Relationship be retained  after Mergers              |   goal   |  0.5  |
...
|                       SA Run Fundraiser in Schools                       |   task   |   1   |
...
|                      Manage\nPartner Relationship1                       |   task   |  0.5  |
...
|                    Sponsor Relationships Be Managed                      |   goal   |  0.5  |
