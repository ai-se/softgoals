...
----------------------------------------------------
   ...
   1 ,     gen20_f1 ,    100.0  ,   3.03 (               |             *),96.97, 96.97, 100.00, 100.00, 100.00
   1 ,     gen40_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
   1 ,     gen60_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
   1 ,     gen80_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00
   1 ,    gen100_f1 ,    100.0  ,    0.0 (---------------|-------------*),96.97, 100.00, 100.00, 100.00, 100.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,     64.0  ,    0.0 (*              |              ),64.00, 64.00, 64.00, 64.00, 64.00
   1 ,     gen20_f2 ,     64.0  ,    0.0 (*              |              ),64.00, 64.00, 64.00, 64.00, 64.00
   1 ,     gen40_f2 ,     64.0  ,    0.0 (*              |              ),64.00, 64.00, 64.00, 64.00, 64.00
   1 ,     gen60_f2 ,     64.0  ,    0.0 (*              |              ),64.00, 64.00, 64.00, 64.00, 64.00
   1 ,     gen80_f2 ,     64.0  ,    0.0 (*              |              ),64.00, 64.00, 64.00, 64.00, 64.00
   1 ,    gen100_f2 ,     64.0  ,    0.0 (*              |              ),64.00, 64.00, 64.00, 64.00, 64.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f3 ,     14.0  ,    6.0 ( -- *-         |              ), 8.00, 12.00, 14.00, 16.00, 19.00
   2 ,     gen80_f3 ,     19.0  ,   11.0 (   -  * --     |              ),13.00, 16.00, 20.00, 24.00, 29.00
   3 ,     gen60_f3 ,     27.0  ,    9.0 (       - * --- |              ),21.00, 24.00, 28.00, 32.00, 38.00
   4 ,     gen40_f3 ,     33.0  ,    9.0 (         -- * -|              ),27.00, 31.00, 33.00, 40.00, 44.00
   5 ,     gen20_f3 ,     44.0  ,    9.0 (           ----|*  --         ),32.00, 41.00, 44.00, 50.00, 55.00
   6 ,      gen0_f3 ,     53.0  ,   12.0 (              -|--   *--      ),40.00, 49.00, 55.00, 59.00, 64.00
```

### Time Taken : 10.5346159935
![1](../../../src/img/vary_cost/CSCounsellingSD.png)
...
+------+----------------------------------------------+----------+-------+------+
|  1   |                 Training CDs                 | resource |   -1  |  3   |
|  2   |                  Promote CS                  |   task   |   -1  |  5   |
|  3   |          !Perform Email Counselling          |   task   |   -1  |  3   |
|  4   |             Provide Information              |   task   |   -1  |  5   |
|  5   |           Undergo Clinical Review            |   task   |   -1  |  5   |
|  6   |           Information in E-Library           | resource |   -1  |  5   |
|  7   |                   Feedback                   | resource |   -1  |  3   |
|  8   |            Counsellor Experience             | resource |   -1  |  3   |
|  9   |            Web Moderator Meetings            | resource |   -1  |  5   |
|  10  |          Tape Recording Technoloyg           | resource |   -1  |  3   |
|  11  |            Counselling Workshops             | resource |   -1  |  3   |
|  12  |           Resources in the Library           | resource |   -1  |  5   |
|  13  |         Provide Written Counselling          |   task   |   -1  |  5   |
|  14  |                Sign Contract                 |   task   |   -1  |  3   |
|  15  |      Provide Web Counselling with Audio      |   task   |   -1  |  4   |
|  16  |         Web Counselling be Performed         |   task   |   -1  |  3   |
|  17  |               Web Site Content               | resource |   -1  |  5   |
|  18  |           Create Counselling Posts           |   task   |   -1  |  4   |
|  19  |       Information Binders at Stations        | resource |   -1  |  4   |
|  20  |          *Implement Bulletin Board           |   task   |   -1  |  4   |
|  21  |      Provide Web Counselling with Video      |   task   |   -1  |  4   |
|  22  |         !Moderate Discussion Boards          |   task   |   -1  |  4   |
|  23  |        *Implement Categorization Tool        |   task   |   1   |  3   |
|  24  | ! Counselor Speak on Kids Issues in General  |   task   |   -1  |  3   |
|  25  |               Double Headsets                | resource |   -1  |  2   |
|  26  |            Participate in events             |   task   |   1   |  1   |
|  27  |       *Implement Email for Counsellors       |   task   |   -1  |  1   |
|  28  |       ! Write Articles for Magazines         |   task   |   -1  |  2   |
|  29  |        ! Write Articles for Website          |   task   |   -1  |  2   |
|  30  |            Report Outdated Links             |   task   |   -1  |  1   |
|  31  |             Provide Counselling              |   task   |   1   |  1   |
|  32  |             Counselling Policies             | resource |   1   |  1   |
|  33  |            Information/Resources             | resource |   1   |  2   |
|  34  |                    Tapes                     | resource |   -1  |  2   |
