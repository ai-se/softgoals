...
----------------------------------------------------
   ...
   1 ,     gen20_f1 ,    95.12  ,    0.0 (*              |              ),95.12, 95.12, 95.12, 95.12, 95.12
   1 ,     gen40_f1 ,    95.12  ,    0.0 (*              |              ),95.12, 95.12, 95.12, 95.12, 95.12
   1 ,     gen60_f1 ,    95.12  ,    0.0 (*              |              ),95.12, 95.12, 95.12, 95.12, 95.12
   1 ,     gen80_f1 ,    95.12  ,    0.0 (*              |              ),95.12, 95.12, 95.12, 95.12, 95.12
   1 ,    gen100_f1 ,    95.12  ,    0.0 (*              |              ),95.12, 95.12, 95.12, 95.12, 95.12
...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen60_f4 ,      6.0  ,    3.0 (  --  *-       |              ), 3.00,  5.00,  7.00,  8.00,  9.00
   1 ,     gen80_f4 ,      6.0  ,    3.0 (  --  *-       |              ), 3.00,  5.00,  7.00,  8.00,  9.00
   1 ,    gen100_f4 ,      6.0  ,    3.0 (  --  *-       |              ), 3.00,  5.00,  7.00,  8.00,  9.00
   1 ,     gen40_f4 ,      7.0  ,    3.0 (  --  *--      |              ), 3.00,  5.00,  7.00,  8.00, 10.00
   1 ,     gen20_f4 ,      7.0  ,    4.0 (   --  *--     |              ), 4.00,  6.00,  8.00,  9.00, 11.00
   2 ,      gen0_f4 ,     16.0  ,    8.0 (       ----    * -----        ), 8.00, 12.00, 16.00, 18.00, 23.00
```

### Time Taken : 5.79636502266
![1](../../../src/img/weighted_random/CSCounsellingManagementSD.png)
...
+------+----------------------------------+----------+-------+------+
|  1   |     Analyze Call Statistics      |   task   |   -1  |  5   |
|  2   |      Counselling Resources       | resource |   -1  |  3   |
|  3   |         Double Head Set          | resource |   -1  |  3   |
|  4   |         Call Statistics          | resource |   -1  |  4   |
|  5   |       Counselling Policies       | resource |   -1  |  4   |
|  6   |      Web Moderator Meetings      | resource |   1   |  2   |
|  7   |   Second Reading of Web Posts    |   task   |   -1  |  4   |
|  8   | Negotiate with Counsellors Union |   task   |   -1  |  3   |
|  9   | Historical Data of Call Volumes  | resource |   1   |  2   |
+------+----------------------------------+----------+-------+------+
```
