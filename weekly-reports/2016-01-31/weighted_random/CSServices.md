...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    60.75  ,   9.14 (           --- |* ----        ),53.23, 57.53, 60.75, 63.44, 69.89
   2 ,     gen40_f1 ,    61.83  ,   8.07 (            ---| * -----      ),53.76, 60.22, 61.83, 65.59, 72.58
   3 ,     gen60_f1 ,    63.98  ,   6.45 (             --|- * ----      ),55.91, 61.83, 64.52, 66.67, 73.66
   3 ,     gen80_f1 ,    65.05  ,   6.99 (               |-  * ---      ),58.60, 62.90, 65.59, 68.82, 73.66
   3 ,    gen100_f1 ,    65.59  ,   8.06 (               |-  * ---      ),58.60, 62.90, 66.13, 68.82, 73.66

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    69.57  ,  30.43 (--           * |  -------     ),43.48, 47.83, 69.57, 78.26, 91.30
   2 ,     gen20_f2 ,     91.3  ,  13.04 (               |  --     * -- ),78.26, 82.61, 91.30, 95.65, 100.00
   2 ,     gen40_f2 ,     91.3  ,  13.04 (               |  -----  * -- ),78.26, 86.96, 91.30, 95.65, 100.00
   3 ,     gen60_f2 ,    95.65  ,   8.69 (               |    -----  *- ),82.61, 91.30, 95.65, 95.65, 100.00
...
----------------------------------------------------
   ...
   2 ,     gen20_f3 ,    225.38  ,  56.57 (            ---|  * ---       ),175.62, 198.34, 226.54, 247.04, 266.64
   2 ,     gen40_f3 ,    226.54  ,  55.03 (            ---|- *  -----    ),176.88, 214.74, 228.40, 255.20, 294.33
   3 ,     gen60_f3 ,    230.49  ,   48.5 (              -|-  *  ----    ),191.55, 215.74, 232.64, 259.26, 295.49
   3 ,     gen80_f3 ,    236.99  ,  50.93 (              -|-   * ----    ),191.55, 219.17, 244.57, 263.84, 295.49
   3 ,    gen100_f3 ,    246.42  ,   50.9 (               |--  *  ---    ),206.60, 222.26, 247.25, 265.67, 295.78

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f4 ,     77.0  ,   13.0 (      ---   *  |----          ),64.00, 72.00, 78.00, 84.00, 95.00
   2 ,     gen20_f4 ,     85.0  ,   20.0 (         ---   |*    ------   ),72.00, 78.00, 87.00, 96.00, 109.00
   2 ,     gen40_f4 ,     89.0  ,   20.0 (        ------ |  *  ------   ),69.00, 82.00, 90.00, 97.00, 110.00
   2 ,     gen60_f4 ,     89.0  ,   19.0 (         ----  |  *  ------   ),71.00, 79.00, 90.00, 96.00, 109.00
   2 ,     gen80_f4 ,     89.0  ,   19.0 (         ----  |  *  ------   ),71.00, 80.00, 90.00, 96.00, 109.00
   2 ,    gen100_f4 ,     89.0  ,   19.0 (         ----  |  *  ------   ),71.00, 80.00, 90.00, 96.00, 109.00
```

### Time Taken : 282.458213091
![1](../../../src/img/weighted_random/CSServices.png)
...
|  2   |                  Create Counselling Posts                  |   task   |   1   |  4   |
|  3   |                !Moderate Discussion Boards                 |   task   |   1   |  5   |
|  4   |                Provide Written Counselling                 |   task   |   1   |  2   |
|  5   |                !Kids Read Polls about Kids1                |   task   |   1   |  3   |
|  6   |                    Strategic Blue Print                    | resource |   1   |  2   |
|  7   |                Kids Use Phone Counselling1                 |   task   |   1   |  3   |
|  8   |           Kids Use Ask a Counsellor Section\ns1            |   task   |   1   |  5   |
|  9   |                     Implement Filters                      |   task   |   1   |  3   |
|  10  |                         Feedback1                          | resource |   -1  |  2   |
|  11  |             Maintain Ask a Counsellor Section1             |   task   |   1   |  5   |
|  12  |                      Web Site Content                      | resource |   1   |  5   |
|  13  |               Voice Counselling be Performed               |   task   |   1   |  5   |
|  14  |           Implement Bulletin Board with Replies1           |   task   |   1   |  4   |
|  15  |           Kids Use Bulletin Board with Replies1            |   task   |   1   |  1   |
|  16  |                Kids Use Video Counselling1                 |   task   |   1   |  2   |
|  17  |              Schedule Chat at Specific Times               |   task   |   1   |  5   |
|  18  |                Kids Use Voice Counselling1                 |   task   |   1   |  5   |
|  19  |               Implement Information Section                |   task   |   -1  |  4   |
|  20  |                 *Provide Recorded Messages                 |   task   |   1   |  5   |
|  21  |                      !Moderate a Chat                      |   task   |   1   |  1   |
|  22  |             Provide Web Counselling with Video             |   task   |   1   |  4   |
|  23  |                   Feedback Form Software                   | resource |   1   |  3   |
|  24  |                Kids Use Email Counselling1                 |   task   |   1   |  4   |
|  25  |    Inform Kids about Anonymity [Kids] of Web Services1     |   task   |   1   |  3   |
|  26  |     Implement Bulletin Board with Delayed Moderation1      |   task   |   1   |  2   |
|  27  |              Implement Anti-Pranking Message               |   task   |   1   |  5   |
|  28  |               *Maintain PHL Phone Services4                |   task   |   1   |  2   |
|  29  |                        Web Software                        | resource |   -1  |  4   |
|  30  |          Parents Use Bulletin Board with Replies1          |   task   |   1   |  1   |
|  31  |                 !Perform Email Counselling                 |   task   |   1   |  2   |
|  32  |                      Implement Delay                       |   task   |   1   |  4   |
|  33  |                          Feedback                          | resource |   -1  |  1   |
|  34  |                        Trace Calls                         |   task   |   1   |  2   |
|  35  |         Kids use get Informed Section of Web Site          |   task   |   1   |  1   |
|  36  |                Implement Voice Counselling1                |   task   |   1   |  2   |
|  37  |                 Put Content Onto Website1                  |   task   |   1   |  1   |
|  38  |                Implement Board with Replies                |   task   |   1   |  4   |
|  39  |          Kids Read General Questions and Answers1          |   task   |   -1  |  5   |
|  40  |                         Web Server                         | resource |   -1  |  5   |
|  41  |  !Implement\nTool to Allow Parents to Talk to Each Other   |   task   |   -1  |  5   |
|  42  |           Kids Use Cyber Café/Portal/Chat Room1            |   task   |   -1  |  1   |
|  43  | Parents Use\nTool to Allow Parents to Talk to Each Other 1 |   task   |   -1  |  1   |
|  44  |      Kids Use Bulletin Board with Delayed Moderation1      |   task   |   -1  |  5   |
|  45  |              Parents Use Information Section1              |   task   |   1   |  3   |
|  46  |             !Implement One-On-One Chat Rooms1              |   task   |   1   |  1   |
|  47  |             Provide Web Counselling with Audio             |   task   |   -1  |  5   |
|  48  |       Block Kids who Display Inappropriate Behavoir        |   task   |   -1  |  1   |
|  49  |                 !Implement Phone Feedback3                 |   task   |   -1  |  5   |
|  50  |                 !Implement Text Messaging1                 |   task   |   -1  |  4   |
+------+------------------------------------------------------------+----------+-------+------+
```
