...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen20_f4 ,      2.0  ,    1.0 (   ---*        |              ), 1.00,  2.00,  2.00,  3.00,  3.00
   1 ,     gen40_f4 ,      2.0  ,    0.0 (   ---*--      |              ), 1.00,  2.00,  2.00,  2.00,  3.00
   1 ,     gen60_f4 ,      2.0  ,    0.0 (   ---*--      |              ), 1.00,  2.00,  2.00,  2.00,  3.00
   1 ,     gen80_f4 ,      2.0  ,    0.0 (   ---*--      |              ), 1.00,  2.00,  2.00,  2.00,  3.00
   1 ,    gen100_f4 ,      2.0  ,    0.0 (   ---*--      |              ), 1.00,  2.00,  2.00,  2.00,  3.00
   2 ,      gen0_f4 ,      5.0  ,    3.0 (      ---      |*  ----       ), 2.00,  3.00,  5.00,  6.00,  7.00
```

### Time Taken : 4.90127897263
![1](../../../src/img/weighted_uniform/CSCounsellingManagementSD.png)
...
|  2   |     Analyze Call Statistics      |   task   |   -1  |  1   |
|  3   | Historical Data of Call Volumes  | resource |   -1  |  1   |
|  4   |         Call Statistics          | resource |   -1  |  1   |
|  5   |      Web Moderator Meetings      | resource |   -1  |  1   |
|  6   |       Counselling Policies       | resource |   -1  |  1   |
|  7   |      Counselling Resources       | resource |   -1  |  1   |
|  8   |   Second Reading of Web Posts    |   task   |   -1  |  1   |
|  9   | Negotiate with Counsellors Union |   task   |   -1  |  1   |
+------+----------------------------------+----------+-------+------+
```
