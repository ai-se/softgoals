...
----------------------------------------------------
   ...
   1 ,     gen80_f1 ,    100.0  ,    0.0 (              -|-------------*),97.14, 100.00, 100.00, 100.00, 100.00
   1 ,    gen100_f1 ,    100.0  ,    0.0 (              -|-------------*),97.14, 100.00, 100.00, 100.00, 100.00
...
----------------------------------------------------
   ...
   2 ,     gen80_f3 ,    31.24  ,   2.13 (           --- |   *-----     ),28.70, 29.80, 31.28, 31.80, 33.50
   2 ,     gen40_f3 ,    31.24  ,   2.74 (          -----|   *   --     ),28.40, 30.18, 31.30, 32.64, 33.36
   2 ,     gen60_f3 ,     31.3  ,   2.94 (            ---|   * ----     ),29.30, 30.09, 31.30, 31.99, 33.50
   2 ,     gen20_f3 ,    31.39  ,   3.09 (            ---|   *    -     ),29.30, 30.18, 31.39, 32.90, 33.42
   2 ,    gen100_f3 ,     31.3  ,    2.1 (           ----|   *-----     ),28.70, 30.28, 31.52, 31.78, 33.50

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen80_f4 ,      3.0  ,    1.0 (---*--         |              ), 2.00,  3.00,  3.00,  3.00,  4.00
   1 ,    gen100_f4 ,      3.0  ,    1.0 (---*--         |              ), 2.00,  3.00,  3.00,  3.00,  4.00
   2 ,     gen60_f4 ,      3.0  ,    1.0 (---   *--      |              ), 2.00,  3.00,  4.00,  4.00,  5.00
   3 ,     gen40_f4 ,      4.0  ,    1.0 (   ---*  ----  |              ), 3.00,  4.00,  4.00,  5.00,  6.00
   4 ,     gen20_f4 ,      6.0  ,    3.0 (      ---    * |---           ), 4.00,  5.00,  6.00,  7.00,  8.00
   5 ,      gen0_f4 ,      7.0  ,    3.0 (         ----  |*      ---    ), 5.00,  6.00,  7.00,  9.00, 10.00
```

### Time Taken : 12.4349470139
![1](../../../src/img/weighted_uniform/Kids and Youth.png)
...
+------+-------------------------------------------+------+-------+------+
|  1   |              Provide Feedback             | task |   -1  |  1   |
|  2   |         Maintain Phone Counselling        | task |   -1  |  1   |
|  3   |         !Implement Text Messaging         | task |   -1  |  1   |
|  4   |           Contact CS in Crisis            | task |   -1  |  1   |
|  5   |     Maintain Ask a Counsellor Section     | task |   -1  |  1   |
|  6   |      !Implement One-On-One Chat Rooms     | task |   -1  |  1   |
|  7   |   !Implement Cyber Café/Portal/Chat Room  | task |   -1  |  1   |
|  8   |        Implement Email Counselling        | task |   -1  |  1   |
|  9   |   !Implement Bulletin Board with Replies  | task |   -1  |  1   |
|  10  |        Implement Voice Counselling        | task |   -1  |  1   |
|  11  |   Contact CS about Non-Crisis Situation   | task |   -1  |  1   |
|  12  |        Implement Video Counselling        | task |   -1  |  1   |
|  13  |  !Implement General Questions and Answers | task |   1   |  1   |
|  14  | Maintain Get Informed Section of Web Site | task |   -1  |  1   |
|  15  |        !Implement Polls about Kids        | task |   -1  |  1   |
+------+-------------------------------------------+------+-------+------+
```
