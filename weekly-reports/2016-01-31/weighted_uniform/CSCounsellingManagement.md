...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    82.64  ,   4.96 (           ----|-   * -----   ),76.86, 80.99, 82.64, 84.30, 87.60
   2 ,     gen40_f1 ,    83.47  ,   4.95 (               |-    * ----   ),79.34, 80.99, 83.47, 85.12, 87.60
   2 ,     gen60_f1 ,    83.47  ,   4.95 (               |-    * -----  ),79.34, 80.99, 83.47, 85.12, 88.43
   2 ,     gen80_f1 ,    83.47  ,   4.96 (               |---  * -----  ),80.17, 81.82, 83.47, 85.12, 88.43
   2 ,    gen100_f1 ,    83.47  ,   4.96 (               |---  *   --   ),79.34, 81.82, 83.47, 85.95, 87.60
...
----------------------------------------------------
   ...
   1 ,     gen60_f2 ,    97.22  ,   5.56 (         ------|---*          ),94.44, 97.22, 97.22, 100.00, 100.00
   1 ,     gen80_f2 ,    97.22  ,   5.56 (         ------|---*          ),94.44, 97.22, 97.22, 100.00, 100.00
   1 ,    gen100_f2 ,    97.22  ,   5.56 (               |   *          ),94.44, 94.44, 97.22, 100.00, 100.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,    133.98  ,  21.41 (   --  *   ----|              ),120.64, 128.30, 134.17, 148.03, 161.19
   2 ,     gen20_f3 ,    150.14  ,   22.6 (      -----  * |----          ),129.86, 146.31, 152.21, 162.98, 176.51
   2 ,     gen40_f3 ,    153.4  ,  21.38 (        ---  * |----          ),136.32, 147.10, 153.50, 163.90, 176.51
   2 ,     gen60_f3 ,    158.08  ,  19.78 (         ---   * ---          ),138.56, 148.50, 158.39, 166.73, 176.51
   2 ,     gen80_f3 ,    158.08  ,   21.2 (         ---   * ---          ),138.56, 149.14, 158.39, 166.88, 177.75
   2 ,    gen100_f3 ,    160.46  ,  18.73 (         ---   * ---          ),138.56, 150.76, 161.19, 166.88, 176.51

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen80_f4 ,      8.0  ,    2.0 (      ---  * --|--            ), 6.00,  7.00,  8.00,  9.00, 11.00
   1 ,    gen100_f4 ,      8.0  ,    2.0 (    -----  * --|--            ), 5.00,  7.00,  8.00,  9.00, 11.00
   2 ,     gen60_f4 ,      8.0  ,    1.0 (      -----  *-|--            ), 6.00,  8.00,  9.00,  9.00, 11.00
   2 ,     gen40_f4 ,      9.0  ,    2.0 (         --  * |----          ), 7.00,  8.00,  9.00, 10.00, 12.00
   3 ,     gen20_f4 ,     10.0  ,    3.0 (         ----  |* -----       ), 7.00,  9.00, 10.00, 11.00, 13.00
   3 ,      gen0_f4 ,     11.0  ,    2.0 (           ----|  * -----     ), 8.00, 10.00, 11.00, 12.00, 14.00
```

### Time Taken : 65.8437581062
![1](../../../src/img/weighted_uniform/CSCounsellingManagement.png)
...
+------+-----------------------------------------------------+----------+-------+------+
|  1   |                  !Hire Counsellors                  |   task   |   -1  |  1   |
|  2   |      Communicate CS Information to Counsellors      |   task   |   1   |  1   |
|  3   |      Provide One-on-One Support to Counsellors      |   task   |   -1  |  1   |
|  4   |              Attend Part Time Meetings              |   task   |   -1  |  1   |
|  5   |            Put on Web Moderator Meetings            |   task   |   1   |  1   |
|  6   |             Put On Counselling Workshops            |   task   |   -1  |  1   |
|  7   |                     Review Tape                     |   task   |   1   |  1   |
|  8   |               Set Counselling Policies              |   task   |   -1  |  1   |
|  9   |                   Use Blue Pumpkin                  |   task   |   -1  |  1   |
|  10  | Write Yearly Peformance Evaluations for Counsellors |   task   |   -1  |  1   |
|  11  |                  Debrief Web Posts                  |   task   |   -1  |  1   |
|  12  |           Negotiate with Counsellors Union          |   task   |   -1  |  1   |
|  13  |                 Counsellors Be Paid                 |   task   |   -1  |  1   |
|  14  |           Historical Data of Call Volumes           | resource |   -1  |  1   |
|  15  |        Create Call Classification Catagories        |   task   |   -1  |  1   |
|  16  |      Put on Orientation Process for Cousellors      |   task   |   1   |  1   |
|  17  |                   Call Statistics                   | resource |   -1  |  1   |
|  18  |                    Request Shifts                   |   task   |   -1  |  1   |
|  19  |         Acquire Web Training from Operations        |   task   |   1   |  1   |
|  20  |              !Hire Counselling Managers             |   task   |   -1  |  1   |
|  21  |                    Debrief Calls                    |   task   |   -1  |  1   |
|  22  |                   Double Head Set                   | resource |   -1  |  1   |
|  23  |                Counselling Resources                | resource |   -1  |  1   |
+------+-----------------------------------------------------+----------+-------+------+
```
