...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f4 ,     12.0  ,    3.0 (   --  *   --  |              ),10.00, 11.00, 12.00, 14.00, 15.00
   1 ,     gen80_f4 ,     13.0  ,    3.0 (     --  * --- |              ),11.00, 12.00, 13.00, 14.00, 16.00
   2 ,     gen60_f4 ,     14.0  ,    2.0 (       --  * --|--            ),12.00, 13.00, 14.00, 15.00, 18.00
   3 ,     gen40_f4 ,     15.0  ,    4.0 (       ----  *-|--            ),12.00, 14.00, 15.00, 16.00, 18.00
   3 ,     gen20_f4 ,     16.0  ,    3.0 (         --   *|--            ),13.00, 14.00, 16.00, 17.00, 18.00
   4 ,      gen0_f4 ,     17.0  ,    3.0 (         ----- |* ------      ),13.00, 16.00, 17.00, 18.00, 21.00
```

### Time Taken : 12.2069540024
![1](../../../src/img/weighted_uniform/CSCounsellingSD.png)
...
+------+----------------------------------------------+----------+-------+------+
|  1   |            Report Outdated Links             |   task   |   -1  |  1   |
|  2   |           Resources in the Library           | resource |   -1  |  1   |
|  3   |           Create Counselling Posts           |   task   |   -1  |  1   |
|  4   |                   Feedback                   | resource |   -1  |  1   |
|  5   |            Information/Resources             | resource |   -1  |  1   |
|  6   |            Counsellor Experience             | resource |   -1  |  1   |
|  7   |         Web Counselling be Performed         |   task   |   -1  |  1   |
|  8   |          *Implement Bulletin Board           |   task   |   1   |  1   |
|  9   |          Tape Recording Technoloyg           | resource |   -1  |  1   |
|  10  |        *Implement Categorization Tool        |   task   |   1   |  1   |
|  11  |            Web Moderator Meetings            | resource |   -1  |  1   |
|  12  |      Provide Web Counselling with Video      |   task   |   -1  |  1   |
|  13  |           Undergo Clinical Review            |   task   |   -1  |  1   |
|  14  |      Provide Web Counselling with Audio      |   task   |   -1  |  1   |
|  15  |           Information in E-Library           | resource |   -1  |  1   |
|  16  |       ! Write Articles for Magazines         |   task   |   -1  |  1   |
|  17  |               !Moderate a Chat               |   task   |   -1  |  1   |
|  18  |       *Implement Email for Counsellors       |   task   |   -1  |  1   |
|  19  |        ! Write Articles for Website          |   task   |   -1  |  1   |
|  20  |                Sign Contract                 |   task   |   1   |  1   |
|  21  |               Double Headsets                | resource |   -1  |  1   |
|  22  |       Information Binders at Stations        | resource |   -1  |  1   |
|  23  |         Provide Written Counselling          |   task   |   1   |  1   |
|  24  |            Participate in events             |   task   |   -1  |  1   |
|  25  |             Provide Information              |   task   |   -1  |  1   |
|  26  |                    Tapes                     | resource |   -1  |  1   |
|  27  |          !Perform Email Counselling          |   task   |   -1  |  1   |
|  28  |             Counselling Policies             | resource |   -1  |  1   |
|  29  |               Web Site Content               | resource |   -1  |  1   |
|  30  |                  Promote CS                  |   task   |   -1  |  1   |
|  31  |         !Moderate Discussion Boards          |   task   |   -1  |  1   |
|  32  | ! Counselor Speak on Kids Issues in General  |   task   |   -1  |  1   |
|  33  |            Counselling Workshops             | resource |   -1  |  1   |
|  34  |             Provide Counselling              |   task   |   -1  |  1   |
|  35  |                 Training CDs                 | resource |   -1  |  1   |
+------+----------------------------------------------+----------+-------+------+
```
