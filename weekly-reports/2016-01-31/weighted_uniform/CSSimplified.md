...
### Time Taken : 123.804624081
![1](../../../src/img/weighted_uniform/CSSimplified.png)
...
+------+----------------------------------------------------------+----------+-------+------+
|  1   |                Run Fundraiser in Schools                 |   task   |   1   |  1   |
|  2   |           Kids Use Ask a Counsellor Section\ns           |   task   |   1   |  1   |
|  3   |                  Counsellor Experience                   | resource |   1   |  1   |
|  4   |                      Free Hardware                       | resource |   -1  |  1   |
|  5   |         Kids read General Questions and Answers          |   task   |   1   |  1   |
|  6   |                Tape Recording Technology                 | resource |   -1  |  1   |
|  7   |                *Implement Bulletin Board                 |   task   |   1   |  1   |
|  8   |            Provide Web Counselling with Audio            |   task   |   1   |  1   |
|  9   |                   Strategic Blue Print                   | resource |   1   |  1   |
|  10  |                !Implement Phone Feedback                 |   task   |   -1  |  1   |
|  11  |                 Create General Ledgers                   |   task   |   1   |  1   |
|  12  |                     Send out Emails                      |   task   |   1   |  1   |
|  13  |                      Free Software                       | resource |   1   |  1   |
|  14  |                       Web Software                       | resource |   -1  |  1   |
|  15  |                      Pledge online                       |   task   |   1   |  1   |
|  16  |               Diffuse Conflict with Parent               |   task   |   1   |  1   |
|  17  |               Write Articles for Newspaper               |   task   |   1   |  1   |
|  18  |          !Implement Bulletin Board with Replies          |   task   |   1   |  1   |
|  19  |                !Perform Email Counselling                |   task   |   1   |  1   |
|  20  |                Kids Use Video Counselling                |   task   |   1   |  1   |
|  21  |               *Maintain PHL Phone Services               |   task   |   -1  |  1   |
|  22  |               ! Provide money for services               |   task   |   1   |  1   |
|  23  |           Kids Use Bulletin Board with Replies           |   task   |   1   |  1   |
|  24  |                     Call Statistics                      | resource |   1   |  1   |
|  25  |            Phone Library of Recorded Messages            | resource |   -1  |  1   |
|  26  |                     !Moderate a Chat                     |   task   |   -1  |  1   |
|  27  |                !Implement Text Messaging                 |   task   |   -1  |  1   |
|  28  |                  Web Moderator Meetings                  | resource |   -1  |  1   |
|  29  |              Use sponsor marketing channels              |   task   |   -1  |  1   |
|  30  |             Negotiate with Counsellors Union             |   task   |   1   |  1   |
|  31  |                  Give CS Presentations                   |   task   |   1   |  1   |
|  32  |                Kids Use Voice Counselling                |   task   |   1   |  1   |
|  33  |                  Counselling Workshops                   | resource |   1   |  1   |
|  34  |                   Promotion Resources                    | resource |   1   |  1   |
|  35  |               !Implement Polls about Kids                |   task   |   1   |  1   |
|  36  |              Parents Use Phone Counselling               |   task   |   1   |  1   |
|  37  |       ! Counselor Speak on Kids Issues in General        |   task   |   1   |  1   |
|  38  |             Provide Online Donor Technology              |   task   |   1   |  1   |
|  39  |              Share PAP in Document Library               |   task   |   1   |  1   |
|  40  |                   Sponsorship proposal                   |   task   |   1   |  1   |
|  41  |        Get Corporate Partner Information from DL         |   task   |   1   |  1   |
|  42  |                   Counselling Policies                   | resource |   1   |  1   |
|  43  |          Single charitable registration number           | resource |   1   |  1   |
|  44  |                       Sponsor Logo                       | resource |   1   |  1   |
|  45  |           Help Put on SA Training Conferences            |   task   |   1   |  1   |
|  46  |                          Oracle                          | resource |   1   |  1   |
|  47  |                Donor/Accounting Data Base                | resource |   1   |  1   |
|  48  |                  Speak at Fundraisers1                   |   task   |   1   |  1   |
|  49  |                Maintain Phone Counselling                |   task   |   1   |  1   |
|  50  |             Historical Data of Call Volumes              | resource |   -1  |  1   |
|  51  |                     Double Head Set                      | resource |   -1  |  1   |
|  52  |                   Manage Receivables                     |   task   |   -1  |  1   |
|  53  |                       Information                        | resource |   -1  |  1   |
|  54  |                        Promote CS                        |   task   |   -1  |  1   |
|  55  |                          Funds                           | resource |   1   |  1   |
|  56  |                Kids Use Email Counselling                |   task   |   -1  |  1   |
|  57  |             Maintain/ Implement PHL Services             |   task   |   -1  |  1   |
|  58  |         Plan and Put on Reconnection Conferences         |   task   |   1   |  1   |
|  59  |                        Web Server                        | resource |   1   |  1   |
|  60  |              *Implement Categorization Tool              |   task   |   1   |  1   |
|  61  |              Elaborate Fundraising targets               |   task   |   1   |  1   |
|  62  |                         Hardware                         | resource |   -1  |  1   |
|  63  |                  Give CS Presentations1                  |   task   |   -1  |  1   |
|  64  |                Kids Use Phone Counselling                |   task   |   -1  |  1   |
|  65  |                  Participate in events                   |   task   |   1   |  1   |
|  66  |                     Free Web Server                      | resource |   1   |  1   |
|  67  |                 *Maintain Phone Services                 |   task   |   -1  |  1   |
|  68  |                 Put Content Onto Website                 |   task   |   1   |  1   |
|  69  |                 Undergo Clinical Review                  |   task   |   -1  |  1   |
|  70  |                 Philanthropic donations                  |   task   |   1   |  1   |
|  71  |                          Tapes                           | resource |   -1  |  1   |
|  72  |               School Initiates Presenation               |   task   |   -1  |  1   |
|  73  |                      Provide funds                       |   task   |   1   |  1   |
|  74  |                   Provide Counselling                    |   task   |   -1  |  1   |
|  75  |                      Free Upgrades                       | resource |   -1  |  1   |
|  76  |                   Speak at Fundraisers                   |   task   |   -1  |  1   |
|  77  |                    Free advertisement                    | resource |   1   |  1   |
|  78  |               Manage\nPartner Relationship               |   task   |   1   |  1   |
|  79  |                        Agreement                         | resource |   1   |  1   |
|  80  |                         *Salary                          | resource |   1   |  1   |
|  81  |                    Caller Statistics                     | resource |   -1  |  1   |
|  82  |             !Implement One-On-One Chat Rooms             |   task   |   -1  |  1   |
|  83  |                         Speaches                         | resource |   1   |  1   |
|  84  |                      Sign Contract                       |   task   |   1   |  1   |
|  85  |                         Software                         | resource |   -1  |  1   |
|  86  |                  Maintain Web Services                   |   task   |   -1  |  1   |
|  87  |                  Collect Pledge online                   |   task   |   1   |  1   |
|  88  |              Voice Counselling be Performed              |   task   |   -1  |  1   |
|  89  |              ! Provide compiled call data                |   task   |   1   |  1   |
|  90  |                         Upgrades                         | resource |   -1  |  1   |
|  91  |                   Pledge\nDuring event                   |   task   |   1   |  1   |
|  92  |        Maintain Get Informed Section of Web Site         |   task   |   1   |  1   |
|  93  |               Implement Voice Counselling                |   task   |   1   |  1   |
|  94  |               Implement Email Counselling                |   task   |   1   |  1   |
|  95  |             ! Write Articles for Magazines               |   task   |   1   |  1   |
|  96  |          !Implement Cyber Café/Portal/Chat Room          |   task   |   -1  |  1   |
|  97  |       !Parents Use Service to Talk to Each Other         |   task   |   -1  |  1   |
|  98  |               Implement Video Counselling                |   task   |   1   |  1   |
|  99  |                   Promotion Resources1                   | resource |   1   |  1   |
| 100  |                 Get web event technology                 |   task   |   -1  |  1   |
| 101  |                       Training CDs                       | resource |   -1  |  1   |
| 102  |                     Provide receipts                     |   task   |   -1  |  1   |
| 103  |            Maintain Ask a Counsellor Section             |   task   |   1   |  1   |
| 104  |                 Get sponsors for events                  |   task   |   -1  |  1   |
| 105  | !Implement\nTool to Allow Parents to Talk to Each Other  |   task   |   1   |  1   |
| 106  |             Provide Document Library System              |   task   |   -1  |  1   |
| 107  |        Kids use get Informed Section of Web Site         |   task   |   1   |  1   |
| 108  |         Parents Use Bulletin Board with Replies          |   task   |   -1  |  1   |
| 109  |               Second Reading of Web Posts                |   task   |   -1  |  1   |
| 110  |                       IT Resources                       | resource |   -1  |  1   |
| 111  |                   Provide Information                    |   task   |   1   |  1   |
| 112  |               Find Help with Presentations               |   task   |   1   |  1   |
| 113  |          Inform kids about anonymity of service          |   task   |   -1  |  1   |
| 114  |              Maintain/Implement CS Services              |   task   |   1   |  1   |
| 115  |               !Moderate Discussion Boards                |   task   |   1   |  1   |
| 116  |              Implement Information Section               |   task   |   1   |  1   |
| 117  |                     Manage Accounts                      |   task   |   1   |  1   |
| 118  |              Put on SA Training Conferences              |   task   |   1   |  1   |
| 119  |                 Create Counselling Posts                 |   task   |   1   |  1   |
| 120  |                     Web Site Content                     | resource |   1   |  1   |
| 121  |            Provide Web Counselling with Video            |   task   |   1   |  1   |
| 122  |                   ! Market CS Service                    |   task   |   -1  |  1   |
| 123  |              Kids Use One-On-One Chat Rooms              |   task   |   1   |  1   |
| 124  |             *Implement Email for Counsellors             |   task   |   1   |  1   |
| 125  |                Kids read Polls about Kids                |   task   |   -1  |  1   |
| 126  |              ! Write Articles for Website                |   task   |   -1  |  1   |
| 127  |                       Web Server1                        | resource |   1   |  1   |
| 128  |                        Feedback1                         | resource |   1   |  1   |
| 129  |                         Feedback                         | resource |   -1  |  1   |
| 130  |                  Provide free services                   |   task   |   -1  |  1   |
| 131  |                    Service Resources                     | resource |   1   |  1   |
| 132  |                  Feedback Form Software                  | resource |   -1  |  1   |
| 133  |               Implement Board with Replies               |   task   |   -1  |  1   |
| 134  |                 Help with Presentations                  |   task   |   1   |  1   |
| 135  |         !Implement General Questions and Answers         |   task   |   1   |  1   |
| 136  |                 Kids Use Text Messaging                  |   task   |   -1  |  1   |
| 137  |             Parents Use Information Section              |   task   |   -1  |  1   |
| 138  |               Provide fundraising services               |   task   |   1   |  1   |
| 139  |      Help Plan and Put on Reconnection Conferences       |   task   |   -1  |  1   |
| 140  |               Provide Written Counselling                |   task   |   -1  |  1   |
| 141  |           Kids Use Cyber Café/Portal/Chat Room           |   task   |   -1  |  1   |
+------+----------------------------------------------------------+----------+-------+------+
```
