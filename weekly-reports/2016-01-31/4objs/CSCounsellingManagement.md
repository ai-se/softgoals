...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    85.12  ,   4.13 (            ---|   * ---      ),80.99, 83.47, 85.12, 86.78, 88.43
   2 ,     gen40_f1 ,    85.95  ,   4.13 (            ---|-   *  --     ),80.99, 84.30, 85.95, 87.60, 89.26
   2 ,     gen60_f1 ,    85.95  ,    3.3 (              -|--- *  --     ),82.64, 85.12, 85.95, 87.60, 89.26
   2 ,     gen80_f1 ,    85.95  ,   2.48 (              -|--- *  --     ),82.64, 85.12, 85.95, 87.60, 89.26
   2 ,    gen100_f1 ,    85.95  ,   2.48 (              -|--- *  -      ),82.64, 85.12, 85.95, 87.60, 88.43

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    97.22  ,   2.78 (               |   *--------- ),94.44, 94.44, 97.22, 97.22, 100.00
   1 ,     gen20_f2 ,    97.22  ,   5.56 (         ------|---*--------- ),94.44, 97.22, 97.22, 97.22, 100.00
   1 ,     gen40_f2 ,    97.22  ,   5.56 (         ------|---*--------- ),94.44, 97.22, 97.22, 97.22, 100.00
   1 ,     gen60_f2 ,    97.22  ,   2.78 (         ------|---*--------- ),94.44, 97.22, 97.22, 97.22, 100.00
   1 ,     gen80_f2 ,    97.22  ,   2.78 (         ------|---*          ),94.44, 97.22, 97.22, 100.00, 100.00
   1 ,    gen100_f2 ,    97.22  ,   5.56 (         ------|---*--------- ),94.44, 97.22, 97.22, 97.22, 100.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,    131.0  ,   16.0 (   -----    *  |--------      ),117.00, 125.00, 132.00, 136.00, 150.00
   2 ,     gen20_f3 ,    138.0  ,   10.0 (        -----  |*  ---        ),125.00, 133.00, 138.00, 142.00, 148.00
   2 ,     gen40_f3 ,    139.0  ,   11.0 (        ------ | *  ----      ),125.00, 135.00, 140.00, 144.00, 150.00
   2 ,     gen60_f3 ,    140.0  ,    7.0 (           ----|  * ----      ),130.00, 138.00, 141.00, 144.00, 150.00
   2 ,     gen80_f3 ,    141.0  ,    8.0 (          -----|  * ----      ),128.00, 138.00, 141.00, 144.00, 150.00
   2 ,    gen100_f3 ,    141.0  ,    6.0 (          -----|  *---        ),129.00, 138.00, 141.00, 143.00, 148.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f4 ,     21.0  ,    5.0 (  -- * ------  |              ),16.00, 19.00, 21.00, 24.00, 32.00
   1 ,     gen80_f4 ,     23.0  ,    8.0 (   --  *   ----|              ),18.00, 21.00, 23.00, 29.00, 36.00
   2 ,     gen60_f4 ,     24.0  ,   10.0 (     --  *  ---|-             ),21.00, 23.00, 26.00, 31.00, 38.00
   2 ,     gen40_f4 ,     29.0  ,   11.0 (     --    *  -|-             ),21.00, 24.00, 29.00, 34.00, 38.00
   3 ,     gen20_f4 ,     34.0  ,    9.0 (       -----  *| --           ),23.00, 31.00, 34.00, 38.00, 41.00
   4 ,      gen0_f4 ,     40.0  ,    8.0 (         ------|  *-----      ),26.00, 35.00, 40.00, 41.00, 49.00
```

### Time Taken : 62.6815280914
![1](../../../src/img/4objs/CSCounsellingManagement.png)
...
+------+-----------------------------------------------------+----------+-------+------+
|  1   |      Put on Orientation Process for Cousellors      |   task   |   -1  |  5   |
|  2   |      Communicate CS Information to Counsellors      |   task   |   1   |  3   |
|  3   |           Negotiate with Counsellors Union          |   task   |   -1  |  4   |
|  4   |        Create Call Classification Catagories        |   task   |   -1  |  4   |
|  5   |               Set Counselling Policies              |   task   |   -1  |  3   |
|  6   |           Historical Data of Call Volumes           | resource |   -1  |  4   |
|  7   |              !Hire Counselling Managers             |   task   |   -1  |  5   |
|  8   |                     Review Tape                     |   task   |   1   |  2   |
|  9   |                   Use Blue Pumpkin                  |   task   |   -1  |  4   |
|  10  |              Attend Part Time Meetings              |   task   |   -1  |  4   |
|  11  |                Counselling Resources                | resource |   -1  |  4   |
|  12  |                  Debrief Web Posts                  |   task   |   -1  |  4   |
|  13  |         Acquire Web Training from Operations        |   task   |   -1  |  4   |
|  14  |      Provide One-on-One Support to Counsellors      |   task   |   1   |  3   |
|  15  |                   Call Statistics                   | resource |   -1  |  5   |
|  16  |                  !Hire Counsellors                  |   task   |   1   |  2   |
|  17  |                    Request Shifts                   |   task   |   -1  |  2   |
|  18  |            Put on Web Moderator Meetings            |   task   |   1   |  2   |
|  19  |                 Counsellors Be Paid                 |   task   |   -1  |  5   |
|  20  |             Put On Counselling Workshops            |   task   |   1   |  1   |
|  21  |                   Double Head Set                   | resource |   -1  |  5   |
|  22  |                    Debrief Calls                    |   task   |   1   |  4   |
|  23  | Write Yearly Peformance Evaluations for Counsellors |   task   |   -1  |  1   |
+------+-----------------------------------------------------+----------+-------+------+
```
