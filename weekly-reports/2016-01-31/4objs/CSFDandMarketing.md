...
----------------------------------------------------
   ...
   2 ,     gen20_f1 ,    90.91  ,    3.9 (               |---  *----    ),87.01, 89.61, 91.56, 92.86, 96.10
   3 ,     gen40_f1 ,    92.21  ,   3.25 (               |  -   *---    ),88.96, 90.26, 92.21, 92.86, 96.10
   3 ,     gen60_f1 ,    92.21  ,   3.25 (               |  -   *----   ),88.96, 90.26, 92.21, 93.51, 96.75
   3 ,     gen80_f1 ,    92.21  ,    3.9 (               |   -  * ---   ),89.61, 90.91, 92.86, 94.16, 96.75
   3 ,    gen100_f1 ,    92.86  ,   4.55 (               |   -  * ---   ),89.61, 90.91, 92.86, 94.16, 96.75

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    81.25  ,   6.25 (     ----  *   |-             ),75.00, 78.13, 81.25, 84.38, 87.50
   2 ,     gen20_f2 ,    90.63  ,   6.25 (           ----|-    *-----   ),81.25, 87.50, 90.63, 90.63, 96.88
   2 ,     gen40_f2 ,    90.63  ,   6.25 (               |     * ----   ),87.50, 87.50, 90.63, 93.75, 96.88
   2 ,     gen60_f2 ,    90.63  ,   6.25 (               | ----* ----   ),87.50, 90.63, 90.63, 93.75, 96.88
   2 ,     gen80_f2 ,    90.63  ,   6.25 (               | ----*     -- ),87.50, 90.63, 90.63, 96.88, 100.00
   3 ,    gen100_f2 ,    90.63  ,   6.25 (               | ----  *   -- ),87.50, 90.63, 93.75, 96.88, 100.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,    205.0  ,   28.0 (     ---  *    |---           ),188.00, 198.00, 206.00, 222.00, 236.00
   2 ,     gen20_f3 ,    224.0  ,   20.0 (         ----- | *-----       ),203.00, 219.00, 227.00, 231.00, 249.00
   2 ,     gen40_f3 ,    227.0  ,   15.0 (             --| * ----       ),214.00, 221.00, 227.00, 234.00, 249.00
   2 ,     gen60_f3 ,    227.0  ,   17.0 (             --| * -----      ),214.00, 221.00, 227.00, 236.00, 250.00
   2 ,     gen80_f3 ,    229.0  ,   16.0 (             --| * ----       ),215.00, 223.00, 229.00, 236.00, 249.00
   2 ,    gen100_f3 ,    229.0  ,   20.0 (             --|  * ----      ),214.00, 224.00, 230.00, 239.00, 250.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f4 ,    106.0  ,   12.0 (        ---  * |---           ),94.00, 101.00, 106.00, 112.00, 120.00
   2 ,     gen20_f4 ,    112.0  ,   16.0 (         ----- |* -----       ),95.00, 109.00, 113.00, 119.00, 131.00
   2 ,     gen40_f4 ,    116.0  ,   17.0 (           ----| * -----      ),100.00, 110.00, 116.00, 120.00, 132.00
   2 ,     gen60_f4 ,    116.0  ,   17.0 (           ----|  *-----      ),100.00, 110.00, 117.00, 121.00, 132.00
   2 ,     gen80_f4 ,    117.0  ,   17.0 (           ----|  * ----      ),100.00, 110.00, 117.00, 122.00, 132.00
   2 ,    gen100_f4 ,    117.0  ,   18.0 (          -----|  * ----      ),99.00, 110.00, 117.00, 122.00, 132.00
```

### Time Taken : 253.218880177
![1](../../../src/img/4objs/CSFDandMarketing.png)
...
+------+--------------------------------------------------------------------------+----------+-------+------+
|  1   |      Sponsors Include CS Logos and Descriptions on their Products        |   task   |   1   |  2   |
|  2   |                   !Train counselors on public speaking                   |   task   |   1   |  3   |
|  3   |                          Provide free services                           |   task   |   1   |  1   |
|  4   |                          Participate in events                           |   task   |   1   |  5   |
|  5   |                  Single charitable registration number1                  | resource |   1   |  5   |
|  6   |                  Communicate through Internet and phone                  |   task   |   1   |  5   |
|  7   |                    Market [Only For Serious Issues]                      |   task   |   1   |  5   |
|  8   |                             Reach agreement                              |   task   |   1   |  1   |
|  9   |                      Share PAP in Document Library1                      |   task   |   1   |  3   |
|  10  |                              Pledge\nonline                              |   task   |   1   |  2   |
|  11  |                       Inform Sponsors of Progress                        |   task   |   1   |  5   |
|  12  |                          Use volunteer services                          |   task   |   1   |  1   |
|  13  |                             Manage Accounts                              |   task   |   1   |  1   |
|  14  |                       ! Provide money for services                       |   task   |   1   |  2   |
|  15  |      Email Corporate Partners Interesting and Relevant News Pieces       |   task   |   1   |  1   |
|  16  |                              Provide funds                               |   task   |   1   |  2   |
|  17  |                        Get web event technology1                         |   task   |   1   |  2   |
|  18  |                Write Down Corporate Sponsors Objectives                  |   task   |   -1  |  2   |
|  19  |                     Develop national event calendar                      |   task   |   1   |  4   |
|  20  |                      ! Provide compiled call data                        |   task   |   -1  |  3   |
|  21  |                     Provide Real Time Tax Receipts                       |   task   |   1   |  3   |
|  22  |                            Provide Logo to CS                            |   task   |   1   |  3   |
|  23  |                       Exclusive Brand and Logo use                       | resource |   1   |  2   |
|  24  |                      ! Write Articles for Website 1                      |   task   |   1   |  2   |
|  25  |                           Manage Receivables                             |   task   |   1   |  1   |
|  26  |                          Conflicts Be Managed                            |   task   |   1   |  4   |
|  27  |                Work with the Regions to Implement Events                 |   task   |   1   |  2   |
|  28  |                        Donor/Accounting Database                         | resource |   -1  |  4   |
|  29  |   Put on Orientation Process for Fund Development and Marketing Staff    |   task   |   -1  |  3   |
|  30  |                      Elaborate Fundraising targets1                      |   task   |   -1  |  2   |
|  31  |           Provide Promotional Material to Student Ambassadors            |   task   |   1   |  5   |
|  32  |                            Free advertisement                            | resource |   1   |  3   |
|  33  |                      Share PAP in Document Library                       |   task   |   1   |  5   |
|  34  | Pitch to National Corporate Sponsors the Sponsorship of Regional Events  |   task   |   -1  |  4   |
|  35  |                        Collect donor information                         |   task   |   -1  |  2   |
|  36  |                     Implement Stay in Touch program                      |   task   |   -1  |  2   |
|  37  |              Put Together Proposals for Corporate Sponsors               |   task   |   1   |  1   |
|  38  |                Get Corporate Partner Information from DL1                |   task   |   -1  |  3   |
|  39  |                         Create General Ledgers                           |   task   |   -1  |  5   |
|  40  |                            Get donor database                            |   task   |   1   |  3   |
|  41  |                    Put on orientation for volunteers                     |   task   |   1   |  4   |
|  42  |                    Organize discussions with Sponsors                    |   task   |   -1  |  4   |
|  43  |                          Reallocate resources1                           |   task   |   -1  |  5   |
|  44  |                  Store donor transactions into database                  |   task   |   -1  |  4   |
|  45  |                       National Marketing Strategy                        | resource |   1   |  5   |
|  46  |                       Bi-Weekly Conference Calls                         |   task   |   -1  |  4   |
|  47  |                       Give philanthropic donation                        |   task   |   1   |  5   |
|  48  |                              Track budgets                               |   task   |   1   |  2   |
|  49  |                     ! Write Articles for Magazines 1                     |   task   |   1   |  3   |
|  50  |                     Provide Online Donor Technology                      |   task   |   1   |  1   |
|  51  |                         Send recognition letters                         |   task   |   1   |  2   |
|  52  |                  Store donor information into database                   |   task   |   1   |  4   |
|  53  |                           Speak at Fundraisers                           |   task   |   1   |  1   |
|  54  |                        Run Fundraiser in Schools                         |   task   |   -1  |  4   |
|  55  |                          Give CS Presentations                           |   task   |   -1  |  5   |
|  56  |                      Place Sponsor Logos in Events                       |   task   |   1   |  1   |
|  57  |                          Provide free services1                          |   task   |   1   |  2   |
|  58  |                     Provide Document Library System                      |   task   |   -1  |  3   |
|  59  |                      Provide philanthropic donation                      |   task   |   1   |  4   |
|  60  |                           Pledge\nDuring event                           |   task   |   -1  |  4   |
|  61  |                       Market through own channels                        |   task   |   -1  |  4   |
|  62  |          Bring Regional Fundraising Staff Together Once a Year           |   task   |   -1  |  4   |
|  63  |                       Get philanthropic donations                        |   task   |   1   |  3   |
|  64  |                Pay Fund Development and Marketing Staff                  |   task   |   -1  |  4   |
|  65  |                          Create Thank you ads                            |   task   |   -1  |  1   |
|  66  |                         Create branded products                          |   task   |   -1  |  3   |
|  67  |            Create posters, flyers and informational material             |   task   |   -1  |  5   |
|  68  |                           Reallocate resources                           |   task   |   -1  |  5   |
|  69  |              ! Counselor Speak on Kids Issues in General 1               |   task   |   -1  |  5   |
+------+--------------------------------------------------------------------------+----------+-------+------+
```
...
|                        Put on Fundraising Events                         |   task   |  0.5  |
...
|                          Collect Pledge online                           |   task   |   1   |
|          Increased Availability [Counselors to Public/Sponsors]          | softgoal |   1   |
...
|                 Up to date corporate partner information                 | softgoal |   1   |
|                  Subscribe to Document Library Folders                   |   task   |   -1  |
