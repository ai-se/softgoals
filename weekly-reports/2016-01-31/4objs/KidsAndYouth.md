...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,     28.0  ,    1.0 (        -------|-*   ----     ),26.00, 28.00, 28.00, 29.00, 30.00
   1 ,     gen20_f3 ,     28.0  ,    1.0 (               |     *---     ),28.00, 28.00, 29.00, 29.00, 30.00
   2 ,     gen40_f3 ,     29.0  ,    1.0 (               |     *---     ),28.00, 28.00, 29.00, 29.00, 30.00
   2 ,     gen60_f3 ,     29.0  ,    1.0 (               | ----*---     ),28.00, 29.00, 29.00, 29.00, 30.00
   2 ,     gen80_f3 ,     29.0  ,    1.0 (               | ----*---     ),28.00, 29.00, 29.00, 29.00, 30.00
   2 ,    gen100_f3 ,     29.0  ,    1.0 (               | ----*---     ),28.00, 29.00, 29.00, 29.00, 30.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,     gen60_f4 ,      7.0  ,    2.0 (  - *-         |              ), 5.00,  6.00,  7.00,  7.00,  9.00
   1 ,     gen80_f4 ,      7.0  ,    2.0 (    *          |              ), 5.00,  5.00,  7.00,  7.00,  8.00
   1 ,    gen100_f4 ,      7.0  ,    2.0 ( -  *          |              ), 4.00,  5.00,  7.00,  7.00,  8.00
   2 ,     gen40_f4 ,      8.0  ,    2.0 (   - *--       |              ), 6.00,  7.00,  8.00,  9.00, 11.00
   3 ,     gen20_f4 ,     10.0  ,    4.0 (    --  * ---- |              ), 7.00,  9.00, 11.00, 13.00, 17.00
   4 ,      gen0_f4 ,     19.0  ,    9.0 (         ---   |*   -----     ),12.00, 15.00, 19.00, 23.00, 28.00
```

### Time Taken : 11.1409728527
![1](../../../src/img/4objs/Kids and Youth.png)
...
|  2   |     Maintain Ask a Counsellor Section     | task |   -1  |  5   |
|  3   |              Provide Feedback             | task |   -1  |  5   |
|  4   |         Maintain Phone Counselling        | task |   -1  |  2   |
|  5   |   !Implement Bulletin Board with Replies  | task |   -1  |  4   |
|  6   |      !Implement One-On-One Chat Rooms     | task |   -1  |  2   |
|  7   |        Implement Voice Counselling        | task |   -1  |  3   |
|  8   |        Implement Email Counselling        | task |   1   |  1   |
|  9   |  !Implement General Questions and Answers | task |   -1  |  4   |
|  10  |        Implement Video Counselling        | task |   1   |  1   |
|  11  | Maintain Get Informed Section of Web Site | task |   -1  |  3   |
|  12  |         !Implement Text Messaging         | task |   -1  |  1   |
|  13  |        !Implement Polls about Kids        | task |   -1  |  2   |
