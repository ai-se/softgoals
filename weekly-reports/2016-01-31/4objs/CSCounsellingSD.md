...
----------------------------------------------------
   ...
   1 ,     gen60_f1 ,    100.0  ,   3.28 (               |             *),96.72, 96.72, 100.00, 100.00, 100.00
   1 ,     gen80_f1 ,    100.0  ,   3.28 (               |             *),96.72, 96.72, 100.00, 100.00, 100.00
   1 ,    gen100_f1 ,    100.0  ,   3.28 (               |             *),96.72, 96.72, 100.00, 100.00, 100.00
...
rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,    gen100_f4 ,     34.0  ,   10.0 (   --  * --    |              ),28.00, 31.00, 35.00, 40.00, 43.00
   1 ,     gen80_f4 ,     40.0  ,    9.0 (     -   * --- |              ),31.00, 34.00, 40.00, 43.00, 49.00
   2 ,     gen60_f4 ,     43.0  ,   10.0 (      ---- *  -|              ),33.00, 41.00, 43.00, 49.00, 55.00
   2 ,     gen40_f4 ,     45.0  ,   11.0 (        --  *  |--            ),37.00, 42.00, 45.00, 52.00, 58.00
   3 ,     gen20_f4 ,     50.0  ,   12.0 (        ---   *|---           ),38.00, 44.00, 51.00, 55.00, 60.00
   4 ,      gen0_f4 ,     55.0  ,    9.0 (        ------ |* ------      ),38.00, 50.00, 55.00, 58.00, 70.00
```

### Time Taken : 13.7594339848
![1](../../../src/img/4objs/CSCounsellingSD.png)
...
+------+----------------------------------------------+----------+-------+------+
|  1   |      Provide Web Counselling with Audio      |   task   |   -1  |  4   |
|  2   |       ! Write Articles for Magazines         |   task   |   -1  |  4   |
|  3   |          *Implement Bulletin Board           |   task   |   1   |  3   |
|  4   |           Create Counselling Posts           |   task   |   -1  |  5   |
|  5   |               Double Headsets                | resource |   -1  |  3   |
|  6   |            Web Moderator Meetings            | resource |   -1  |  2   |
|  7   |        *Implement Categorization Tool        |   task   |   1   |  3   |
|  8   |            Information/Resources             | resource |   -1  |  5   |
|  9   |           Resources in the Library           | resource |   -1  |  5   |
|  10  |            Participate in events             |   task   |   1   |  1   |
|  11  |             Provide Information              |   task   |   -1  |  5   |
|  12  |            Report Outdated Links             |   task   |   -1  |  5   |
|  13  |         !Moderate Discussion Boards          |   task   |   -1  |  5   |
|  14  | ! Counselor Speak on Kids Issues in General  |   task   |   1   |  3   |
|  15  |        ! Write Articles for Website          |   task   |   -1  |  4   |
|  16  |           Information in E-Library           | resource |   -1  |  4   |
|  17  |            Counsellor Experience             | resource |   -1  |  3   |
|  18  |                    Tapes                     | resource |   -1  |  3   |
|  19  |       Information Binders at Stations        | resource |   -1  |  2   |
|  20  |       *Implement Email for Counsellors       |   task   |   -1  |  2   |
|  21  |                 Training CDs                 | resource |   1   |  1   |
|  22  |             Counselling Policies             | resource |   -1  |  3   |
|  23  |               Web Site Content               | resource |   -1  |  1   |
|  24  |      Provide Web Counselling with Video      |   task   |   -1  |  3   |
|  25  |                   Feedback                   | resource |   -1  |  3   |
|  26  |          !Perform Email Counselling          |   task   |   -1  |  3   |
|  27  |             Provide Counselling              |   task   |   -1  |  3   |
|  28  |               !Moderate a Chat               |   task   |   -1  |  4   |
|  29  |                  Promote CS                  |   task   |   -1  |  3   |
|  30  |            Counselling Workshops             | resource |   -1  |  4   |
|  31  |                Sign Contract                 |   task   |   -1  |  5   |
|  32  |          Tape Recording Technoloyg           | resource |   -1  |  1   |
|  33  |           Undergo Clinical Review            |   task   |   -1  |  2   |
|  34  |         Web Counselling be Performed         |   task   |   -1  |  4   |
|  35  |         Provide Written Counselling          |   task   |   1   |  2   |
+------+----------------------------------------------+----------+-------+------+
```
