...
### Time Taken : 23.5886011124
![1](../../../src/img/cdom_delta_001/CSITDepartment.png)
...
+------+-------------------------------------------------+----------+-------+------+---------+
|  1   |                      Use T1                     |   task   |   1   |  1   | 0.02786 |
|  2   |            !Implement Phone Feedback1           |   task   |   -1  |  1   |  0.0263 |
|  3   | Provide Technology to Create and Send Documents |   task   |   -1  |  1   | 0.02557 |
|  4   |                  Free Upgrades                  | resource |   -1  |  1   | 0.02375 |
|  5   |      Use Informal Buddy System for Training     |   task   |   1   |  1   | 0.02293 |
|  6   |         Provide Online Donor Technology1        |   task   |   -1  |  1   | 0.02293 |
|  7   |                      Oracle                     | resource |   -1  |  1   | 0.02269 |
|  8   |            Put Content Onto Website1            |   task   |   -1  |  1   | 0.02099 |
|  9   |  Perform Donor/Accounting Data Base Maintenance |   task   |   -1  |  1   | 0.02027 |
|  10  |         *Implement Email for Counsellors        |   task   |   -1  |  1   | 0.01907 |
|  11  |                   Network PCs                   |   task   |   -1  |  1   | 0.01818 |
|  12  |                     Software                    | resource |   1   |  1   | 0.01727 |
|  13  |                   IT Resources                  | resource |   -1  |  1   | 0.01689 |
|  14  |                     Use VPN                     |   task   |   -1  |  1   | 0.01655 |
|  15  |                Use Current Method               |   task   |   -1  |  1   |  0.0126 |
|  16  |                     Upgrades                    | resource |   -1  |  1   | 0.01249 |
|  17  |                   Web Server1                   | resource |   1   |  1   | 0.01183 |
|  18  |                     Hardware                    | resource |   1   |  1   | 0.01126 |
|  19  |                  Free Software                  | resource |   -1  |  1   | 0.01083 |
|  20  |                 Free Web Server                 | resource |   -1  |  1   | 0.00995 |
|  21  |                  Free Hardware                  | resource |   -1  |  1   | 0.00891 |
+------+-------------------------------------------------+----------+-------+------+---------+
```
