...
----------------------------------------------------
   ...
   1 ,     gen20_f1 ,    91.71  ,   3.86 (             --|--  *   --    ),87.85, 90.61, 91.71, 93.92, 95.03
   2 ,     gen40_f1 ,    92.27  ,   3.31 (               |---  *  ---   ),88.95, 91.16, 92.27, 93.92, 95.58
   2 ,     gen60_f1 ,    92.82  ,   3.32 (               | ---   * --   ),90.06, 91.71, 93.37, 94.48, 95.58
   2 ,     gen80_f1 ,    93.37  ,   3.32 (               | ---   * ---  ),90.06, 91.71, 93.37, 94.48, 96.13
   2 ,    gen100_f1 ,    93.92  ,   3.32 (               | ---    *---  ),90.06, 91.71, 93.92, 94.48, 96.13

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f2 ,    86.21  ,   3.45 (----------*    |--------      ),79.31, 86.21, 86.21, 89.66, 96.55
   1 ,     gen20_f2 ,    89.66  ,  10.34 (     -----     *   -----      ),82.76, 86.21, 89.66, 93.10, 96.55
   2 ,     gen40_f2 ,    89.66  ,  10.34 (          -----|   *          ),86.21, 89.66, 93.10, 96.55, 96.55
   2 ,     gen60_f2 ,     93.1  ,   6.89 (          -----|   *          ),86.21, 89.66, 93.10, 96.55, 96.55
   3 ,     gen80_f2 ,    96.55  ,   6.89 (          -----|---     *---- ),86.21, 93.10, 96.55, 96.55, 100.00
   3 ,    gen100_f2 ,    96.55  ,   3.45 (               |---     *---- ),89.66, 93.10, 96.55, 96.55, 100.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f3 ,    206.0  ,   20.0 (  --   * ----  |              ),191.00, 196.00, 207.00, 212.00, 225.00
   1 ,     gen20_f3 ,    209.0  ,   22.0 (  --    * ---  |              ),191.00, 198.00, 210.00, 216.00, 225.00
   1 ,     gen40_f3 ,    210.0  ,   20.0 (  ----  * ---- |              ),191.00, 202.00, 211.00, 217.00, 228.00
   2 ,     gen60_f3 ,    212.0  ,   15.0 (  -----  *-----|              ),191.00, 206.00, 212.00, 217.00, 237.00
   2 ,     gen80_f3 ,    212.0  ,   16.0 (  ----   * ----|-             ),191.00, 204.00, 212.00, 219.00, 240.00
   2 ,    gen100_f3 ,    212.0  ,   19.0 (  ----   *-----|-             ),191.00, 204.00, 213.00, 217.00, 240.00

rank ,         name ,    med   ,   iqr 
----------------------------------------------------
   1 ,      gen0_f4 ,     26.0  ,    4.0 (        ------ | * -------    ),22.00, 25.00, 27.00, 28.00, 32.00
   1 ,     gen20_f4 ,     27.0  ,    4.0 (        ------ | *   -----    ),22.00, 25.00, 27.00, 29.00, 32.00
   1 ,     gen40_f4 ,     27.0  ,    4.0 (        ------ | *   -----    ),22.00, 25.00, 27.00, 29.00, 32.00
   1 ,     gen60_f4 ,     27.0  ,    5.0 (        ------ | *   ---      ),22.00, 25.00, 27.00, 29.00, 31.00
   1 ,     gen80_f4 ,     27.0  ,    5.0 (        ------ | *   ---      ),22.00, 25.00, 27.00, 29.00, 31.00
   1 ,    gen100_f4 ,     27.0  ,    5.0 (          ---- | *   ---      ),23.00, 25.00, 27.00, 29.00, 31.00
```

### Time Taken : 209.325846195
![1](../../../src/img/cdom_delta_001/CSCounselling.png)
...
+------+----------------------------------------------------+----------+-------+------+---------+
|  1   |                 *Explore Options1                  |   task   |   1   |  1   | 0.11756 |
|  2   |          Provide Resources in One Source           |   task   |   1   |  1   | 0.08557 |
|  3   |        Sign Contract with Counselling Union        |   task   |   1   |  1   | 0.08138 |
|  4   |                Counselling Policies                | resource |   1   |  1   | 0.07779 |
|  5   |   ! Counselor Speak on Kids Issues in General 1    |   task   |   -1  |  1   | 0.07737 |
|  6   |                  Double Headsets                   | resource |   1   |  1   | 0.06446 |
|  7   |                      Feedback                      | resource |   -1  |  1   | 0.06349 |
|  8   |              !Undergo Media Training               |   task   |   1   |  1   | 0.06119 |
|  9   |                 Assess Situation1                  |   task   |   -1  |  1   | 0.06119 |
|  10  |          !Participate in Sponsor Meetings          |   task   |   -1  |  1   |  0.0597 |
|  11  |           Provide Information in Binders           |   task   |   1   |  1   | 0.05918 |
|  12  |                  Listen for Cues                   |   task   |   -1  |  1   | 0.05823 |
|  13  |               Report Outdated Links1               |   task   |   1   |  1   | 0.05823 |
|  14  |   Block Kids who Display Inappropriate Behavoir    |   task   |   -1  |  1   | 0.05641 |
|  15  |              Debrief with Counsellors              |   task   |   1   |  1   | 0.05554 |
|  16  |       Comment on Technology Usability Issues       |   task   |   -1  |  1   |  0.0547 |
|  17  |              Speak at SA Conferences               |   task   |   -1  |  1   |  0.054  |
|  18  |          *Receive Training from Managment          |   task   |   1   |  1   | 0.05333 |
|  19  |            Diffuse Conflict with Parent            |   task   |   1   |  1   | 0.05311 |
|  20  |           *Implement Categorization Tool           |   task   |   -1  |  1   | 0.05255 |
|  21  |           ! Write Articles for Website 1           |   task   |   -1  |  1   | 0.05233 |
|  22  |               Counselling Workshops                | resource |   -1  |  1   | 0.05114 |
|  23  |                  *Explore Options                  |   task   |   -1  |  1   |  0.0507 |
|  24  |         *Implement Email for Counsellors1          |   task   |   -1  |  1   | 0.04898 |
|  25  | Include Legal Information in Counselling Resources |   task   |   1   |  1   | 0.04891 |
|  26  |             Tape Recording Technology              | resource |   1   |  1   | 0.04787 |
|  27  |            Perform Crisis Intervention             |   task   |   1   |  1   | 0.04765 |
|  28  |              Speak Publicly about Job              |   task   |   1   |  1   | 0.04741 |
|  29  |          ! Write Articles for Magazines 1          |   task   |   -1  |  1   | 0.04661 |
|  30  |               Web Moderator Meetings               | resource |   1   |  1   | 0.04655 |
|  31  |                       Tapes                        | resource |   1   |  1   | 0.04592 |
|  32  |            Provide Resources in Library            |   task   |   1   |  1   | 0.04558 |
|  33  |               Learn Web Technologies               |   task   |   -1  |  1   |  0.045  |
|  34  |              Attend Part Time Meeting              |   task   |   1   |  1   |  0.045  |
|  35  |     Provide Information to Other Counselloers      |   task   |   1   |  1   | 0.04414 |
|  36  |               Participate in events1               |   task   |   -1  |  1   | 0.04356 |
|  37  |            Remove Identifying Material             |   task   |   1   |  1   | 0.04327 |
|  38  |                   Report Abuses                    |   task   |   1   |  1   | 0.04261 |
|  39  | Include Drug Information in Counselling Resources  |   task   |   -1  |  1   |  0.0417 |
|  40  |                  Assess Situation                  |   task   |   -1  |  1   | 0.04167 |
|  41  |           Provide Resources in E-Library           |   task   |   1   |  1   | 0.04167 |
|  42  |                    Training CDs                    | resource |   1   |  1   | 0.04091 |
|  43  |                   Request Shifts                   |   task   |   -1  |  1   | 0.04091 |
|  44  |           !Participate in Board Meetings           |   task   |   -1  |  1   | 0.04024 |
|  45  |                Refer Parents to PHL                |   task   |   -1  |  1   | 0.04018 |
|  46  |             *Implement Bulletin Board1             |   task   |   -1  |  1   | 0.04018 |
|  47  |     Listen to Calls of Experienced Counsellors     |   task   |   -1  |  1   | 0.03947 |
|  48  |          Encourage Kids to Talk to Others          |   task   |   1   |  1   | 0.03947 |
|  49  |      Perform Conference Call with Third Party      |   task   |   1   |  1   | 0.03841 |
|  50  |              *Edit Counselling Posts               |   task   |   -1  |  1   | 0.03841 |
|  51  |                   Record Stories                   |   task   |   -1  |  1   | 0.03821 |
|  52  |        Receive Call Classification Training        |   task   |   1   |  1   | 0.03756 |
|  53  |  *Encourage Kids to Talk to Different Counsellors  |   task   |   1   |  1   | 0.03674 |
|  54  |             Encourage Kids to Call CS              |   task   |   -1  |  1   | 0.03674 |
+------+----------------------------------------------------+----------+-------+------+---------+
```
...
|                 Receive Training as a New Counsellor                 |   task   |   1   |
