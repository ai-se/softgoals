...
### Time Taken : 241.439694881
![1](../../../src/img/cdom_delta_001/CSServices.png)
...
+------+------------------------------------------------------------+----------+-------+------+---------+
|  1   |                Provide Written Counselling                 |   task   |   1   |  1   | 0.02154 |
|  2   |                     Service Resources                      | resource |   1   |  1   | 0.02044 |
|  3   |                  Create Counselling Posts                  |   task   |   1   |  1   | 0.02031 |
|  4   |                      Web Site Content                      | resource |   1   |  1   | 0.02008 |
|  5   |                !Moderate Discussion Boards                 |   task   |   1   |  1   |  0.0197 |
|  6   |                Kids Use Phone Counselling1                 |   task   |   1   |  1   | 0.01913 |
|  7   |               Voice Counselling be Performed               |   task   |   1   |  1   | 0.01769 |
|  8   |                    Strategic Blue Print                    | resource |   1   |  1   | 0.01767 |
|  9   |       Block Kids who Display Inappropriate Behavoir        |   task   |   -1  |  1   | 0.01734 |
|  10  |      Kids Use Bulletin Board with Delayed Moderation1      |   task   |   -1  |  1   | 0.01592 |
|  11  |             Maintain Ask a Counsellor Section1             |   task   |   1   |  1   | 0.01583 |
|  12  |               *Maintain PHL Phone Services4                |   task   |   1   |  1   | 0.01569 |
|  13  |           Kids Use Ask a Counsellor Section\ns1            |   task   |   1   |  1   | 0.01476 |
|  14  |              Schedule Chat at Specific Times               |   task   |   1   |  1   | 0.01468 |
|  15  |           Kids Use Bulletin Board with Replies1            |   task   |   1   |  1   | 0.01438 |
|  16  |               Implement Information Section                |   task   |   1   |  1   | 0.01422 |
|  17  |                     Implement Filters                      |   task   |   1   |  1   | 0.01422 |
|  18  |           Implement Bulletin Board with Replies1           |   task   |   1   |  1   | 0.01345 |
|  19  |                Kids Use Video Counselling1                 |   task   |   -1  |  1   | 0.01311 |
|  20  |              Parents Use Information Section1              |   task   |   1   |  1   | 0.01296 |
|  21  |                 *Provide Recorded Messages                 |   task   |   1   |  1   | 0.01296 |
|  22  |                 !Perform Email Counselling                 |   task   |   1   |  1   | 0.01227 |
|  23  |             !Implement One-On-One Chat Rooms1              |   task   |   1   |  1   | 0.01129 |
|  24  |           Kids Use Cyber Café/Portal/Chat Room1            |   task   |   1   |  1   | 0.01124 |
|  25  |                Kids Use Voice Counselling1                 |   task   |   -1  |  1   | 0.01124 |
|  26  |         Kids use get Informed Section of Web Site          |   task   |   1   |  1   | 0.01101 |
|  27  |              Implement Anti-Pranking Message               |   task   |   -1  |  1   |  0.0108 |
|  28  |                Implement Board with Replies                |   task   |   -1  |  1   |  0.0108 |
|  29  |                 !Implement Phone Feedback3                 |   task   |   1   |  1   | 0.01079 |
|  30  |     Implement Bulletin Board with Delayed Moderation1      |   task   |   1   |  1   | 0.01059 |
|  31  |                          Feedback                          | resource |   -1  |  1   | 0.01059 |
|  32  |  !Implement\nTool to Allow Parents to Talk to Each Other   |   task   |   -1  |  1   | 0.01051 |
|  33  |                      Implement Delay                       |   task   |   -1  |  1   | 0.01037 |
|  34  | Parents Use\nTool to Allow Parents to Talk to Each Other 1 |   task   |   1   |  1   | 0.01024 |
|  35  |          Parents Use Bulletin Board with Replies1          |   task   |   1   |  1   | 0.00963 |
|  36  |                   Feedback Form Software                   | resource |   1   |  1   | 0.00949 |
|  37  |                 Put Content Onto Website1                  |   task   |   -1  |  1   | 0.00941 |
|  38  |          Kids Read General Questions and Answers1          |   task   |   1   |  1   |  0.0094 |
|  39  |                         Web Server                         | resource |   -1  |  1   |  0.0094 |
|  40  |                !Kids Read Polls about Kids1                |   task   |   1   |  1   |  0.0094 |
|  41  |                Implement Voice Counselling1                |   task   |   -1  |  1   | 0.00909 |
|  42  |             Provide Web Counselling with Video             |   task   |   1   |  1   | 0.00904 |
|  43  |                        Trace Calls                         |   task   |   -1  |  1   | 0.00899 |
|  44  |             Provide Web Counselling with Audio             |   task   |   -1  |  1   | 0.00889 |
|  45  |                      !Moderate a Chat                      |   task   |   1   |  1   | 0.00872 |
|  46  |                 !Implement Text Messaging1                 |   task   |   -1  |  1   |  0.0084 |
|  47  |                Kids Use Email Counselling1                 |   task   |   1   |  1   | 0.00834 |
|  48  |                         Feedback1                          | resource |   1   |  1   | 0.00809 |
|  49  |                        Web Software                        | resource |   -1  |  1   | 0.00809 |
|  50  |    Inform Kids about Anonymity [Kids] of Web Services1     |   task   |   -1  |  1   | 0.00785 |
+------+------------------------------------------------------------+----------+-------+------+---------+
```
