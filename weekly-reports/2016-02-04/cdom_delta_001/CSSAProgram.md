...
### Time Taken : 21.7210450172
![1](../../../src/img/cdom_delta_001/CSSAProgram.png)
...
+------+-------------------------------+----------+-------+------+---------+
|  1   | School Initiates Presenation1 |   task   |   -1  |  1   | 0.02367 |
|  2   |       Attend SA Meetings      |   task   |   -1  |  1   | 0.02254 |
|  3   |        Send out Emails        |   task   |   -1  |  1   |  0.0225 |
|  4   |    Help with Presentations    |   task   |   -1  |  1   | 0.02175 |
|  5   |      Promotion Resources1     | resource |   -1  |  1   | 0.02171 |
|  6   |        Provide Speaches       |   task   |   -1  |  1   | 0.01864 |
|  7   |       Plan Social Events      |   task   |   -1  |  1   | 0.01857 |
|  8   |   Run Fundraiser in Schools1  |   task   |   -1  |  1   | 0.01826 |
|  9   |          Retrain SA s         |   task   |   -1  |  1   |  0.0153 |
|  10  |           Train SA s          |   task   |   -1  |  1   | 0.01471 |
|  11  |       Attend CS Meetings      |   task   |   -1  |  1   | 0.01148 |
|  12  |  Write Articles for Newspaper |   task   |   1   |  1   |   0.01  |
+------+-------------------------------+----------+-------+------+---------+
```
